...
{
	/// <summary>This class will upgrade v621 to v622</summary>
	public class UpgradeTasks622 : IUpgradeDBInit, IUpgradeDB
	{
		...
		public const int DB_UPG_MAX = 621;

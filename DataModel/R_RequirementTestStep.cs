...
namespace Inflectra.SpiraTest.DataModel
{
    ...
    public partial class R_RequirementTestStep: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        {
            get { return _sTEP_DESCRIPTION; }
            set
            {
                if (_sTEP_DESCRIPTION != value)
                {
                    if (ChangeTracker.ChangeTrackingEnabled && ChangeTracker.State != ObjectState.Added)
                    {
                        throw new InvalidOperationException("The property 'STEP_DESCRIPTION' is part of the object's key and cannot be changed. Changes to key properties can only be made when the object is not being tracked or is in the Added state.");
                    }
                    _sTEP_DESCRIPTION = value;
                    OnPropertyChanged("STEP_DESCRIPTION");
                }
            }
        }

<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="OverallCompletion.ascx.cs" Inherits="Inflectra.SpiraTest.Web.UserControls.WebParts.ProjectGroupHome.OverallCompletion" %>
...
<script type="text/javascript">
    ...
    $('#help-OverallCompletion').popover({
        content: resx.InAppHelp_Chart_ProgramOverallCompletion,
        placement: "left",
        trigger: "hover focus",

...
{
    /// <summary>
    /// Serializes a Dictionary of integers into a form that can be converted to/from a JavaScript JSON object
    /// (i.e. var dictionary = {}; type of object).
    /// </summary>
    [
    Serializable
    ]
    public class JsonDictionaryOfIntegers : ISerializable
    {
        /// <summary>
        ...
        /// Constructor
        /// </summary>
        public JsonDictionaryOfIntegers()
        {
        ...
        /// </summary>
        public JsonDictionaryOfIntegers(Dictionary<string, int> dict)
        {
            this.dict = dict;
        }
        ...
        protected JsonDictionaryOfIntegers(SerializationInfo info, StreamingContext context)
        {
            dict = new Dictionary<string, int>();
        ...
        /// <summary>
        /// Gets/Sets the value associated with a specific key
        /// </summary>
        /// <param name="key">The key to look for</param>

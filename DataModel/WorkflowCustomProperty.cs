...
namespace Inflectra.SpiraTest.DataModel
{
    ...
    public partial class WorkflowCustomProperty: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        private void FixupCustomProperty(CustomProperty previousValue)
        {
            ...
            {
                if (!CustomProperty.IncidentWorkflowFields.Contains(this))
                {
                    CustomProperty.IncidentWorkflowFields.Add(this);
                }
        ...
        private void FixupState(WorkflowFieldState previousValue)
        {
            ...
            if (previousValue != null && previousValue.IncidentCustomProperties.Contains(this))
            {
                previousValue.IncidentCustomProperties.Remove(this);
            }
    
            if (State != null)
            {
                if (!State.IncidentCustomProperties.Contains(this))
                {
                    State.IncidentCustomProperties.Add(this);
                }

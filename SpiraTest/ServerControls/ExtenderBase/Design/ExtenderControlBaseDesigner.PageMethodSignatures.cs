...
namespace Inflectra.SpiraTest.Web.ServerControls.ExtenderBase.Design
{
    /// <summary>
        ...
        where T : ExtenderControlBase
    {
        ...
        private class PageMethodDesignerActionList : DesignerActionList
        {
                ...
                try
                {
                    ...
                    try
                    {
                        ...
                        try
                        {
                            ...
                            {
                                if (PageMethodNeedsRepair(method))
                                {
                                    ShowMessage("Repairing page method ' + method + '");
            ...
            {
                Logger.LogTraceEvent("Inflectra.SpiraTest.Web.ServerControls.ExtenderBase.Design", message);
            }

...
{
    /// <summary>
    /// Serializes a Dictionary of strings into a form that can be converted to/from a JavaScript JSON object
    /// (i.e. var dictionary = {}; type of object).
    /// </summary>
    [
    Serializable
    ]
    public class JsonDictionaryOfStrings : ISerializable
    {
        /// <summary>
        ...
        /// Constructor
        /// </summary>
        public JsonDictionaryOfStrings()
        {
        ...
        /// </summary>
        public JsonDictionaryOfStrings(Dictionary<string, string> dict)
        {
            this.dict = dict;
        }
        ...
        protected JsonDictionaryOfStrings(SerializationInfo info, StreamingContext context)
        {
            dict = new Dictionary<string, string>();
        ...
        /// <summary>
        /// Determines if the value is present in the dictionary
        /// </summary>

...
namespace Inflectra.SpiraTest.DataModel
{
    ...
    public partial class R_RiskProbability: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        #region Primitive Properties
    
        [DataMember]
        public int RISK_PROBABILITY_ID
        {
            ...
            set
            {
                if (_rISK_PROBABILITY_ID != value)
                {
                    ...
                    {
                        throw new InvalidOperationException("The property 'RISK_PROBABILITY_ID' is part of the object's key and cannot be changed. Changes to key properties can only be made when the object is not being tracked or is in the Added state.");
                    }
        ...
        private int _rISK_PROBABILITY_ID;

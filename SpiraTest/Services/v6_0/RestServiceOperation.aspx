<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RestServiceOperation.aspx.cs" Inherits="Inflectra.SpiraTest.Web.Services.v6_0.RestServiceOperation" EnableTheming="false" Theme="" %>
...
<body class="pa0 ma0">
    <form id="frmMain" runat="server">
        <p class="pa4 mt0 mb4 bg-tiber fs-h3 ff-josefin white"><asp:Literal runat="server" ID="ltrProductName2"/>: REST Web Service (v6.0)</p>
        <div class="mb6 vw-50-xl vw-66-lg vw-75-md vw-75_sm vw-90-xs vw-90-xxs mx-auto">
            ...
            <div id="divXml2" style="display:none">
                <pre class="ReturnData"><asp:Literal ID="ltrXml2" runat="server" /></pre>
            </div>
            <div id="divJson2" style="display:none">
                <pre class="ReturnData"><asp:Literal ID="ltrJson2" runat="server" /></pre>            
            </div>
            ...
            <div id="divXml" style="display:none">
                <pre class="ReturnData"><asp:Literal ID="ltrXml" runat="server" /></pre>
            </div>
            <div id="divJson" style="display:none">
                <pre class="ReturnData"><asp:Literal ID="ltrJson" runat="server" /></pre>            
            </div>
        </div>

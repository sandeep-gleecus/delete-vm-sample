...
namespace Inflectra.SpiraTest.DataModel
{
    ...
    public partial class TestSetFolderHierarchy: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        private void FixupProject(Project previousValue)
        {
            ...
            if (previousValue != null && previousValue.TestSetFoldersHierarchy.Contains(this))
            {
                previousValue.TestSetFoldersHierarchy.Remove(this);
            }
    
            if (Project != null)
            {
                if (!Project.TestSetFoldersHierarchy.Contains(this))
                {
                    Project.TestSetFoldersHierarchy.Add(this);
                }

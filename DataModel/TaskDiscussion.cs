...
namespace Inflectra.SpiraTest.DataModel
{
    ...
    public partial class TaskDiscussion: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        private void FixupTask(Task previousValue)
        {
            ...
            if (Task != null)
            {
                if (!Task.Discussions.Contains(this))
                {
                    Task.Discussions.Add(this);
                }
        ...
        private void FixupCreator(User previousValue)
        {
            ...
            if (previousValue != null && previousValue.TaskDiscussions.Contains(this))
            {
                previousValue.TaskDiscussions.Remove(this);
            }
    
            if (Creator != null)
            {
                if (!Creator.TaskDiscussions.Contains(this))
                {
                    Creator.TaskDiscussions.Add(this);
                }

...
namespace Inflectra.SpiraTest.DataModel
{
    ...
    public partial class R_Comment: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        public string COMMENT_TEXT
        {
            ...
            set
            {
                if (_cOMMENT_TEXT != value)
                {
                    if (ChangeTracker.ChangeTrackingEnabled && ChangeTracker.State != ObjectState.Added)
                    {
                        throw new InvalidOperationException("The property 'COMMENT_TEXT' is part of the object's key and cannot be changed. Changes to key properties can only be made when the object is not being tracked or is in the Added state.");
                    }
                    _cOMMENT_TEXT = value;
                    OnPropertyChanged("COMMENT_TEXT");
                }
            }
        }

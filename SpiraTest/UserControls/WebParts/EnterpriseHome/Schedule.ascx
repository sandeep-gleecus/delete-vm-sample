<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Schedule.ascx.cs"
    Inherits="Inflectra.SpiraTest.Web.UserControls.WebParts.EnterpriseHome.Schedule" %>
...
<script type="text/javascript">
    ...
    $('#help-WorkspaceSchedule').popover({
        content: resx.InAppHelp_Chart_EnterpriseSchedule,
        placement: "left",
        trigger: "hover focus",

...
{
    /// <summary>
    /// Allows the new Newtonsoft JSON deserializer to use handle UriTemplates
    /// </summary>
    /// <remarks>
    /// https://stackoverflow.com/questions/33554997/using-custom-wcf-body-deserialization-without-changing-uri-template-deserializat
    /// </remarks>
    public class UriTemplateDispatchFormatter : IDispatchMessageFormatter
    {

...
namespace Inflectra.SpiraTest.DataModel
{
    ...
    public partial class RequirementWorkflowTransitionRole: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        [DataMember]
        public RequirementWorkflowTransition Transition
        {
        ...
        private RequirementWorkflowTransition _transition;
        ...
        private void FixupRole(ProjectRole previousValue)
        {
            ...
            if (previousValue != null && previousValue.RequirementWorkflowTransitionRoles.Contains(this))
            {
                previousValue.RequirementWorkflowTransitionRoles.Remove(this);
            }
    
            if (Role != null)
            {
                if (!Role.RequirementWorkflowTransitionRoles.Contains(this))
                {
                    Role.RequirementWorkflowTransitionRoles.Add(this);
                }
        ...
        private void FixupTransition(RequirementWorkflowTransition previousValue)
        {
            if (IsDeserializing)
            {
                return;
        ...
        private void FixupType(WorkflowTransitionRoleType previousValue)
        {
            ...
            if (Type != null)
            {
                if (!Type.RequirementWorkflowTransitionRoles.Contains(this))
                {
                    Type.RequirementWorkflowTransitionRoles.Add(this);
                }

...
{
    /// <summary>
    /// Displays the build list for the entire enterprise
    /// </summary>
    public partial class RecentBuilds : WebPartBase, IWebPartReloadable
    {
        private const string CLASS_NAME = "Inflectra.SpiraTest.Web.UserControls.WebParts.EnterpriseHome.RecentBuilds::";

...
namespace Inflectra.SpiraTest.Web.Services.v6_0
{
    ...
    {
        private const string CLASS_NAME = "Inflectra.SpiraTest.Web.Services.v6_0.RestServiceOperation";
                    ...
                    else
                    {
                        if (parameters.Length > 0)
                        {
                            ...
                            else
                            {
                                ...
                                using (XmlWriter xmlWriter = new XmlTextWriter(stringWriter) { Formatting = System.Xml.Formatting.Indented })
                                {

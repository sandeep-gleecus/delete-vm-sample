...
namespace Inflectra.SpiraTest.Web.Administration.ProjectTemplate
{
	...
	/// </summary>
    [
    HeaderSettings(GlobalNavigation.NavigationHighlightedLink.Administration, "Admin_WorkflowTransition_Title", "Template-Releases/#edit-workflow-transition", "Admin_WorkflowTransition_Title"),
    ...
    public partial class ReleaseWorkflowTransition : AdministrationBase
	{
		//Datasets and entities
        DataModel.ReleaseWorkflowTransition workflowTransition;
        protected SortedList<string, string> flagList;

		protected int workflowId;
		protected int workflowTransitionId;

        private const string CLASS_NAME = "Inflectra.SpiraTest.Web.Administration.ProjectTemplate.ReleaseWorkflowTransition::";
		...
		protected void Page_Load(object sender, System.EventArgs e)
		{
			...
			if (!IsPostBack) 
			{
                ...
                this.lnkIncomingStep.Text = workflowTransition.InputReleaseStatus.Name + " (" + workflowTransition.InputReleaseStatusId.ToString() + ")"; ;
                this.lnkIncomingStep.NavigateUrl = UrlRoots.RetrieveTemplateAdminUrl(ProjectTemplateId, "ReleaseWorkflowStep") + "?" + GlobalFunctions.PARAMETER_WORKFLOW_ID + "=" + workflowId.ToString() + "&" + GlobalFunctions.PARAMETER_RELEASE_STATUS_ID + "=" + workflowTransition.InputReleaseStatusId.ToString();
                this.lnkOutgoingStep.Text = workflowTransition.OutputReleaseStatus.Name + " (" + workflowTransition.OutputReleaseStatusId.ToString() + ")"; ;
                this.lnkOutgoingStep.NavigateUrl = UrlRoots.RetrieveTemplateAdminUrl(ProjectTemplateId, "ReleaseWorkflowStep") + "?" + GlobalFunctions.PARAMETER_WORKFLOW_ID + "=" + workflowId.ToString() + "&" + GlobalFunctions.PARAMETER_RELEASE_STATUS_ID + "=" + workflowTransition.OutputReleaseStatusId.ToString();
        ...
        {
            Response.Redirect(UrlRoots.RetrieveTemplateAdminUrl(ProjectTemplateId, "ReleaseWorkflowDetails") + "?" + GlobalFunctions.PARAMETER_WORKFLOW_ID + "=" + workflowId);
        }
		...
		private void btnUpdate_Click(object sender, EventArgs e)
		{
            ...
            foreach (GridViewRow gvr in this.grdExecuteRoles.Rows)
            {
                ...
                if (gvr.RowType == DataControlRowType.DataRow)
                {
                    ...
                    ReleaseWorkflowTransitionRole workflowTransitionRole = this.workflowTransition.TransitionRoles.FirstOrDefault(r => r.ProjectRoleId == projectRoleId && r.WorkflowTransitionRoleTypeId == (int)WorkflowTransitionRoleType.WorkflowTransitionRoleTypeEnum.Execute);

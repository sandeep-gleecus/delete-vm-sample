...
namespace Inflectra.SpiraTest.Web.Services.v4_0
{
	...
	[XmlComments(XmlCommentFormat.Default, "Inflectra.SpiraTest.Web.Services.v4_0.ImportExport")]
	public interface IImportExport : IService
	{
		...
		[OperationContract]
		[FaultContract(typeof(ServiceFaultMessage))]
		long TestCase_CountForFolder(List<RemoteFilter> remoteFilters, int parentID);
        ...
        [OperationContract]
        [FaultContract(typeof(ServiceFaultMessage))]
        List<RemoteTestCaseFolder> TestCase_RetrieveFolderHierarchy();

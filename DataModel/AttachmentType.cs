...
namespace Inflectra.SpiraTest.DataModel
{
    ...
    public partial class AttachmentType: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        [DataMember]
        public TrackableCollection<Attachment> Attachments
        {
            get
            {
                if (_attachments == null)
                {
                    _attachments = new TrackableCollection<Attachment>();
        ...
        private TrackableCollection<Attachment> _attachments;

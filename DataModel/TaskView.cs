...
namespace Inflectra.SpiraTest.DataModel
{
    ...
    public partial class TaskView: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        public string RequirementName
        {
            ...
            set
            {
                if (_requirementName != value)
                {
                    ChangeTracker.RecordOriginalValue("RequirementName", _requirementName);
                    _requirementName = value;
                    OnPropertyChanged("RequirementName");
                }
            }
        }
        ...
        public string RiskName
        {
            ...
            set
            {
                if (_riskName != value)
                {
                    ChangeTracker.RecordOriginalValue("RiskName", _riskName);
                    _riskName = value;
                    OnPropertyChanged("RiskName");
                }
            }
        }
        ...
        public bool IsPullRequest
        {
            ...
            set
            {
                if (_isPullRequest != value)
                {
                    if (ChangeTracker.ChangeTrackingEnabled && ChangeTracker.State != ObjectState.Added)
                    {
                        throw new InvalidOperationException("The property 'IsPullRequest' is part of the object's key and cannot be changed. Changes to key properties can only be made when the object is not being tracked or is in the Added state.");
                    }

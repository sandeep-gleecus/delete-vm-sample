...
namespace Inflectra.SpiraTest.Web.Administration.ProjectTemplate
{
	...
	/// </summary>
    [
    HeaderSettings(GlobalNavigation.NavigationHighlightedLink.Administration, "Admin_WorkflowTransition_Title", "Template-Documents/#edit-workflow-transition", "Admin_WorkflowTransition_Title"),
    ...
    public partial class DocumentWorkflowTransition : AdministrationBase
	{
		//Datasets and entities
        DataModel.DocumentWorkflowTransition workflowTransition;
        protected SortedList<string, string> flagList;

		protected int workflowId;
		protected int workflowTransitionId;

        private const string CLASS_NAME = "Inflectra.SpiraTest.Web.Administration.ProjectTemplate.DocumentWorkflowTransition::";
		...
		protected void Page_Load(object sender, System.EventArgs e)
		{
			...
			if (!IsPostBack) 
			{
				...
				this.lnkIncomingStep.Text = Microsoft.Security.Application.Encoder.HtmlEncode(workflowTransition.InputDocumentStatus.Name + " (" + workflowTransition.InputDocumentStatusId.ToString() + ")");
                this.lnkIncomingStep.NavigateUrl = UrlRoots.RetrieveTemplateAdminUrl(ProjectTemplateId, "DocumentWorkflowStep") + "?" + GlobalFunctions.PARAMETER_WORKFLOW_ID + "=" + workflowId.ToString() + "&" + GlobalFunctions.PARAMETER_DOCUMENT_STATUS_ID + "=" + workflowTransition.InputDocumentStatusId.ToString();
				this.lnkOutgoingStep.Text = Microsoft.Security.Application.Encoder.HtmlEncode(workflowTransition.OutputDocumentStatus.Name + " (" + workflowTransition.OutputDocumentStatusId.ToString() + ")");
                this.lnkOutgoingStep.NavigateUrl = UrlRoots.RetrieveTemplateAdminUrl(ProjectTemplateId, "DocumentWorkflowStep") + "?" + GlobalFunctions.PARAMETER_WORKFLOW_ID + "=" + workflowId.ToString() + "&" + GlobalFunctions.PARAMETER_DOCUMENT_STATUS_ID + "=" + workflowTransition.OutputDocumentStatusId.ToString();
                ...
                this.chkExecuteByCreatorYn.Checked = (workflowTransition.IsExecuteByAuthor) ? true : false;
                this.chkExecuteByOwnerYn.Checked = (workflowTransition.IsExecuteByEditor) ? true : false;
			}
        ...
        {
            Response.Redirect(UrlRoots.RetrieveTemplateAdminUrl(ProjectTemplateId, "DocumentWorkflowDetails") + "?" + GlobalFunctions.PARAMETER_WORKFLOW_ID + "=" + workflowId);
        }
		...
		private void btnUpdate_Click(object sender, EventArgs e)
		{
            ...
            this.workflowTransition.IsExecuteByAuthor = (this.chkExecuteByCreatorYn.Checked);
            this.workflowTransition.IsExecuteByEditor = (this.chkExecuteByOwnerYn.Checked);
            ...
            foreach (GridViewRow gvr in this.grdExecuteRoles.Rows)
            {
                ...
                if (gvr.RowType == DataControlRowType.DataRow)
                {
                    ...
                    DocumentWorkflowTransitionRole workflowTransitionRole = this.workflowTransition.TransitionRoles.FirstOrDefault(r => r.ProjectRoleId == projectRoleId && r.WorkflowTransitionRoleTypeId == (int)WorkflowTransitionRoleType.WorkflowTransitionRoleTypeEnum.Execute);

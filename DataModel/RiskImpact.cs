...
namespace Inflectra.SpiraTest.DataModel
{
    ...
    public partial class RiskImpact: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        public int RiskImpactId
        {
            ...
            set
            {
                if (_riskImpactId != value)
                {
                    ...
                    {
                        throw new InvalidOperationException("The property 'RiskImpactId' is part of the object's key and cannot be changed. Changes to key properties can only be made when the object is not being tracked or is in the Added state.");
                    }
                    _riskImpactId = value;
        ...
        private void FixupProjectTemplate(ProjectTemplate previousValue)
        {
            ...
            if (previousValue != null && previousValue.RiskImpacts.Contains(this))
            {
            ...
            {
                if (!ProjectTemplate.RiskImpacts.Contains(this))
                {
                    ProjectTemplate.RiskImpacts.Add(this);
                }
        ...
        private void FixupRisks(object sender, NotifyCollectionChangedEventArgs e)
        {
            ...
            if (e.OldItems != null)
            {
                ...
                {
                    if (ReferenceEquals(item.Impact, this))
                    {
                        item.Impact = null;
                    }
                    if (ChangeTracker.ChangeTrackingEnabled)

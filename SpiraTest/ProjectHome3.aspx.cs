...
namespace Inflectra.SpiraTest.Web
{
	...
	public partial class ProjectHome3 : PageLayout
	{
		private const string CLASS_NAME = "Inflectra.SpiraTest.Web.ProjectHome3::";
		...
		protected void Page_Load(object sender, System.EventArgs e)
		{
            ...
            if (preferredProjectHome != "Dev")
            {
                SaveProjectSetting(GlobalFunctions.PROJECT_SETTINGS_PROJECT_HOME_SETTINGS, GlobalFunctions.PROJECT_SETTINGS_KEY_HOME_PAGE, "Dev");
            }
		...
		void prtManager_WebPartDrillDown(object sender, WebPartEventArgs e)
		{
			...
			if (e.WebPart != null && e.WebPart is GenericWebPart)
			{
				...
				if (genericWebPart.ChildControl != null && genericWebPart.ChildControl is WebPartBase)
				{
                    ...
                    if (userControl is UserControls.WebParts.ProjectHome.RequirementsCoverageNew)
					{
						ucRequirementsCoverage_DrillDown();
					}
					if (userControl == this.ucReleaseTaskProgress)
					{

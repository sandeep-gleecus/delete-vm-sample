...
namespace Inflectra.SpiraTest.DataModel
{
    ...
    public partial class R_IncidentType: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        public int WORKFLOW_ID
        {
            ...
            set
            {
                if (_wORKFLOW_ID != value)
                {
                    if (ChangeTracker.ChangeTrackingEnabled && ChangeTracker.State != ObjectState.Added)
                    {
                        throw new InvalidOperationException("The property 'WORKFLOW_ID' is part of the object's key and cannot be changed. Changes to key properties can only be made when the object is not being tracked or is in the Added state.");
                    }
                    _wORKFLOW_ID = value;
                    OnPropertyChanged("WORKFLOW_ID");
                }
            }
        }
        ...
        public bool IS_ISSUE
        {
            ...
            set
            {
                if (_iS_ISSUE != value)
                {
                    if (ChangeTracker.ChangeTrackingEnabled && ChangeTracker.State != ObjectState.Added)
                    {
                        throw new InvalidOperationException("The property 'IS_ISSUE' is part of the object's key and cannot be changed. Changes to key properties can only be made when the object is not being tracked or is in the Added state.");
                    }
                    _iS_ISSUE = value;
                    OnPropertyChanged("IS_ISSUE");
                }
            }
        }
        private bool _iS_ISSUE;

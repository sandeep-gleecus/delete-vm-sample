...
namespace Inflectra.SpiraTest.Web.Services.v5_0.DataObjects
{
    ...
    public static class UpdateFunctions
    {
        ...
        public static void ConvertLegacyStaticIds(int projectTemplateId, RemoteRequirement remoteRequirement)
        {
            ...
            //Next type
            string staticName = "";
            switch (remoteRequirement.RequirementTypeId)
            {
                case 1: staticName = "Need"; break;
                case 2: staticName = "Feature"; break;
                case 3: staticName = "Use Case"; break;
                case 4: staticName = "User Story"; break;
                case 5: staticName = "Quality"; break;
                case 6: staticName = "Design Element"; break;
            }
            List<RequirementType> types = requirementManager.RequirementType_Retrieve(projectTemplateId, false);
            RequirementType type = types.FirstOrDefault(p => p.Name == staticName || p.RequirementTypeId == remoteRequirement.RequirementTypeId);
            if (type == null)
            {
                //No match, so use default
                remoteRequirement.RequirementTypeId = types.FirstOrDefault(p => p.IsDefault).RequirementTypeId;
            }
            else
            {
                remoteRequirement.RequirementTypeId = type.RequirementTypeId;
            }
        }
        ...
        public static void ConvertLegacyStaticIds(int projectTemplateId, RemoteTask remoteTask)
        {
            ...
            //Next type
            string staticName = "";
            switch (remoteTask.TaskTypeId)
            {
                case 1: staticName = "Development"; break;
                case 2: staticName = "Testing"; break;
                case 3: staticName = "Management"; break;
                case 4: staticName = "Infrastructure"; break;
                case 5: staticName = "Other"; break;
            }
            List<TaskType> types = taskManager.TaskType_Retrieve(projectTemplateId, false);
            TaskType type = types.FirstOrDefault(p => p.Name == staticName || p.TaskTypeId == remoteTask.TaskTypeId);
            if (type == null)
            {
                //No match, so use default
                remoteTask.TaskTypeId = types.FirstOrDefault(p => p.IsDefault).TaskTypeId;
            }
            else
            {
                remoteTask.TaskTypeId = type.TaskTypeId;
            }
        }
        ...
        public static void ConvertLegacyStaticIds(int projectTemplateId, RemoteTestCase remoteTestCase)
        {
            ...
            //Next type
            string staticName = "";
            switch (remoteTestCase.TestCaseTypeId)
            {
                case 1: staticName = "Acceptance"; break;
                case 2: staticName = "Compatibility"; break;
                case 3: staticName = "Functional"; break;
                case 4: staticName = "Integration"; break;
                case 5: staticName = "Load/Performance"; break;
                case 6: staticName = "Network"; break;
                case 7: staticName = "Regression"; break;
                case 8: staticName = "Scenario"; break;
                case 9: staticName = "Security"; break;
                case 10: staticName = "Unit"; break;
                case 11: staticName = "Usability"; break;
                case 12: staticName = "Exploratory"; break;
            }
            List<TestCaseType> types = taskManager.TestCaseType_Retrieve(projectTemplateId, false);
            TestCaseType type = types.FirstOrDefault(p => p.Name == staticName || p.TestCaseTypeId == remoteTestCase.TestCaseTypeId);
            if (type == null)
            {
                //No match, so use default
                remoteTestCase.TestCaseTypeId = types.FirstOrDefault(p => p.IsDefault).TestCaseTypeId;
            }
            else
            {
                remoteTestCase.TestCaseTypeId = type.TestCaseTypeId;
            }
        }
        ...
        public static void UpdateTestCaseData(int projectTemplateId, TestCase testCase, RemoteTestCase remoteTestCase)
        {
            ...
            testCase.TestCaseTypeId = remoteTestCase.TestCaseTypeId;
        ...
        public static void UpdateTaskData(int projectTemplateId, Task task, RemoteTask remoteTask)
        {
            ...
            task.TaskTypeId = remoteTask.TaskTypeId;
        ...
        public static void UpdateRequirementData(int projectTemplateId, Requirement requirement, RemoteRequirement remoteRequirement)
        {
            ...
            requirement.RequirementTypeId = remoteRequirement.RequirementTypeId;

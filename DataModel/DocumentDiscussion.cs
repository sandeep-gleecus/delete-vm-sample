...
namespace Inflectra.SpiraTest.DataModel
{
    ...
    public partial class DocumentDiscussion: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        public int ArtifactId
        {
            ...
            set
            {
                if (_artifactId != value)
                {
                    ...
                    if (!IsDeserializing)
                    {
                        if (Document != null && Document.AttachmentId != value)
                        {
                            Document = null;
                        }
                    }
        ...
        private void FixupDocument(Attachment previousValue)
        {
            if (IsDeserializing)
            {
                return;
            ...
            if (Document != null)
            {
                if (!Document.Discussions.Contains(this))
                {
                    Document.Discussions.Add(this);
                }
    
                ArtifactId = Document.AttachmentId;
            }
        ...
        private void FixupCreator(User previousValue)
        {
            ...
            if (previousValue != null && previousValue.DocumentDiscussions.Contains(this))
            {
                previousValue.DocumentDiscussions.Remove(this);
            }
    
            if (Creator != null)
            {
                if (!Creator.DocumentDiscussions.Contains(this))
                {
                    Creator.DocumentDiscussions.Add(this);
                }

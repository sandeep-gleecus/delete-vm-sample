...
namespace Inflectra.SpiraTest.DataModel
{
    ...
    public partial class RequirementWorkflowCustomProperty: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        private void FixupCustomProperty(CustomProperty previousValue)
        {
            ...
            {
                if (!CustomProperty.RequirementWorkflowFields.Contains(this))
                {
                    CustomProperty.RequirementWorkflowFields.Add(this);
                }
        ...
        private void FixupRequirementStatus(RequirementStatus previousValue)
        {
            ...
            {
                if (!RequirementStatus.WorkflowCustomProperties.Contains(this))
                {
                    RequirementStatus.WorkflowCustomProperties.Add(this);
                }
        ...
        private void FixupFieldState(WorkflowFieldState previousValue)
        {
            ...
            if (previousValue != null && previousValue.RequirementCustomProperties.Contains(this))
            {
                previousValue.RequirementCustomProperties.Remove(this);
            }
    
            if (FieldState != null)
            {
                if (!FieldState.RequirementCustomProperties.Contains(this))
                {
                    FieldState.RequirementCustomProperties.Add(this);
                }

...
namespace Inflectra.SpiraTest.DataModel
{
    ...
    public partial class WorkflowTransitionRole: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        private void FixupTransition(WorkflowTransition previousValue)
        {
            if (IsDeserializing)
            {
                return;
        ...
        private void FixupRole(ProjectRole previousValue)
        {
            ...
            if (previousValue != null && previousValue.IncidentWorkflowTransitionRoles.Contains(this))
            {
                previousValue.IncidentWorkflowTransitionRoles.Remove(this);
            }
    
            if (Role != null)
            {
                if (!Role.IncidentWorkflowTransitionRoles.Contains(this))
                {
                    Role.IncidentWorkflowTransitionRoles.Add(this);
                }
        ...
        private void FixupType(WorkflowTransitionRoleType previousValue)
        {
            ...
            if (Type != null)
            {
                if (!Type.IncidentWorkflowTransitionRoles.Contains(this))
                {
                    Type.IncidentWorkflowTransitionRoles.Add(this);
                }

...
{
    /// <summary>
    /// Displays the admin page for adding new users to a project group
    /// </summary>
    [
    HeaderSettings(GlobalNavigation.NavigationHighlightedLink.Administration, "Admin_ProjectGroupMembershipAdd_Title", "System-Workspaces/#viewedit-programs", "Admin_ProjectGroupMembershipAdd_Title"),
    ...
    public partial class MembershipAdd : AdministrationBase
    {
        private const string CLASS_NAME = "Inflectra.SpiraTest.Web.Administration.Program.MembershipAdd::";
        ...
        protected override void OnInit(EventArgs e)
        {
            ...
            ((FilterSortFieldEx)this.grdUserManagement.Columns[4]).SubHeaderText = GlobalFunctions.ARTIFACT_PREFIX_USER;
            ((FilterSortFieldEx)this.grdUserManagement.Columns[4]).DataFormatString = GlobalFunctions.ARTIFACT_PREFIX_USER + GlobalFunctions.FORMAT_ID;
        }
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                Response.Redirect("~/Administration/ProgramList.aspx", true);
                return;
            }
            ...
            //Set the URL to go back to the program edit page
            this.lnkBackToProjectGroupMembership.NavigateUrl = UrlRoots.RetrieveGroupAdminUrl(ProjectGroupId.Value, "Edit");
        ...
        protected void LoadAndBindData()
        {
            ...
            //Get the filter list and sort expression as a local variable
            UserSettingsCollection filterList = GetUserSettings(GlobalFunctions.USER_SETTINGS_ADMINISTRATION_PROJECT_GROUP_MEMBERSHIP_ADD_FILTERS);
            string sortExpression = GetUserSetting(GlobalFunctions.USER_SETTINGS_ADMINISTRATION_PROJECT_GROUP_MEMBERSHIP_ADD_PAGINATION, GlobalFunctions.USER_SETTINGS_KEY_SORT_EXPRESSION, "Profile.FirstName ASC");
            int startingIndex = GetUserSetting(GlobalFunctions.USER_SETTINGS_ADMINISTRATION_PROJECT_GROUP_MEMBERSHIP_ADD_PAGINATION, GlobalFunctions.USER_SETTINGS_KEY_PAGINATION_START_ROW, 0);
            int pageSize = GetUserSetting(GlobalFunctions.USER_SETTINGS_ADMINISTRATION_PROJECT_GROUP_MEMBERSHIP_ADD_PAGINATION, GlobalFunctions.USER_SETTINGS_KEY_PAGINATION_PAGE_SIZE, 15);
            ...
            int totalCount;
            List<User> users = userManager.GetUsers(filterList, sortExpression, 0, Int32.MaxValue, GlobalFunctions.GetCurrentTimezoneUtcOffset(), out totalCount, false, false, null, ProjectGroupId.Value);
            ...
            catch (Exception)
            {
                startingIndex = 0;
                this.grdUserManagement.PageIndex = startingIndex;
                SaveUserSetting(GlobalFunctions.USER_SETTINGS_ADMINISTRATION_PROJECT_GROUP_MEMBERSHIP_ADD_PAGINATION, GlobalFunctions.USER_SETTINGS_KEY_PAGINATION_START_ROW, startingIndex);
                this.grdUserManagement.DataBind();
            }

            //Set the name of the project group on the page
        ...
        void btnCancel_Click(object sender, EventArgs e)
        {
            ...
            //Redirect back to the project group details page
            Response.Redirect(UrlRoots.RetrieveGroupAdminUrl(ProjectGroupId.Value, "Edit"));
        ...
        private void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            //Instantiate business objects and get current project membership
            ...
            foreach (GridViewRow gridViewRow in this.grdUserManagement.Rows)
            {
                if (gridViewRow.RowType == DataControlRowType.DataRow)
                {
                    ...
                    DropDownListEx ddlProjectGroupRole = (DropDownListEx)gridViewRow.Cells[5].FindControl("ddlProjectGroupRole");
                    if (ddlProjectGroupRole != null && ddlProjectGroupRole.SelectedValue != "")
                    {
                        int userId = Int32.Parse(ddlProjectGroupRole.MetaData);
                        int projectGroupRoleId = Int32.Parse(ddlProjectGroupRole.SelectedValue);

                        //Add the new membership record
                        ...
                        newProjectGroupUser.ProjectGroupRoleId = projectGroupRoleId;
            ...
            catch (ProjectDuplicateMembershipRecordException)
            {
                ...
                this.lblMessage.Text = Resources.Messages.Admin_ProjectGroupMembershipAdd_UserAlreadyMember;
        ...
        private void grdUserManagement_RowCommand(object source, GridViewCommandEventArgs e)
        {
            ...
            {
                //Update the sort
                SaveUserSetting(GlobalFunctions.USER_SETTINGS_ADMINISTRATION_PROJECT_GROUP_MEMBERSHIP_ADD_PAGINATION, GlobalFunctions.USER_SETTINGS_KEY_SORT_EXPRESSION, e.CommandArgument.ToString());
                LoadAndBindData();
            }
        ...
        private void grdUserManagement_PageIndexChanging(object source, GridViewPageEventArgs e)
        {
            ...
            try
            {
                ...
                UserSettingsCollection paginationSettings = GetUserSettings(GlobalFunctions.USER_SETTINGS_ADMINISTRATION_PROJECT_GROUP_MEMBERSHIP_ADD_PAGINATION);

<%@ Page
	...
	CodeBehind="BaselineArtifactDetails.aspx.cs"
	Inherits="Inflectra.SpiraTest.Web.Administration.Project.BaselineArtifactDetails" %>
...
<asp:Content ContentPlaceHolderID="cplAdministrationContent" runat="server">
    ...
    <div class="btn-group mb4" role="group">
		<tstsc:DropMenu ID="btnBackList" runat="server" Text="<%$Resources:Buttons,BackToBaseline %>" GlyphIconCssClass="fas fa-arrow-left mr3" CausesValidation="false" />
	</div>

	<h2 class="mb2">
		<asp:Literal runat="server" Text="<%$ Resources:Main,Admin_BaselineArtifactDetails %>" />:
		<tstsc:ImageEx ID="imgArtifact" runat="server" AlternateText="<%$Resources:Fields,Artifact %>" CssClass="w5 h5" />
	...
	<h3 class="mt0">
        ...
        <tstsc:LabelEx ID="lblBaseline" runat="server" />
	</h3>
	

	<p>
		<tstsc:LabelEx runat="server" Text="<%$Resources:Messages,Admin_BaselineArtifactDetails %>" />
	</p>

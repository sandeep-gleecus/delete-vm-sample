...
{
    /// <summary>
    /// Echoes back the image data as a BMP download
    /// </summary>
    public class GraphImageBmp : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            else
            {
                ...
                context.Response.AddHeader("Content-Type", "image/bmp");
                context.Response.AddHeader("Content-Disposition", "attachment; filename=graph.bmp");

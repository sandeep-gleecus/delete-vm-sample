...
namespace Inflectra.SpiraTest.Common
{
	...
	public partial class IncidentStatusResponse : IObjectWithChangeTracker, INotifyPropertyChanged
	{
		...
		[DataMember]
		public Nullable<int> IncidentWorkflowId
		{
			get { return _incidentWorkflowId; }
			set
			{
				if (_incidentWorkflowId != value)
				{
					...
					_incidentWorkflowId = value;
					OnPropertyChanged("IncidentWorkflowId");
				}
			}
		}
		private Nullable<int> _incidentWorkflowId;
		...
		public int InputIncidentStatusId
		{
			...
			set
			{
				if (_inputIncidentStatusId != value)
				{
					if (!IsDeserializing)
					{
						if (InputIncidentStatus != null && InputIncidentStatus.IncidentStatusId != value)
						{
							InputIncidentStatus = null;
						}
					}
		...
		public int OutputIncidentStatusId
		{
			...
			set
			{
				if (_outputIncidentStatusId != value)
				{
					if (!IsDeserializing)
					{
						if (OutputIncidentStatus != null && OutputIncidentStatus.IncidentStatusId != value)
						{
							OutputIncidentStatus = null;
						}
					}
		...
		[DataMember]
		public IncidentStatus InputIncidentStatus
		{
			get { return _inputIncidentStatus; }
			set
			{
				if (!ReferenceEquals(_inputIncidentStatus, value))
				{
					var previousValue = _inputIncidentStatus;
					_inputIncidentStatus = value;
					OnNavigationPropertyChanged("InputIncidentStatusStatus");
				}
			}
		}
		private IncidentStatus _inputIncidentStatus;

		[DataMember]
		public IncidentStatus OutputIncidentStatus
		{
			get { return _outputIncidentStatus; }
			set
			{
				if (!ReferenceEquals(_outputIncidentStatus, value))
				{
					var previousValue = _outputIncidentStatus;
					_outputIncidentStatus = value;
					OnNavigationPropertyChanged("OutputIncidentStatus");
				}
			}
		}
		private IncidentStatus _outputIncidentStatus;

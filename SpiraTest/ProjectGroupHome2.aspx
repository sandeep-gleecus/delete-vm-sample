<%@ Page 
    ...
    CodeBehind="ProjectGroupHome2.aspx.cs" 
    Inherits="Inflectra.SpiraTest.Web.ProjectGroupHome2" 
    Title="Untitled Page" 
    %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cplMainContent" runat="server">
    <tstsc:UpdatePanelEx ID="ajaxWebParts" runat="server">
        <ContentTemplate>
            <tstsc:WebPartManagerEx ID="prtManager" runat="server" DashboardName="ProjectGroupHome2" OnInit="prtManager_Init"  OnAuthorizeWebPart="prtManager_AuthorizeWebPart">
                <StaticConnections>
                </StaticConnections>

...
{
    public partial class LockedOutUsers : WebPartBase, IWebPartReloadable
    {
        private const string CLASS_NAME = "Inflectra.SpiraTest.Web.UserControls.WebParts.Administration.LockedOutUsers::";
        ...
        public void LoadAndBindData()
        {
            ...
            try
            {
                ...
                filterList["IsApproved"] = true;
                filterList["IsLocked"] = true;
                filterList["IsActive"] = true;

                //Get the list of pending user requests
                Business.UserManager userManager = new Business.UserManager();
                int totalCount = 0;
                List<DataModel.User> users = userManager.GetUsers(filterList, "LastLockoutDate DESC", 0, RowsToDisplay, GlobalFunctions.GetCurrentTimezoneUtcOffset(), out totalCount, true, true);

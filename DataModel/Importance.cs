...
namespace Inflectra.SpiraTest.DataModel
{
    ...
    public partial class Importance: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        public int ImportanceId
        {
            ...
            set
            {
                if (_importanceId != value)
                {
                    ...
                    {
                        throw new InvalidOperationException("The property 'ImportanceId' is part of the object's key and cannot be changed. Changes to key properties can only be made when the object is not being tracked or is in the Added state.");
                    }
                    _importanceId = value;
        ...
        private void FixupProjectTemplate(ProjectTemplate previousValue)
        {
            ...
            if (previousValue != null && previousValue.Importances.Contains(this))
            {
                previousValue.Importances.Remove(this);
            }
    
            if (ProjectTemplate != null)
            {
                if (!ProjectTemplate.Importances.Contains(this))
                {
                    ProjectTemplate.Importances.Add(this);
                }
        ...
        private void FixupRequirements(object sender, NotifyCollectionChangedEventArgs e)
        {
            ...
            if (e.OldItems != null)
            {
                ...
                {
                    if (ReferenceEquals(item.Importance, this))
                    {

<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Schedule.ascx.cs" Inherits="Inflectra.SpiraTest.Web.UserControls.WebParts.ProjectGroupHome.Schedule" %>
...
<script type="text/javascript">
    ...
    $('#help-WorkspaceSchedule').popover({
        content: resx.InAppHelp_Chart_ProgramSchedule,
        placement: "left",
        trigger: "hover focus",

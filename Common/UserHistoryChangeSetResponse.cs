...
{
	public partial class UserHistoryChangeSetResponse : IObjectWithChangeTracker, INotifyPropertyChanged
	{
		...
		public int UpdatedUserId
		{
			...
			set
			{
				if (_updatedUserId != value)
				{
					if (ChangeTracker.ChangeTrackingEnabled && ChangeTracker.State != ObjectState.Added)
					{
						throw new InvalidOperationException("The property 'UpdatedUserId' is part of the object's key and cannot be changed. Changes to key properties can only be made when the object is not being tracked or is in the Added state.");
					}
		...
		[DataMember]
		public Nullable<System.DateTime> LastLogoutDate
		{
		...
		private Nullable<System.DateTime> _lastLogoutDate;

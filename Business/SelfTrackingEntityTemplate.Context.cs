...
namespace Inflectra.SpiraTest.Business
{
    public partial class SpiraTestEntities : ObjectContext
    {
		...
		{
			get { return _userHistoryChangesets ?? (_userHistoryChangesets = CreateObjectSet<TST_USER_HISTORY_CHANGESET>("TST_USER_HISTORY_CHANGESET")); }
		}
        ...
        /// </summary>
        /// <param name="projectId">No Metadata Documentation available.</param>
        public virtual int Project_DeleteDataMappings(Nullable<int> projectId, int userId)
        {
		...
		public virtual ObjectResult<decimal> PercentageCalculation(Nullable<int> month, Nullable<int> year)
		{
			...
			return base.ExecuteFunction<decimal>("PERCENTAGE_CALCULATION_ACTIVE_USERS", monthParameter, yearParameter);
		}
		...
		/// </summary>
		/// <param name="year">No Metadata Documentation available.</param>
		public virtual ObjectResult<SYSTEM_USAGE_REPORT_Result> GetSustemUsageReport(string year)
		{

			ObjectParameter yearParameter;
				yearParameter = new ObjectParameter("year", year);
			
			return base.ExecuteFunction<SYSTEM_USAGE_REPORT_Result>("SYSTEM_USAGE_REPORT", yearParameter);
		}

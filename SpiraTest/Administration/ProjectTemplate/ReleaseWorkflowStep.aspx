<%@ Page Language="c#" CodeBehind="ReleaseWorkflowStep.aspx.cs" AutoEventWireup="True"
    Inherits="Inflectra.SpiraTest.Web.Administration.ProjectTemplate.ReleaseWorkflowStep" MasterPageFile="~/MasterPages/Administration.master" %>
	...
	<div class="container-fluid">
        <div class="row">
            <div class="col-lg-9">
                                    ...
                                    <Columns>
                                        <asp:TemplateColumn ItemStyle-CssClass="pa0">
                                            <ItemTemplate>
                                                ...
                                                <div class="Step">
                                                    <tstsc:HyperLinkEx runat="server" Font-Italic="false" NavigateUrl='<%# UrlRoots.RetrieveTemplateAdminUrl(ProjectTemplateId, "ReleaseWorkflowTransition") + "?" + GlobalFunctions.PARAMETER_WORKFLOW_ID + "=" + workflowId.ToString() + "&" + GlobalFunctions.PARAMETER_WORKFLOW_TRANSITION_ID + "=" + ((Inflectra.SpiraTest.DataModel.ReleaseWorkflowTransition) Container.DataItem).WorkflowTransitionId%>'
                                                        ID="Hyperlink1"><%#: ((Inflectra.SpiraTest.DataModel.ReleaseWorkflowTransition)Container.DataItem).Name + " (" + GlobalFunctions.ARTIFACT_PREFIX_WORKFLOW_TRANSITION + ((Inflectra.SpiraTest.DataModel.ReleaseWorkflowTransition)Container.DataItem).WorkflowTransitionId + ")"%></tstsc:HyperLinkEx>
                                                </div>
                                                <div style="height: 2px; font-size: 1pt">
                                                </div>
                                            </ItemTemplate>
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateColumn ItemStyle-CssClass="pa0">
                                            <ItemTemplate>
                                                ...
                                                <div class="Step">
                                                    <tstsc:HyperLinkEx runat="server" Font-Italic="false" NavigateUrl='<%# UrlRoots.RetrieveTemplateAdminUrl(ProjectTemplateId, "ReleaseWorkflowTransition") + "?" + GlobalFunctions.PARAMETER_WORKFLOW_ID + "=" + workflowId.ToString() + "&" + GlobalFunctions.PARAMETER_WORKFLOW_TRANSITION_ID + "=" + ((Inflectra.SpiraTest.DataModel.ReleaseWorkflowTransition) Container.DataItem).WorkflowTransitionId%>'><%#: ((Inflectra.SpiraTest.DataModel.ReleaseWorkflowTransition)Container.DataItem).Name + " (" + GlobalFunctions.ARTIFACT_PREFIX_WORKFLOW_TRANSITION + ((Inflectra.SpiraTest.DataModel.ReleaseWorkflowTransition)Container.DataItem).WorkflowTransitionId + ")"%></tstsc:HyperLinkEx>
                                                </div>
                                                <div style="height: 2px; font-size: 1pt">
                                                </div>
                                            </ItemTemplate>
                ...
                <h3>
                    <asp:Localize runat="server" Text="<%$Resources:Main,Admin_ReleaseWorkflowStep_ReleaseFields %>" />
                </h3>
                <p>
                    <asp:Localize runat="server" Text="<%$Resources:Main,Admin_ReleaseWorkflowStep_ReleaseFieldsIntro %>" />
                </p>
                <div style="max-width: 550px">
                    <tstsc:GridViewEx ID="grdReleaseFields" runat="server" AutoGenerateColumns="False"
                ...
                <div class="mt4 btn-group">
                    ...
                    <tstsc:HyperLinkEx ID="HyperLinkEx2" runat="server" NavigateUrl='<%# UrlRoots.RetrieveTemplateAdminUrl(ProjectTemplateId, "ReleaseWorkflowDetails") + "?" + GlobalFunctions.PARAMETER_WORKFLOW_ID + "=" + workflowId.ToString()%>' Text="<%$Resources:Buttons,Cancel %>" CssClass="btn btn-default" />
                </div>
                <h3>
                    <asp:Localize ID="Localize1" runat="server" Text="<%$Resources:Main,Admin_ReleaseWorkflowStep_ReleaseCustomProperties %>" />
                </h3>
                <p>
                    <asp:Localize ID="Localize2" runat="server" Text="<%$Resources:Main,Admin_ReleaseWorkflowStep_ReleaseCustomPropertiesIntro %>" />
                </p>
                <div style="max-width: 550px">
                    <tstsc:GridViewEx ID="grdReleaseCustomProperties" runat="server" AutoGenerateColumns="False"
                ...
                <div class="mt4 btn-group">
                    ...
                    <tstsc:HyperLinkEx ID="HyperLinkEx1" runat="server" NavigateUrl='<%# UrlRoots.RetrieveTemplateAdminUrl(ProjectTemplateId, "ReleaseWorkflowDetails") + "?" + GlobalFunctions.PARAMETER_WORKFLOW_ID + "=" + workflowId.ToString()%>' Text="<%$Resources:Buttons,Cancel %>" CssClass="btn btn-default" />
                </div>
            </div>
        </div>
    </div>

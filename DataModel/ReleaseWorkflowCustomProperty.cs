...
namespace Inflectra.SpiraTest.DataModel
{
    ...
    public partial class ReleaseWorkflowCustomProperty: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        private void FixupCustomProperty(CustomProperty previousValue)
        {
            ...
            {
                if (!CustomProperty.ReleaseWorkflowFields.Contains(this))
                {
                    CustomProperty.ReleaseWorkflowFields.Add(this);
                }
        ...
        private void FixupReleaseStatus(ReleaseStatus previousValue)
        {
            ...
            {
                if (!ReleaseStatus.WorkflowCustomProperties.Contains(this))
                {
                    ReleaseStatus.WorkflowCustomProperties.Add(this);
                }
        ...
        private void FixupFieldState(WorkflowFieldState previousValue)
        {
            ...
            if (previousValue != null && previousValue.ReleaseCustomProperties.Contains(this))
            {
                previousValue.ReleaseCustomProperties.Remove(this);
            }
    
            if (FieldState != null)
            {
                if (!FieldState.ReleaseCustomProperties.Contains(this))
                {
                    FieldState.ReleaseCustomProperties.Add(this);
                }

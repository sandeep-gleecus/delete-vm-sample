...
namespace Inflectra.SpiraTest.Web.Services.v5_0.DataObjects
{
    ...
    public class MultiValueFilter
    {
        ...
        /// Constructor
        /// </summary>
        public MultiValueFilter(Common.MultiValueFilter multiValueFilter)
        {
            this.internalMultiValueFilter = multiValueFilter;
        }
    ...
    public class DateRange
    {
        ...
        /// Constructor
        /// </summary>
        public DateRange(Common.DateRange dateRange)
        {

...
namespace Inflectra.SpiraTest.DataModel
{
    ...
    public partial class R_Component: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        public int COMPONENT_ID
        {
            ...
            set
            {
                if (_cOMPONENT_ID != value)
                {
                    ...
                    {
                        throw new InvalidOperationException("The property 'COMPONENT_ID' is part of the object's key and cannot be changed. Changes to key properties can only be made when the object is not being tracked or is in the Added state.");
                    }
                    _cOMPONENT_ID = value;

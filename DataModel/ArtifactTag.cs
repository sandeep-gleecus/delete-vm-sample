...
namespace Inflectra.SpiraTest.DataModel
{
    ...
    public partial class ArtifactTag: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        private void FixupArtifactType(ArtifactType previousValue)
        {
            ...
            if (previousValue != null && previousValue.ArtifactTags.Contains(this))
            {
                previousValue.ArtifactTags.Remove(this);
            }
    
            if (ArtifactType != null)
            {
                if (!ArtifactType.ArtifactTags.Contains(this))
                {
                    ArtifactType.ArtifactTags.Add(this);
                }
        ...
        private void FixupProject(Project previousValue)
        {
            ...
            if (Project != null)
            {
                if (!Project.ArtifactTags.Contains(this))
                {
                    Project.ArtifactTags.Add(this);
                }

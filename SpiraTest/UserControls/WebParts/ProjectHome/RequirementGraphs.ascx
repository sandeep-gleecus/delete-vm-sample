<%@ Control Language="C#" AutoEventWireup="True" CodeBehind="RequirementGraphs.ascx.cs" Inherits="Inflectra.SpiraTest.Web.UserControls.WebParts.ProjectHome.RequirementGraphs" %>
<a 
    aria-label="More Information About This Item"
    class="u-help" 
    id="help-RequirementGraphs"  
    role="button" 
    tabindex="0" 
    >
...
<script type="text/javascript">
    ...
    $('#help-RequirementGraphs').popover({

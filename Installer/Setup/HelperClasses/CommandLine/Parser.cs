...
{
	/// <summary>Provides methods to parse command line arguments.</summary>
	public class Parser : IDisposable
	{
		...
		/// <summary>Initializes a new instance of the <see cref="CommandLine.Parser"/> class.</summary>
		public Parser()
		{
			Settings = new ParserSettings { Consumed = true };
		}

		/// <summary>Initializes a new instance of the <see cref="Parser"/> class, configurable with <see cref="ParserSettings"/> using a delegate.</summary>
		/// <param name="configuration">The <see cref="Action&lt;ParserSettings&gt;"/> delegate used to configure aspects and behaviors of the parser.</param>
		...
		/// <summary>Finalizes an instance of the <see cref="CommandLine.Parser"/> class.</summary>
		~Parser()
		{
			Dispose(false);
		}

		/// <summary>Gets the singleton instance created with basic defaults.</summary>
		public static Parser Default
		{
			get { return DefaultParser.Value; }
		}

		/// <summary>Gets the instance that implements <see cref="CommandLine.ParserSettings"/> in use.</summary>
		public ParserSettings Settings { get; }

		/// <summary>Parses a string array of command line arguments constructing values in an instance of type <typeparamref name="T"/>.
		/// Grammar rules are defined decorating public properties with appropriate attributes.</summary>
		...
		/// <summary>Parses a string array of command line arguments for verb commands scenario, constructing the proper instance from the array of types supplied by <paramref name="types"/>.
		/// Grammar rules are defined decorating public properties with appropriate attributes.
		/// The <see cref="CommandLine.VerbAttribute"/> must be applied to types in the array.</summary>
		/// <param name="args">A <see cref="System.String"/> array of command line arguments, normally supplied by application entry point.</param>
		...
		/// <summary>Frees resources owned by the instance.</summary>
		public void Dispose()
		{
			Dispose(true);

...
namespace Inflectra.SpiraTest.Web
{
	...
	public partial class ProjectGroupHome : PageLayout
	{
		private const string CLASS_NAME = "Inflectra.SpiraTest.Web.ProjectGroupHome::";
		...
		protected void Page_Load(object sender, EventArgs e)
		{
            ...
            if (ProjectGroupId.HasValue)
            {
                ...
                if (!IsPostBack)
                {
                    ...
                    if (preferredHome != "General")
                    {
                        SaveUserSetting(GlobalFunctions.USER_SETTINGS_PROJECT_GROUP_HOME_GENERAL, GlobalFunctions.PROJECT_SETTINGS_KEY_HOME_PAGE, "General");
                    }
                }
            }
            else

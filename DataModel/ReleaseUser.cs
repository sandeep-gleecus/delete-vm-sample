...
namespace Inflectra.SpiraTest.DataModel
{
    ...
    public partial class ReleaseUser: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        private void FixupRelease(Release previousValue)
        {
            ...
            if (Release != null)
            {
                if (!Release.UserViewState.Contains(this))
                {
                    Release.UserViewState.Add(this);
                }
        ...
        private void FixupUser(User previousValue)
        {
            ...
            if (previousValue != null && previousValue.ReleaseViewState.Contains(this))
            {
                previousValue.ReleaseViewState.Remove(this);
            }
    
            if (User != null)
            {
                if (!User.ReleaseViewState.Contains(this))
                {
                    User.ReleaseViewState.Add(this);
                }

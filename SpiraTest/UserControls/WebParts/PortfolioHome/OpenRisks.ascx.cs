...
{
	/// <summary>
	/// Displays the list of porfolio-wide risks
	/// </summary>
	public partial class OpenRisks : WebPartBase, IWebPartReloadable
	{
		private const string CLASS_NAME = "Inflectra.SpiraTest.Web.UserControls.WebParts.PortfolioHome.OpenRisks::";
		...
		public void LoadAndBindData()
		{
            ...
            List<RiskView> openRisks = riskManager.Risk_RetrieveOpenForPortfolio(portfolioId, RowsToDisplay);

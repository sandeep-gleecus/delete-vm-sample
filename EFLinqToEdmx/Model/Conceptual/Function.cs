  ...
  public class Function : XTypedElement, IXMetaData
  {
    ...
    public IList<FunctionParameter> Parameters
    {
      get
      {
        ...
        {
          _parameterField = new XTypedList<FunctionParameter>(this, LinqToXsdTypeManager.Instance, XName.Get("Parameter", "http://schemas.microsoft.com/ado/2009/11/edm"));
        }
      ...
      set
      {
        ...
        else
        {
          if ((_parameterField == null))
          {
            _parameterField = XTypedList<FunctionParameter>.Initialize(this, LinqToXsdTypeManager.Instance, value, XName.Get("Parameter", "http://schemas.microsoft.com/ado/2009/11/edm"));
          }
          else
          {
    ...
    public IList<string> DefiningExpression
    {
      get
      {
        ...
        {
          _definingExpressionField = new XSimpleList<string>(this, XmlSchemaType.GetBuiltInSimpleType(XmlTypeCode.String).Datatype, XName.Get("DefiningExpression", "http://schemas.microsoft.com/ado/2009/11/edm"));
        }
      ...
      set
      {
        ...
        else
        {
          if ((_definingExpressionField == null))
          {
            _definingExpressionField = XSimpleList<string>.Initialize(this, XmlSchemaType.GetBuiltInSimpleType(XmlTypeCode.String).Datatype, value, XName.Get("DefiningExpression", "http://schemas.microsoft.com/ado/2009/11/edm"));
          }
          else
          {
    ...
    public IList<FunctionReturnType> ReturnTypes
    {
      get
      {
        ...
        {
          _returnTypeField = new XTypedList<FunctionReturnType>(this, LinqToXsdTypeManager.Instance, XName.Get("ReturnType", "http://schemas.microsoft.com/ado/2009/11/edm"));
        }
      ...
      set
      {
        ...
        else
        {
          if ((_returnTypeField == null))
          {
            _returnTypeField = XTypedList<FunctionReturnType>.Initialize(this, LinqToXsdTypeManager.Instance, value, XName.Get("ReturnType", "http://schemas.microsoft.com/ado/2009/11/edm"));
          }
          else
          {
    ...
    public object MaxLength
    {
      ...
      set
      {
        SetAttribute(XName.Get("MaxLength", ""), value, XmlSchemaType.GetBuiltInSimpleType(XmlTypeCode.AnyAtomicType).Datatype);
      }
    }
    ...
    XName IXMetaData.SchemaName
    {
      get
      {
        return XName.Get("TFunction", "http://schemas.microsoft.com/ado/2009/11/edm");
      }
    }
    ...
    private static void BuildElementDictionary()
    {
      ...
      LocalElementDictionary.Add(XName.Get("Parameter", "http://schemas.microsoft.com/ado/2009/11/edm"), typeof (FunctionParameter));
      LocalElementDictionary.Add(XName.Get("DefiningExpression", "http://schemas.microsoft.com/ado/2009/11/edm"), typeof (string));
      LocalElementDictionary.Add(XName.Get("ReturnType", "http://schemas.microsoft.com/ado/2009/11/edm"), typeof (FunctionReturnType));
    }

    private static void InitFsm()
    {
      var transitions = new Dictionary<int, Transitions>();
      transitions.Add(1, new Transitions(new SingleTransition(XName.Get("Documentation", "http://schemas.microsoft.com/ado/2009/11/edm"), 2), new SingleTransition(XName.Get("Parameter", "http://schemas.microsoft.com/ado/2009/11/edm"), 3), new SingleTransition(XName.Get("DefiningExpression", "http://schemas.microsoft.com/ado/2009/11/edm"), 3), new SingleTransition(XName.Get("ReturnType", "http://schemas.microsoft.com/ado/2009/11/edm"), 3), new SingleTransition(new WildCard("##other", "http://schemas.microsoft.com/ado/2009/11/edm"), 9)));
      transitions.Add(2, new Transitions(new SingleTransition(XName.Get("Parameter", "http://schemas.microsoft.com/ado/2009/11/edm"), 2), new SingleTransition(XName.Get("DefiningExpression", "http://schemas.microsoft.com/ado/2009/11/edm"), 2), new SingleTransition(XName.Get("ReturnType", "http://schemas.microsoft.com/ado/2009/11/edm"), 2), new SingleTransition(new WildCard("##other", "http://schemas.microsoft.com/ado/2009/11/edm"), 9)));
      transitions.Add(9, new Transitions(new SingleTransition(XName.Get("Parameter", "http://schemas.microsoft.com/ado/2009/11/edm"), 3), new SingleTransition(XName.Get("DefiningExpression", "http://schemas.microsoft.com/ado/2009/11/edm"), 3), new SingleTransition(XName.Get("ReturnType", "http://schemas.microsoft.com/ado/2009/11/edm"), 3), new SingleTransition(new WildCard("##other", "http://schemas.microsoft.com/ado/2009/11/edm"), 3)));
      transitions.Add(3, new Transitions(new SingleTransition(XName.Get("Parameter", "http://schemas.microsoft.com/ado/2009/11/edm"), 3), new SingleTransition(XName.Get("DefiningExpression", "http://schemas.microsoft.com/ado/2009/11/edm"), 3), new SingleTransition(XName.Get("ReturnType", "http://schemas.microsoft.com/ado/2009/11/edm"), 3), new SingleTransition(new WildCard("##other", "http://schemas.microsoft.com/ado/2009/11/edm"), 9)));

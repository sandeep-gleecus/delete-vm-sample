...
namespace Inflectra.SpiraTest.Web.Administration.Project
{
	...
	public partial class TaraVaultProjectSettings : AdministrationBase
	{
		private const string CLASS_NAME = "Web.Administration.Project.TaraVaultProjectSettings::";
		...
		protected void Page_Load(object sender, EventArgs e)
		{
            ...
            //If not activated, go to project admin home
            ...
            //Link to project admin home
            this.lnkhome.NavigateUrl = UrlRewriterModule.RetrieveProjectAdminUrl(ProjectId, "Default");
        ...
        private void BtnDeleteCache_Click(object sender, EventArgs e)
        {
            ...
            {
                //Create instance..
                SourceCodeManager sourceCodeManager = new SourceCodeManager(this.ProjectId, true);

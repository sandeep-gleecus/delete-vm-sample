...
namespace Inflectra.SpiraTest.DataModel
{
    ...
    public partial class R_TaskPriority: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        public int TASK_PRIORITY_ID
        {
            ...
            set
            {
                if (_tASK_PRIORITY_ID != value)
                {
                    ...
                    {
                        throw new InvalidOperationException("The property 'TASK_PRIORITY_ID' is part of the object's key and cannot be changed. Changes to key properties can only be made when the object is not being tracked or is in the Added state.");
                    }

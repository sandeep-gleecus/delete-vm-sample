...
namespace Inflectra.SpiraTest.DataModel
{
    ...
    public partial class TaskWorkflowCustomProperty: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        private void FixupCustomProperty(CustomProperty previousValue)
        {
            ...
            {
                if (!CustomProperty.TaskWorkflowFields.Contains(this))
                {
                    CustomProperty.TaskWorkflowFields.Add(this);
                }
        ...
        private void FixupTaskStatus(TaskStatus previousValue)
        {
            ...
            if (TaskStatus != null)
            {
                if (!TaskStatus.WorkflowCustomProperties.Contains(this))
                {
                    TaskStatus.WorkflowCustomProperties.Add(this);
                }
        ...
        private void FixupFieldState(WorkflowFieldState previousValue)
        {
            ...
            if (previousValue != null && previousValue.TaskCustomProperties.Contains(this))
            {
                previousValue.TaskCustomProperties.Remove(this);
            }
    
            if (FieldState != null)
            {
                if (!FieldState.TaskCustomProperties.Contains(this))
                {
                    FieldState.TaskCustomProperties.Add(this);
                }

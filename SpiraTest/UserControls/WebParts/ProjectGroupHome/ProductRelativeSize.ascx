<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ProductRelativeSize.ascx.cs" Inherits="Inflectra.SpiraTest.Web.UserControls.WebParts.ProjectGroupHome.ProductRelativeSize" %>
...
<script type="text/javascript">
    ...
    $('#help-RelativeSize').popover({
        content: resx.InAppHelp_Chart_ProductRelativeSize,
        placement: "left",
        trigger: "hover focus",

...
namespace Inflectra.SpiraTest.DataModel
{
    ...
    public partial class UserRecentArtifact: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        public System.DateTime LastAccessDate
        {
            ...
            set
            {
                ...
                {
                    ChangeTracker.RecordOriginalValue("LastAccessDate", _lastAccessDate);
        ...
        private void FixupArtifactType(ArtifactType previousValue)
        {
            ...
            if (previousValue != null && previousValue.RecentArtifacts.Contains(this))
            {
                previousValue.RecentArtifacts.Remove(this);
            }
    
            if (ArtifactType != null)
            {
                if (!ArtifactType.RecentArtifacts.Contains(this))
                {
                    ArtifactType.RecentArtifacts.Add(this);
                }
        ...
        private void FixupProject(Project previousValue)
        {
            ...
            if (Project != null)
            {
                if (!Project.RecentArtifacts.Contains(this))
                {
                    Project.RecentArtifacts.Add(this);
                }
        ...
        private void FixupUser(User previousValue)
        {
            ...
            if (User != null)
            {
                if (!User.RecentArtifacts.Contains(this))
                {
                    User.RecentArtifacts.Add(this);
                }

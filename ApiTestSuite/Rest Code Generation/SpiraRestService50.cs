...
namespace Inflectra.SpiraTest.ApiTestSuite.Rest_Code_Generation.SpiraRestService50
{
	...
	{
		protected string baseUrl = "http://tardis/spira/services/v5_0/RestService.svc";
		...
		public RemoteComponent Component_Create(RemoteCredentials credentials, object project_id, RemoteComponent remoteComponent)
		{
			...
			{
				JsonSerializerSettings settings = new JsonSerializerSettings() {DateFormatHandling= DateFormatHandling.MicrosoftDateFormat};
				request.Body = JsonConvert.SerializeObject(remoteComponent, settings);
            ...
            if (!response.IsErrorStatus && response.Headers.FirstOrDefault(h => h.Name == Properties.Resources.Rest_StatusCode).Value == "200 OK")
            {
				...
				else
				{
					...
					JsonSerializerSettings settings = new JsonSerializerSettings() {DateFormatHandling= DateFormatHandling.MicrosoftDateFormat};
					RemoteComponent responseObj = JsonConvert.DeserializeObject<RemoteComponent>(response.Body, settings);
					return responseObj;
				}
            }
			else
		...
		public RemoteProjectArtifact[] DataMapping_SearchArtifactMappings(RemoteCredentials credentials, object data_sync_system_id, object artifact_type_id, String externalKey)
		{
			...
			{
				JsonSerializerSettings settings = new JsonSerializerSettings() {DateFormatHandling= DateFormatHandling.MicrosoftDateFormat};
				request.Body = JsonConvert.SerializeObject(externalKey, settings);
            ...
            if (!response.IsErrorStatus && response.Headers.FirstOrDefault(h => h.Name == Properties.Resources.Rest_StatusCode).Value == "200 OK")
            {
				...
				else
				{
					...
					JsonSerializerSettings settings = new JsonSerializerSettings() {DateFormatHandling= DateFormatHandling.MicrosoftDateFormat};
					RemoteProjectArtifact[] responseObj = JsonConvert.DeserializeObject<RemoteProjectArtifact[]>(response.Body, settings);
					return responseObj;
				}
            }
			else
		...
		public RemoteDataSyncSystem DataSyncSystem_Create(RemoteCredentials credentials, RemoteDataSyncSystem remoteDataSyncSystem)
		{
			...
			{
				JsonSerializerSettings settings = new JsonSerializerSettings() {DateFormatHandling= DateFormatHandling.MicrosoftDateFormat};
				request.Body = JsonConvert.SerializeObject(remoteDataSyncSystem, settings);
		...
		public RemoteHistoryChange[] History_RetrieveForArtifact1(RemoteCredentials credentials, object project_id, object artifact_type_id, object artifact_id, object start_row, object number_rows, object sort_property, object sort_direction)
		{
            ...
            if (!response.IsErrorStatus && response.Headers.FirstOrDefault(h => h.Name == Properties.Resources.Rest_StatusCode).Value == "200 OK")
            {
				...
				else
				{
					...
					JsonSerializerSettings settings = new JsonSerializerSettings() {DateFormatHandling= DateFormatHandling.MicrosoftDateFormat};
					RemoteHistoryChange[] responseObj = JsonConvert.DeserializeObject<RemoteHistoryChange[]>(response.Body, settings);
					return responseObj;
				}
            }
			else
		...
		public RemoteHistoryChangeSet History_RetrieveById(RemoteCredentials credentials, object project_id, object history_change_set_id)
		{
            ...
            if (!response.IsErrorStatus && response.Headers.FirstOrDefault(h => h.Name == Properties.Resources.Rest_StatusCode).Value == "200 OK")
            {
				...
				else
				{
					...
					JsonSerializerSettings settings = new JsonSerializerSettings() {DateFormatHandling= DateFormatHandling.MicrosoftDateFormat};
					RemoteHistoryChangeSet responseObj = JsonConvert.DeserializeObject<RemoteHistoryChangeSet>(response.Body, settings);
					return responseObj;
				}
            }
			else
		...
		public RemoteWorkflowTransition[] Incident_RetrieveWorkflowTransitions(RemoteCredentials credentials, object project_id, object incident_type_id, object incident_status_id, object is_detector, object is_owner)
		{
            ...
            if (!response.IsErrorStatus && response.Headers.FirstOrDefault(h => h.Name == Properties.Resources.Rest_StatusCode).Value == "200 OK")
            {
				...
				else
				{
					...
					JsonSerializerSettings settings = new JsonSerializerSettings() {DateFormatHandling= DateFormatHandling.MicrosoftDateFormat};
					RemoteWorkflowTransition[] responseObj = JsonConvert.DeserializeObject<RemoteWorkflowTransition[]>(response.Body, settings);
					return responseObj;
				}
            }
			else
		...
		public RemoteWorkflowField[] Incident_RetrieveWorkflowFields(RemoteCredentials credentials, object project_id, object incident_type_id, object incident_status_id)
		{
            ...
            if (!response.IsErrorStatus && response.Headers.FirstOrDefault(h => h.Name == Properties.Resources.Rest_StatusCode).Value == "200 OK")
            {
				...
				else
				{
					...
					JsonSerializerSettings settings = new JsonSerializerSettings() {DateFormatHandling= DateFormatHandling.MicrosoftDateFormat};
					RemoteWorkflowField[] responseObj = JsonConvert.DeserializeObject<RemoteWorkflowField[]>(response.Body, settings);
					return responseObj;
				}
            }
			else
		...
		public RemoteWorkflowCustomProperty[] Incident_RetrieveWorkflowCustomProperties(RemoteCredentials credentials, object project_id, object incident_type_id, object incident_status_id)
		{
            ...
            if (!response.IsErrorStatus && response.Headers.FirstOrDefault(h => h.Name == Properties.Resources.Rest_StatusCode).Value == "200 OK")
            {
				...
				else
				{
					...
					JsonSerializerSettings settings = new JsonSerializerSettings() {DateFormatHandling= DateFormatHandling.MicrosoftDateFormat};
					RemoteWorkflowCustomProperty[] responseObj = JsonConvert.DeserializeObject<RemoteWorkflowCustomProperty[]>(response.Body, settings);
					return responseObj;
				}
            }
			else
		...
		public RemoteMessageInfo Message_GetInfo(RemoteCredentials credentials)
		{
            ...
            if (!response.IsErrorStatus && response.Headers.FirstOrDefault(h => h.Name == Properties.Resources.Rest_StatusCode).Value == "200 OK")
            {
				...
				else
				{
					...
					JsonSerializerSettings settings = new JsonSerializerSettings() {DateFormatHandling= DateFormatHandling.MicrosoftDateFormat};
					RemoteMessageInfo responseObj = JsonConvert.DeserializeObject<RemoteMessageInfo>(response.Body, settings);
					return responseObj;
				}
            }
			else
		...
		public Int64 Message_PostNew(RemoteCredentials credentials, RemoteMessageIndividual remoteMessage)
		{
			...
			{
				JsonSerializerSettings settings = new JsonSerializerSettings() {DateFormatHandling= DateFormatHandling.MicrosoftDateFormat};
				request.Body = JsonConvert.SerializeObject(remoteMessage, settings);
		...
		public RemoteUserMessage[] Message_GetUnreadMessageSenders(RemoteCredentials credentials)
		{
            ...
            if (!response.IsErrorStatus && response.Headers.FirstOrDefault(h => h.Name == Properties.Resources.Rest_StatusCode).Value == "200 OK")
            {
				...
				else
				{
					...
					JsonSerializerSettings settings = new JsonSerializerSettings() {DateFormatHandling= DateFormatHandling.MicrosoftDateFormat};
					RemoteUserMessage[] responseObj = JsonConvert.DeserializeObject<RemoteUserMessage[]>(response.Body, settings);
					return responseObj;
				}
            }
			else
		...
		public RemoteMessage[] Message_RetrieveUnread(RemoteCredentials credentials)
		{
            ...
            if (!response.IsErrorStatus && response.Headers.FirstOrDefault(h => h.Name == Properties.Resources.Rest_StatusCode).Value == "200 OK")
            {
				...
				else
				{
					...
					JsonSerializerSettings settings = new JsonSerializerSettings() {DateFormatHandling= DateFormatHandling.MicrosoftDateFormat};
					RemoteMessage[] responseObj = JsonConvert.DeserializeObject<RemoteMessage[]>(response.Body, settings);
					return responseObj;
				}
            }
			else
		...
		public void Project_AddUserMembership(RemoteCredentials credentials, object project_id, RemoteProjectUser remoteProjectUser)
		{
			...
			{
				JsonSerializerSettings settings = new JsonSerializerSettings() {DateFormatHandling= DateFormatHandling.MicrosoftDateFormat};
				request.Body = JsonConvert.SerializeObject(remoteProjectUser, settings);
		...
		public RemoteReleaseStatus[] Release_RetrieveStatuses(RemoteCredentials credentials, object project_id)
		{
			string path = "projects/{project_id}/releases/statuses";
            ...
            if (!response.IsErrorStatus && response.Headers.FirstOrDefault(h => h.Name == Properties.Resources.Rest_StatusCode).Value == "200 OK")
            {
				...
				else
				{
					...
					JsonSerializerSettings settings = new JsonSerializerSettings() {DateFormatHandling= DateFormatHandling.MicrosoftDateFormat};
					RemoteReleaseStatus[] responseObj = JsonConvert.DeserializeObject<RemoteReleaseStatus[]>(response.Body, settings);
					return responseObj;
				}
            }
			else
		...
		public RemoteReleaseType[] Release_RetrieveTypes(RemoteCredentials credentials, object project_id)
		{
			string path = "projects/{project_id}/releases/types";
            ...
            if (!response.IsErrorStatus && response.Headers.FirstOrDefault(h => h.Name == Properties.Resources.Rest_StatusCode).Value == "200 OK")
            {
				...
				else
				{
					...
					JsonSerializerSettings settings = new JsonSerializerSettings() {DateFormatHandling= DateFormatHandling.MicrosoftDateFormat};
					RemoteReleaseType[] responseObj = JsonConvert.DeserializeObject<RemoteReleaseType[]>(response.Body, settings);
					return responseObj;
				}
            }
			else
		...
		public RemoteWorkflowField[] Release_RetrieveWorkflowFields(RemoteCredentials credentials, object project_id, object release_type_id, object release_status_id)
		{
			string path = "projects/{project_id}/releases/types/{release_type_id}/workflow/fields?status_id={release_status_id}";
		...
		public RemoteWorkflowCustomProperty[] Release_RetrieveWorkflowCustomProperties(RemoteCredentials credentials, object project_id, object release_type_id, object release_status_id)
		{
			string path = "projects/{project_id}/releases/types/{release_type_id}/workflow/custom-properties?status_id={release_status_id}";
		...
		public void Requirement_MoveToEnd(RemoteCredentials credentials, object project_id, object requirement_id)
		{
			string path = "projects/{project_id}/requirements/{requirement_id}/move";

            //Create the request
            RestRequest request = new RestRequest("Requirement_MoveToEnd");
			if (credentials != null)
			{
				request.Credential = new System.Net.NetworkCredential();
				request.Credential.UserName = credentials.UserName;
		...
		public RemoteRequirementStatus[] Requirement_RetrieveStatuses(RemoteCredentials credentials, object project_id)
		{
			string path = "projects/{project_id}/requirements/statuses";
            ...
            if (!response.IsErrorStatus && response.Headers.FirstOrDefault(h => h.Name == Properties.Resources.Rest_StatusCode).Value == "200 OK")
            {
				...
				else
				{
					...
					JsonSerializerSettings settings = new JsonSerializerSettings() {DateFormatHandling= DateFormatHandling.MicrosoftDateFormat};
					RemoteRequirementStatus[] responseObj = JsonConvert.DeserializeObject<RemoteRequirementStatus[]>(response.Body, settings);
					return responseObj;
				}
            }
			else
		...
		public RemoteRequirementStep[] Requirement_RetrieveSteps(RemoteCredentials credentials, object project_id, object requirement_id)
		{
            ...
            if (!response.IsErrorStatus && response.Headers.FirstOrDefault(h => h.Name == Properties.Resources.Rest_StatusCode).Value == "200 OK")
            {
				...
				else
				{
					...
					JsonSerializerSettings settings = new JsonSerializerSettings() {DateFormatHandling= DateFormatHandling.MicrosoftDateFormat};
					RemoteRequirementStep[] responseObj = JsonConvert.DeserializeObject<RemoteRequirementStep[]>(response.Body, settings);
					return responseObj;
				}
            }
			else
		...
		public RemoteRequirementStep Requirement_AddStep(RemoteCredentials credentials, object project_id, object requirement_id, object existing_requirement_step_id, object creator_id, RemoteRequirementStep remoteRequirementStep)
		{
			...
			{
				JsonSerializerSettings settings = new JsonSerializerSettings() {DateFormatHandling= DateFormatHandling.MicrosoftDateFormat};
				request.Body = JsonConvert.SerializeObject(remoteRequirementStep, settings);
		...
		public void Requirement_AddTestStepCoverage(RemoteCredentials credentials, object project_id, RemoteRequirementTestStepMapping remoteReqTestStepMapping)
		{
			...
			{
				JsonSerializerSettings settings = new JsonSerializerSettings() {DateFormatHandling= DateFormatHandling.MicrosoftDateFormat};
				request.Body = JsonConvert.SerializeObject(remoteReqTestStepMapping, settings);
		...
		public RemoteRequirementTestStepMapping[] Requirement_RetrieveTestStepCoverage(RemoteCredentials credentials, object project_id, object requirement_id)
		{
            ...
            if (!response.IsErrorStatus && response.Headers.FirstOrDefault(h => h.Name == Properties.Resources.Rest_StatusCode).Value == "200 OK")
            {
				...
				else
				{
					...
					JsonSerializerSettings settings = new JsonSerializerSettings() {DateFormatHandling= DateFormatHandling.MicrosoftDateFormat};
					RemoteRequirementTestStepMapping[] responseObj = JsonConvert.DeserializeObject<RemoteRequirementTestStepMapping[]>(response.Body, settings);
					return responseObj;
				}
            }
			else
		...
		public RemoteRequirementType[] Requirement_RetrieveTypes(RemoteCredentials credentials, object project_id)
		{
			string path = "projects/{project_id}/requirements/types";
            ...
            if (!response.IsErrorStatus && response.Headers.FirstOrDefault(h => h.Name == Properties.Resources.Rest_StatusCode).Value == "200 OK")
            {
				...
				else
				{
					...
					JsonSerializerSettings settings = new JsonSerializerSettings() {DateFormatHandling= DateFormatHandling.MicrosoftDateFormat};
					RemoteRequirementType[] responseObj = JsonConvert.DeserializeObject<RemoteRequirementType[]>(response.Body, settings);
					return responseObj;
				}
            }
			else
		...
		public RemoteWorkflowField[] Requirement_RetrieveWorkflowFields(RemoteCredentials credentials, object project_id, object requirement_type_id, object requirement_status_id)
		{
			string path = "projects/{project_id}/requirements/types/{requirement_type_id}/workflow/fields?status_id={requirement_status_id}";
		...
		public RemoteWorkflowCustomProperty[] Requirement_RetrieveWorkflowCustomProperties(RemoteCredentials credentials, object project_id, object requirement_type_id, object requirement_status_id)
		{
			string path = "projects/{project_id}/requirements/types/{requirement_type_id}/workflow/custom-properties?status_id={requirement_status_id}";
		...
		public RemoteSavedFilter[] SavedFilter_RetrieveForUser(RemoteCredentials credentials)
		{
            ...
            if (!response.IsErrorStatus && response.Headers.FirstOrDefault(h => h.Name == Properties.Resources.Rest_StatusCode).Value == "200 OK")
            {
				...
				else
				{
					...
					JsonSerializerSettings settings = new JsonSerializerSettings() {DateFormatHandling= DateFormatHandling.MicrosoftDateFormat};
					RemoteSavedFilter[] responseObj = JsonConvert.DeserializeObject<RemoteSavedFilter[]>(response.Body, settings);
					return responseObj;
				}
            }
			else
		...
		public RemoteSourceCodeBranch[] SourceCode_RetrieveBranches(RemoteCredentials credentials, object project_id)
		{
            ...
            if (!response.IsErrorStatus && response.Headers.FirstOrDefault(h => h.Name == Properties.Resources.Rest_StatusCode).Value == "200 OK")
            {
				...
				else
				{
					...
					JsonSerializerSettings settings = new JsonSerializerSettings() {DateFormatHandling= DateFormatHandling.MicrosoftDateFormat};
					RemoteSourceCodeBranch[] responseObj = JsonConvert.DeserializeObject<RemoteSourceCodeBranch[]>(response.Body, settings);
					return responseObj;
				}
            }
			else
		...
		public RemoteSourceCodeFile[] SourceCode_RetrieveFilesByFolder(RemoteCredentials credentials, object project_id, object branch_id, object folder_id)
		{
            ...
            if (!response.IsErrorStatus && response.Headers.FirstOrDefault(h => h.Name == Properties.Resources.Rest_StatusCode).Value == "200 OK")
            {
				...
				else
				{
					...
					JsonSerializerSettings settings = new JsonSerializerSettings() {DateFormatHandling= DateFormatHandling.MicrosoftDateFormat};
					RemoteSourceCodeFile[] responseObj = JsonConvert.DeserializeObject<RemoteSourceCodeFile[]>(response.Body, settings);
					return responseObj;
				}
            }
			else
		...
		public RemoteSourceCodeFolder[] SourceCode_RetrieveFoldersByParent(RemoteCredentials credentials, object project_id, object branch_id, object parent_folder_id)
		{
            ...
            if (!response.IsErrorStatus && response.Headers.FirstOrDefault(h => h.Name == Properties.Resources.Rest_StatusCode).Value == "200 OK")
            {
				...
				else
				{
					...
					JsonSerializerSettings settings = new JsonSerializerSettings() {DateFormatHandling= DateFormatHandling.MicrosoftDateFormat};
					RemoteSourceCodeFolder[] responseObj = JsonConvert.DeserializeObject<RemoteSourceCodeFolder[]>(response.Body, settings);
					return responseObj;
				}
            }
			else
		...
		public RemoteSourceCodeRevision[] SourceCode_RetrieveRevisions(RemoteCredentials credentials, object project_id, object branch_id, object start_Row, object number_rows, object sort_property, object sort_direction, RemoteFilter[] remoteFilters)
		{
            ...
            if (!response.IsErrorStatus && response.Headers.FirstOrDefault(h => h.Name == Properties.Resources.Rest_StatusCode).Value == "200 OK")
            {
				...
				else
				{
					...
					JsonSerializerSettings settings = new JsonSerializerSettings() {DateFormatHandling= DateFormatHandling.MicrosoftDateFormat};
					RemoteSourceCodeRevision[] responseObj = JsonConvert.DeserializeObject<RemoteSourceCodeRevision[]>(response.Body, settings);
					return responseObj;
				}
            }
			else
		...
		public RemoteLinkedArtifact[] SourceCode_RetrieveArtifactsForRevision(RemoteCredentials credentials, object project_id, object branch_id, object revision_id)
		{
            ...
            if (!response.IsErrorStatus && response.Headers.FirstOrDefault(h => h.Name == Properties.Resources.Rest_StatusCode).Value == "200 OK")
            {
				...
				else
				{
					...
					JsonSerializerSettings settings = new JsonSerializerSettings() {DateFormatHandling= DateFormatHandling.MicrosoftDateFormat};
					RemoteLinkedArtifact[] responseObj = JsonConvert.DeserializeObject<RemoteLinkedArtifact[]>(response.Body, settings);
					return responseObj;
				}
            }
			else
		...
		public RemoteArtifactSubscription[] Subscription_RetrieveForUser(RemoteCredentials credentials)
		{
            ...
            if (!response.IsErrorStatus && response.Headers.FirstOrDefault(h => h.Name == Properties.Resources.Rest_StatusCode).Value == "200 OK")
            {
				...
				else
				{
					...
					JsonSerializerSettings settings = new JsonSerializerSettings() {DateFormatHandling= DateFormatHandling.MicrosoftDateFormat};
					RemoteArtifactSubscription[] responseObj = JsonConvert.DeserializeObject<RemoteArtifactSubscription[]>(response.Body, settings);
					return responseObj;
				}
            }
			else
		...
		public RemoteTaskFolder[] Task_RetrieveFolders(RemoteCredentials credentials, object project_id)
		{
            ...
            if (!response.IsErrorStatus && response.Headers.FirstOrDefault(h => h.Name == Properties.Resources.Rest_StatusCode).Value == "200 OK")
            {
				...
				else
				{
					...
					JsonSerializerSettings settings = new JsonSerializerSettings() {DateFormatHandling= DateFormatHandling.MicrosoftDateFormat};
					RemoteTaskFolder[] responseObj = JsonConvert.DeserializeObject<RemoteTaskFolder[]>(response.Body, settings);
					return responseObj;
				}
            }
			else
		...
		public RemoteTaskFolder Task_CreateFolder(RemoteCredentials credentials, object project_id, RemoteTaskFolder remoteTaskFolder)
		{
			...
			{
				JsonSerializerSettings settings = new JsonSerializerSettings() {DateFormatHandling= DateFormatHandling.MicrosoftDateFormat};
				request.Body = JsonConvert.SerializeObject(remoteTaskFolder, settings);
		...
		public RemoteTaskStatus[] Task_RetrieveStatuses(RemoteCredentials credentials, object project_id)
		{
			string path = "projects/{project_id}/tasks/statuses";
            ...
            if (!response.IsErrorStatus && response.Headers.FirstOrDefault(h => h.Name == Properties.Resources.Rest_StatusCode).Value == "200 OK")
            {
				...
				else
				{
					...
					JsonSerializerSettings settings = new JsonSerializerSettings() {DateFormatHandling= DateFormatHandling.MicrosoftDateFormat};
					RemoteTaskStatus[] responseObj = JsonConvert.DeserializeObject<RemoteTaskStatus[]>(response.Body, settings);
					return responseObj;
				}
            }
			else
		...
		public RemoteTaskType[] Task_RetrieveTypes(RemoteCredentials credentials, object project_id)
		{
			string path = "projects/{project_id}/tasks/types";
            ...
            if (!response.IsErrorStatus && response.Headers.FirstOrDefault(h => h.Name == Properties.Resources.Rest_StatusCode).Value == "200 OK")
            {
				...
				else
				{
					...
					JsonSerializerSettings settings = new JsonSerializerSettings() {DateFormatHandling= DateFormatHandling.MicrosoftDateFormat};
					RemoteTaskType[] responseObj = JsonConvert.DeserializeObject<RemoteTaskType[]>(response.Body, settings);
					return responseObj;
				}
            }
			else
		...
		public RemoteWorkflowField[] Task_RetrieveWorkflowFields(RemoteCredentials credentials, object project_id, object task_type_id, object task_status_id)
		{
			string path = "projects/{project_id}/tasks/types/{task_type_id}/workflow/fields?status_id={task_status_id}";
		...
		public RemoteWorkflowCustomProperty[] Task_RetrieveWorkflowCustomProperties(RemoteCredentials credentials, object project_id, object task_type_id, object task_status_id)
		{
			string path = "projects/{project_id}/tasks/types/{task_type_id}/workflow/custom-properties?status_id={task_status_id}";
		...
		public RemoteTestCaseFolder[] TestCase_RetrieveFolders(RemoteCredentials credentials, object project_id)
		{
            ...
            if (!response.IsErrorStatus && response.Headers.FirstOrDefault(h => h.Name == Properties.Resources.Rest_StatusCode).Value == "200 OK")
            {
				...
				else
				{
					...
					JsonSerializerSettings settings = new JsonSerializerSettings() {DateFormatHandling= DateFormatHandling.MicrosoftDateFormat};
					RemoteTestCaseFolder[] responseObj = JsonConvert.DeserializeObject<RemoteTestCaseFolder[]>(response.Body, settings);
					return responseObj;
				}
            }
			else
		...
		public RemoteTestCaseFolder TestCase_CreateFolder(RemoteCredentials credentials, object project_id, RemoteTestCaseFolder remoteTestCaseFolder)
		{
			...
			{
				JsonSerializerSettings settings = new JsonSerializerSettings() {DateFormatHandling= DateFormatHandling.MicrosoftDateFormat};
				request.Body = JsonConvert.SerializeObject(remoteTestCaseFolder, settings);
		...
		public RemoteTestCaseStatus[] TestCase_RetrieveStatuses(RemoteCredentials credentials, object project_id)
		{
			string path = "projects/{project_id}/test-cases/statuses";
            ...
            if (!response.IsErrorStatus && response.Headers.FirstOrDefault(h => h.Name == Properties.Resources.Rest_StatusCode).Value == "200 OK")
            {
				...
				else
				{
					...
					JsonSerializerSettings settings = new JsonSerializerSettings() {DateFormatHandling= DateFormatHandling.MicrosoftDateFormat};
					RemoteTestCaseStatus[] responseObj = JsonConvert.DeserializeObject<RemoteTestCaseStatus[]>(response.Body, settings);
					return responseObj;
				}
            }
			else
		...
		public RemoteTestCaseType[] TestCase_RetrieveTypes(RemoteCredentials credentials, object project_id)
		{
			string path = "projects/{project_id}/test-cases/types";
            ...
            if (!response.IsErrorStatus && response.Headers.FirstOrDefault(h => h.Name == Properties.Resources.Rest_StatusCode).Value == "200 OK")
            {
				...
				else
				{
					...
					JsonSerializerSettings settings = new JsonSerializerSettings() {DateFormatHandling= DateFormatHandling.MicrosoftDateFormat};
					RemoteTestCaseType[] responseObj = JsonConvert.DeserializeObject<RemoteTestCaseType[]>(response.Body, settings);
					return responseObj;
				}
            }
			else
		...
		public RemoteWorkflowField[] TestCase_RetrieveWorkflowFields(RemoteCredentials credentials, object project_id, object test_case_type_id, object test_case_status_id)
		{
			string path = "projects/{project_id}/test-cases/types/{test_case_type_id}/workflow/fields?status_id={test_case_status_id}";
		...
		public RemoteWorkflowCustomProperty[] TestCase_RetrieveWorkflowCustomProperties(RemoteCredentials credentials, object project_id, object test_case_type_id, object test_case_status_id)
		{
			string path = "projects/{project_id}/test-cases/types/{test_case_type_id}/workflow/custom-properties?status_id={test_case_status_id}";
		...
		public RemoteTestConfigurationSet TestConfiguration_RetrieveSetById(RemoteCredentials credentials, object project_id, object test_configuration_set_id)
		{
            ...
            if (!response.IsErrorStatus && response.Headers.FirstOrDefault(h => h.Name == Properties.Resources.Rest_StatusCode).Value == "200 OK")
            {
				...
				else
				{
					...
					JsonSerializerSettings settings = new JsonSerializerSettings() {DateFormatHandling= DateFormatHandling.MicrosoftDateFormat};
					RemoteTestConfigurationSet responseObj = JsonConvert.DeserializeObject<RemoteTestConfigurationSet>(response.Body, settings);
					return responseObj;
				}
            }
			else
		...
		public RemoteTestSetFolder TestSet_CreateFolder(RemoteCredentials credentials, object project_id, RemoteTestSetFolder remoteTestSetFolder)
		{
			...
			{
				JsonSerializerSettings settings = new JsonSerializerSettings() {DateFormatHandling= DateFormatHandling.MicrosoftDateFormat};
				request.Body = JsonConvert.SerializeObject(remoteTestSetFolder, settings);
            ...
            if (!response.IsErrorStatus && response.Headers.FirstOrDefault(h => h.Name == Properties.Resources.Rest_StatusCode).Value == "200 OK")
            {
				...
				else
				{
					...
					JsonSerializerSettings settings = new JsonSerializerSettings() {DateFormatHandling= DateFormatHandling.MicrosoftDateFormat};
					RemoteTestSetFolder responseObj = JsonConvert.DeserializeObject<RemoteTestSetFolder>(response.Body, settings);
					return responseObj;
				}
            }
			else
		...
		public RemoteTestSetParameter[] TestSet_RetrieveParameters(RemoteCredentials credentials, object project_id, object test_set_id)
		{
            ...
            if (!response.IsErrorStatus && response.Headers.FirstOrDefault(h => h.Name == Properties.Resources.Rest_StatusCode).Value == "200 OK")
            {
				...
				else
				{
					...
					JsonSerializerSettings settings = new JsonSerializerSettings() {DateFormatHandling= DateFormatHandling.MicrosoftDateFormat};
					RemoteTestSetParameter[] responseObj = JsonConvert.DeserializeObject<RemoteTestSetParameter[]>(response.Body, settings);
					return responseObj;
				}
            }
			else
		...
		public RemoteTestSetTestCaseParameter[] TestSet_RetrieveTestCaseParameters(RemoteCredentials credentials, object project_id, object test_set_id, object test_set_test_case_id)
		{
            ...
            if (!response.IsErrorStatus && response.Headers.FirstOrDefault(h => h.Name == Properties.Resources.Rest_StatusCode).Value == "200 OK")
            {
				...
				else
				{
					...
					JsonSerializerSettings settings = new JsonSerializerSettings() {DateFormatHandling= DateFormatHandling.MicrosoftDateFormat};
					RemoteTestSetTestCaseParameter[] responseObj = JsonConvert.DeserializeObject<RemoteTestSetTestCaseParameter[]>(response.Body, settings);
					return responseObj;
				}
            }
			else
	...
	{
			public System.Int32 HistoryChangeId { get; set; }
			public System.Int32 ChangeSetId { get; set; }
			public System.Nullable<System.Int32> CustomPropertyId { get; set; }
	...
	{
			public System.Int32 HistoryChangeSetId { get; set; }
			public System.Int32 ProjectId { get; set; }

...
<html>
  ...
  <head runat=server>
    ...
    <title><%#Inflectra.SpiraTest.Common.ConfigurationSettings.Default.License_ProductType%>: <%#ServiceName + " SOAP " + GetLocalizedText("WebService")%></title>

  </head>

  <body>

    <p class="heading1"><%#Inflectra.SpiraTest.Common.ConfigurationSettings.Default.License_ProductType%>: <%#ServiceName%> SOAP Web Service</p><br>

    <div id="content" class="asmxBody">

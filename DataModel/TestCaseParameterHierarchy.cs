...
namespace Inflectra.SpiraTest.DataModel
{
    ...
    public partial class TestCaseParameterHierarchy: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        private void FixupProject(Project previousValue)
        {
            ...
            if (previousValue != null && previousValue.TestCaseParameterHierarchies.Contains(this))
            {
                previousValue.TestCaseParameterHierarchies.Remove(this);
            }
    
            if (Project != null)
            {
                if (!Project.TestCaseParameterHierarchies.Contains(this))
                {
                    Project.TestCaseParameterHierarchies.Add(this);
                }

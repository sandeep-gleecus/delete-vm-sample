...
namespace Inflectra.SpiraTest.DataModel
{
    ...
    public partial class ProjectTagFrequency: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        public int Frequency
        {
            ...
            set
            {
                if (_frequency != value)
                {
                    ChangeTracker.RecordOriginalValue("Frequency", _frequency);
                    _frequency = value;
        ...
        private void FixupProject(Project previousValue)
        {
            ...
            if (previousValue != null && previousValue.TagFrequencies.Contains(this))
            {
                previousValue.TagFrequencies.Remove(this);
            }
    
            if (Project != null)
            {
                if (!Project.TagFrequencies.Contains(this))
                {
                    Project.TagFrequencies.Add(this);
                }

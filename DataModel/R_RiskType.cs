...
namespace Inflectra.SpiraTest.DataModel
{
    ...
    public partial class R_RiskType: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        [DataMember]
        public int RISK_WORKFLOW_ID
        {
            get { return _rISK_WORKFLOW_ID; }
            set
            {
                if (_rISK_WORKFLOW_ID != value)
                {
                    if (ChangeTracker.ChangeTrackingEnabled && ChangeTracker.State != ObjectState.Added)
                    {
                        throw new InvalidOperationException("The property 'RISK_WORKFLOW_ID' is part of the object's key and cannot be changed. Changes to key properties can only be made when the object is not being tracked or is in the Added state.");
                    }
                    _rISK_WORKFLOW_ID = value;
                    OnPropertyChanged("RISK_WORKFLOW_ID");
                }
            }
        }
        private int _rISK_WORKFLOW_ID;

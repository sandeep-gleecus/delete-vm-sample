/***************************************************************
**	Insert script for table TST_TEST_CASE_PRIORITY
***************************************************************/
SET IDENTITY_INSERT TST_TEST_CASE_PRIORITY ON; 

INSERT INTO TST_TEST_CASE_PRIORITY
(
TEST_CASE_PRIORITY_ID, PROJECT_TEMPLATE_ID, NAME, IS_ACTIVE, COLOR, SCORE
)
VALUES
(
...
SET IDENTITY_INSERT TST_TEST_CASE_PRIORITY OFF; 

...
namespace Inflectra.SpiraTest.DataModel
{
    ...
    public partial class TemplateDataSource: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        #region Primitive Properties
    
        [DataMember]
        public int TemplateDataSourceId
        {
            get { return _templateDataSourceId; }
            set
            {
                if (_templateDataSourceId != value)
                {
                    if (ChangeTracker.ChangeTrackingEnabled && ChangeTracker.State != ObjectState.Added)
                    {
                        throw new InvalidOperationException("The property 'TemplateDataSourceId' is part of the object's key and cannot be changed. Changes to key properties can only be made when the object is not being tracked or is in the Added state.");
                    }
                    _templateDataSourceId = value;
                    OnPropertyChanged("TemplateDataSourceId");
                }
            }
        }
        private int _templateDataSourceId;
        ...
        public string ProviderClass
        {
            ...
            set
            {
                if (_providerClass != value)
                {
                    ChangeTracker.RecordOriginalValue("ProviderClass", _providerClass);
                    _providerClass = value;
                    OnPropertyChanged("ProviderClass");
                }
            }
        }
        ...
        private void FixupTST_TEMPLATE(Template previousValue)
        {
            ...
            if (previousValue != null && previousValue.TST_TEMPLATE_DATASOURCE.Contains(this))
            {
                previousValue.TST_TEMPLATE_DATASOURCE.Remove(this);
            }
    
            if (TST_TEMPLATE != null)
            {
                if (!TST_TEMPLATE.TST_TEMPLATE_DATASOURCE.Contains(this))
                {
                    TST_TEMPLATE.TST_TEMPLATE_DATASOURCE.Add(this);
                }

...
namespace Inflectra.SpiraTest.DataModel
{
    ...
    public partial class R_TestSetFolder: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        #region Primitive Properties
    
        [DataMember]
        public int TEST_SET_FOLDER_ID
        {
            ...
            set
            {
                if (_tEST_SET_FOLDER_ID != value)
                {
                    ...
                    {
                        throw new InvalidOperationException("The property 'TEST_SET_FOLDER_ID' is part of the object's key and cannot be changed. Changes to key properties can only be made when the object is not being tracked or is in the Added state.");
                    }
        ...
        private int _tEST_SET_FOLDER_ID;
        ...
        [DataMember]
        public Nullable<int> PARENT_TEST_SET_FOLDER_ID
        {
            get { return _pARENT_TEST_SET_FOLDER_ID; }
            set
            {
                if (_pARENT_TEST_SET_FOLDER_ID != value)
                {
                    ChangeTracker.RecordOriginalValue("PARENT_TEST_SET_FOLDER_ID", _pARENT_TEST_SET_FOLDER_ID);
                    _pARENT_TEST_SET_FOLDER_ID = value;
                    OnPropertyChanged("PARENT_TEST_SET_FOLDER_ID");
                }
            }
        }
        private Nullable<int> _pARENT_TEST_SET_FOLDER_ID;

...
namespace Inflectra.SpiraTest.DataModel
{
    ...
    public partial class R_IncidentPriority: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        public int PRIORITY_ID
        {
            ...
            set
            {
                if (_pRIORITY_ID != value)
                {
                    ...
                    {
                        throw new InvalidOperationException("The property 'PRIORITY_ID' is part of the object's key and cannot be changed. Changes to key properties can only be made when the object is not being tracked or is in the Added state.");
                    }
                    _pRIORITY_ID = value;

...
namespace Inflectra.SpiraTest.Web.UserControls.WebParts.EnterpriseHome
{
	/// <summary>
	/// Displays the list of enterprise-wide risks
	/// </summary>
	public partial class OpenRisks : WebPartBase, IWebPartReloadable
	{
		private const string CLASS_NAME = "Inflectra.SpiraTest.Web.UserControls.WebParts.EnterpriseHome.OpenRisks::";
		...
		public void LoadAndBindData()
		{
            ...
            List<RiskView> openRisks = riskManager.Risk_RetrieveAllOpen(RowsToDisplay);

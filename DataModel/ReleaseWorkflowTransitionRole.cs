...
namespace Inflectra.SpiraTest.DataModel
{
    ...
    public partial class ReleaseWorkflowTransitionRole: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        [DataMember]
        public ReleaseWorkflowTransition Transition
        {
        ...
        private ReleaseWorkflowTransition _transition;
        ...
        private void FixupRole(ProjectRole previousValue)
        {
            ...
            if (previousValue != null && previousValue.ReleaseWorkflowTransitionRoles.Contains(this))
            {
                previousValue.ReleaseWorkflowTransitionRoles.Remove(this);
            }
    
            if (Role != null)
            {
                if (!Role.ReleaseWorkflowTransitionRoles.Contains(this))
                {
                    Role.ReleaseWorkflowTransitionRoles.Add(this);
                }
        ...
        private void FixupTransition(ReleaseWorkflowTransition previousValue)
        {
            if (IsDeserializing)
            {
                return;
        ...
        private void FixupType(WorkflowTransitionRoleType previousValue)
        {
            ...
            if (Type != null)
            {
                if (!Type.ReleaseWorkflowTransitionRoles.Contains(this))
                {
                    Type.ReleaseWorkflowTransitionRoles.Add(this);
                }

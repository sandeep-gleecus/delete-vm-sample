<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ActivityFeed.ascx.cs" Inherits="Inflectra.SpiraTest.Web.UserControls.WebParts.ProjectHome.ActivityFeed" %>

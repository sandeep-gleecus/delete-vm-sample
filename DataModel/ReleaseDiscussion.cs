...
namespace Inflectra.SpiraTest.DataModel
{
    ...
    public partial class ReleaseDiscussion: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        private void FixupCreator(User previousValue)
        {
            ...
            if (previousValue != null && previousValue.ReleaseDiscussions.Contains(this))
            {
                previousValue.ReleaseDiscussions.Remove(this);
            }
    
            if (Creator != null)
            {
                if (!Creator.ReleaseDiscussions.Contains(this))
                {
                    Creator.ReleaseDiscussions.Add(this);
                }
        ...
        private void FixupRelease(Release previousValue)
        {
            ...
            if (Release != null)
            {
                if (!Release.Discussions.Contains(this))
                {
                    Release.Discussions.Add(this);
                }
    
                ArtifactId = Release.ReleaseId;
            }
            if (ChangeTracker.ChangeTrackingEnabled)
            {

...
namespace Inflectra.SpiraTest.DataModel
{
    ...
    public partial class ProjectView: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        public bool IsReqStatusByTasks
        {
            ...
            set
            {
                if (_isReqStatusByTasks != value)
                {
                    if (ChangeTracker.ChangeTrackingEnabled && ChangeTracker.State != ObjectState.Added)
                    {
                        throw new InvalidOperationException("The property 'IsReqStatusByTasks' is part of the object's key and cannot be changed. Changes to key properties can only be made when the object is not being tracked or is in the Added state.");
                    }
        ...
        public bool IsReqStatusByTestCases
        {
            ...
            set
            {
                if (_isReqStatusByTestCases != value)
                {
                    if (ChangeTracker.ChangeTrackingEnabled && ChangeTracker.State != ObjectState.Added)
                    {
                        throw new InvalidOperationException("The property 'IsReqStatusByTestCases' is part of the object's key and cannot be changed. Changes to key properties can only be made when the object is not being tracked or is in the Added state.");
                    }
        ...
        public bool IsEffortTestCases
        {
            ...
            set
            {
                if (_isEffortTestCases != value)
                {
                    if (ChangeTracker.ChangeTrackingEnabled && ChangeTracker.State != ObjectState.Added)
                    {
                        throw new InvalidOperationException("The property 'IsEffortTestCases' is part of the object's key and cannot be changed. Changes to key properties can only be made when the object is not being tracked or is in the Added state.");
                    }
        ...
        public bool IsReqStatusAutoPlanned
        {
            ...
            set
            {
                if (_isReqStatusAutoPlanned != value)
                {
                    if (ChangeTracker.ChangeTrackingEnabled && ChangeTracker.State != ObjectState.Added)
                    {
                        throw new InvalidOperationException("The property 'IsReqStatusAutoPlanned' is part of the object's key and cannot be changed. Changes to key properties can only be made when the object is not being tracked or is in the Added state.");
                    }
        ...
        {
            get { return _projectTemplateName; }
            set
            {
                if (_projectTemplateName != value)
                {
                    if (ChangeTracker.ChangeTrackingEnabled && ChangeTracker.State != ObjectState.Added)
                    {
                        throw new InvalidOperationException("The property 'ProjectTemplateName' is part of the object's key and cannot be changed. Changes to key properties can only be made when the object is not being tracked or is in the Added state.");
                    }
                    _projectTemplateName = value;
                    OnPropertyChanged("ProjectTemplateName");
                }
            }
        }
        private string _projectTemplateName;

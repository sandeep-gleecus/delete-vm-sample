<%@ Page Language="C#" MasterPageFile="~/MasterPages/Administration.master" AutoEventWireup="true"
    CodeBehind="ProgramCreate.aspx.cs" Inherits="Inflectra.SpiraTest.Web.Administration.ProgramCreate"
    Title="" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cplAdministrationContent" runat="server">
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-9">
                <h1>
                    <asp:Localize ID="Localize1" runat="server" Text="<%$Resources:Main,Admin_ProgramCreate_Title %>" />
                    <small>
                        <tstsc:LabelEx ID="lblProjectGroupName" runat="server" />
                    </small>
                </h1>
                <div class="btn-group priority1" role="group">
                    <tstsc:HyperLinkEx SkinID="ButtonDefault" ID="lnkBackToList" runat="server" NavigateUrl="ProgramList.aspx">
                        <span class="fas fa-arrow-left"></span>
                        <asp:Localize runat="server" Text="<%$Resources:Main,Admin_ProgramDetails_BackToList %>" />
                    </tstsc:HyperLinkEx>
                </div>

...
namespace Inflectra.SpiraTest.DataModel
{
    ...
    public partial class RiskWorkflow: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        [DataMember]
        public TrackableCollection<RiskWorkflowCustomProperty> CustomProperties
        {
            get
            {
                if (_customProperties == null)
                {
                    _customProperties = new TrackableCollection<RiskWorkflowCustomProperty>();
            ...
            set
            {
                if (!ReferenceEquals(_customProperties, value))
                {
                    ...
                    if (_customProperties != null)
                    {
                        ...
                        foreach (RiskWorkflowCustomProperty item in _customProperties)
                        {
        ...
        private TrackableCollection<RiskWorkflowCustomProperty> _customProperties;
    
        [DataMember]
        public TrackableCollection<RiskWorkflowField> Fields
        {
            get
            {
                if (_fields == null)
                {
                    _fields = new TrackableCollection<RiskWorkflowField>();
            ...
            set
            {
                if (!ReferenceEquals(_fields, value))
                {
                    ...
                    if (_fields != null)
                    {
                        ...
                        // This is the principal end in an association that performs cascade deletes.
                        // Remove the cascade delete event handler for any entities in the current collection.
                        foreach (RiskWorkflowField item in _fields)
                        {
                            ChangeTracker.ObjectStateChanging -= item.HandleCascadeDelete;
                        }
                    }
        ...
        private TrackableCollection<RiskWorkflowField> _fields;
    
        [DataMember]
        public TrackableCollection<RiskWorkflowTransition> Transitions
        {
            get
            {
                if (_transitions == null)
                {
                    _transitions = new TrackableCollection<RiskWorkflowTransition>();
        ...
        private TrackableCollection<RiskWorkflowTransition> _transitions;
        ...
        private void FixupProjectTemplate(ProjectTemplate previousValue)
        {
            ...
            if (previousValue != null && previousValue.RiskWorkflows.Contains(this))
            {
            ...
            {
                if (!ProjectTemplate.RiskWorkflows.Contains(this))
                {
                    ProjectTemplate.RiskWorkflows.Add(this);
                }

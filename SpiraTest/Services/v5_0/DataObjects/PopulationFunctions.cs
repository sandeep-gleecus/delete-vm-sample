...
namespace Inflectra.SpiraTest.Web.Services.v5_0.DataObjects
{
    ...
    public static class PopulationFunctions
    {
        ...
        {
            remoteHistoryChangeSet.HistoryChangeSetId = (int)historyChangeSet.ChangeSetId;
        ...
        {
            remoteHistoryChange.HistoryChangeId = (int)historyDetail.ArtifactHistoryId;
            remoteHistoryChange.ChangeSetId = (int)historyDetail.ChangeSetId;
        ...
        {
            remoteHistoryChange.HistoryChangeId = (int)historyChange.ArtifactHistoryId;
            remoteHistoryChange.ChangeSetId = (int)historyChange.ChangeSetId;
            ...
            remoteHistoryChange.ChangeSet.HistoryChangeSetId = (int)historyChange.ChangeSetId;
        ...
        public static void PopulateTaskType(RemoteTaskType remoteTaskType, TaskType taskType)
        {
            ...
            remoteTaskType.Active = taskType.IsActive;
        }
        ...
        public static void PopulateTestCaseType(RemoteTestCaseType remoteTestCaseType, TestCaseType testCaseType)
        {
            ...
            remoteTestCaseType.Active = testCaseType.IsActive;
        }
        ...
        public static void PopulateRequirementType(RemoteRequirementType remoteRequirementType, RequirementType requirementType)
        {
            ...
            remoteRequirementType.Active = requirementType.IsActive;
        }

...
<%@ Page language="c#" Codebehind="ProjectHome2.aspx.cs" AutoEventWireup="True" Inherits="Inflectra.SpiraTest.Web.ProjectHome2" MasterPageFile="~/MasterPages/ProjectDashboard.Master" %>
...
<asp:Content ContentPlaceHolderID="cplMainContent" runat="server" ID="Content2">
    <tstsc:UpdatePanelEx ID="ajaxWebParts" runat="server">
        <ContentTemplate>
            <tstsc:WebPartManagerEx ID="prtManager" runat="server" DashboardName="ProjectHome2" OnInit="prtManager_Init"  OnAuthorizeWebPart="prtManager_AuthorizeWebPart">
                <StaticConnections>
                </StaticConnections>
            </tstsc:WebPartManagerEx>
            <div class="py4 px3 flex flex-wrap-xs justify-between">
                <div class="pr3">
			        <h2>
                        <asp:label id="lblProjectName" Runat="server"/>			            
                        <asp:Label CssClass="o-50 fw-b fs-h4-xs" id="lblProjectId" Runat="server"/>
                    </h2>
                ...
                <div>
                    <div class="w9 w8-xs">
                        ...
                        <div class="w-65 tc dib hidden-mobile"></div>

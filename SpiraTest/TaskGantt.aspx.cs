...
namespace Inflectra.SpiraTest.Web
{
    ...
    /// Task Gantt chart view and handling all raised events
    /// </summary>
    [HeaderSettings(GlobalNavigation.NavigationHighlightedLink.Tasks, "SiteMap_TaskGantt", "Task-Tracking/#task-gantt-chart")]
    public partial class TaskGantt : PageLayout
    {
        private const string CLASS_NAME = "Inflectra.SpiraTest.Web.TaskGantt::";
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
			...
			if (!IsPostBack)
            {
                ...
                if (listPage != "Gantt")
                {
                    SaveProjectSetting(GlobalFunctions.PROJECT_SETTINGS_TASK_BOARD_SETTINGS, GlobalFunctions.PROJECT_SETTINGS_KEY_HOME_PAGE, "Gantt");
                }

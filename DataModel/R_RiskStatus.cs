...
namespace Inflectra.SpiraTest.DataModel
{
    ...
    public partial class R_RiskStatus: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        public bool IS_OPEN
        {
            ...
            set
            {
                if (_iS_OPEN != value)
                {
                    if (ChangeTracker.ChangeTrackingEnabled && ChangeTracker.State != ObjectState.Added)
                    {
                        throw new InvalidOperationException("The property 'IS_OPEN' is part of the object's key and cannot be changed. Changes to key properties can only be made when the object is not being tracked or is in the Added state.");
                    }
                    _iS_OPEN = value;
                    OnPropertyChanged("IS_OPEN");
                }
            }
        }

<%@ Page Language="c#" CodeBehind="DocumentWorkflowTransition.aspx.cs" AutoEventWireup="True"
    Inherits="Inflectra.SpiraTest.Web.Administration.ProjectTemplate.DocumentWorkflowTransition" MasterPageFile="~/MasterPages/Administration.master" %>
            ...
            <div class="col-lg-9">
                ...
                <div style="max-width: 650px;">
                    <table class="DataGrid" style="width: 100%">
                        ...
                        <tr>
                            <td class="priority1">
                                <tstsc:LabelEx ID="chkExcecuteByDetectorYnLabel" runat="server" Text="<%$Resources:Main,Admin_DocumentWorkflowTransition_AuthorExecuteLabel %>" AssociatedControlID="chkExecuteByCreatorYn" />:
                            </td>
                            <td class="priority1">
                        ...
                        <tr>
                            <td class="priority1">
                                <tstsc:LabelEx ID="chkExecuteByOwnerYnLabel" runat="server" Text="<%$Resources:Main,Admin_DocumentWorkflowTransition_OwnerExecuteLabel %>" AssociatedControlID="chkExecuteByOwnerYn" />:
                            </td>
                            <td class="priority1">

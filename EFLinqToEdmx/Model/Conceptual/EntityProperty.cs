...
namespace LinqToEdmx.Model.Conceptual
{
  ...
  public class EntityProperty : XTypedElement, IXMetaData
  {
    ...
    public System.Type PropertyType
    {
        get
        {
            string typeName = Attribute(XName.Get("Type", "")).Value;
            return TypeSystem.GetTypeFromSimpleName(typeName, false);
        }
    }
    ...
    XName IXMetaData.SchemaName
    {
      get
      {
        return XName.Get("TEntityProperty", "http://schemas.microsoft.com/ado/2009/11/edm");
      }
    }

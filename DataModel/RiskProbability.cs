...
namespace Inflectra.SpiraTest.DataModel
{
    ...
    public partial class RiskProbability: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        public int RiskProbabilityId
        {
            ...
            set
            {
                if (_riskProbabilityId != value)
                {
                    ...
                    {
                        throw new InvalidOperationException("The property 'RiskProbabilityId' is part of the object's key and cannot be changed. Changes to key properties can only be made when the object is not being tracked or is in the Added state.");
                    }
        ...
        private int _riskProbabilityId;
        ...
        private void FixupProjectTemplate(ProjectTemplate previousValue)
        {
            ...
            if (previousValue != null && previousValue.RiskProbabilities.Contains(this))
            {
            ...
            {
                if (!ProjectTemplate.RiskProbabilities.Contains(this))
                {
                    ProjectTemplate.RiskProbabilities.Add(this);
                }
        ...
        private void FixupRisks(object sender, NotifyCollectionChangedEventArgs e)
        {
            ...
            if (e.OldItems != null)
            {
                ...
                {
                    if (ReferenceEquals(item.Probability, this))
                    {

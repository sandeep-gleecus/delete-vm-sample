...
{
	/// <summary>Defines generic overloads for <see cref="CommandLine.Parser.ParseArguments(IEnumerable&lt;string&gt;,Type[])"/>.</summary>
	public static class ParserExtensions
	{
		#region ParseArguments()
		/// <summary>Parses a string array of command line arguments for verb commands scenario, constructing the proper instance from types as generic arguments.

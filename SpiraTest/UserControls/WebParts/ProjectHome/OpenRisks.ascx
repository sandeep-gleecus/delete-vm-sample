<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="OpenRisks.ascx.cs" Inherits="Inflectra.SpiraTest.Web.UserControls.WebParts.ProjectHome.OpenRisks" %>
...
<tstsc:GridViewEx id="grdRiskList" Runat="server" EnableViewState="false" SkinID="WidgetGrid" WebServiceClass="Inflectra.SpiraTest.Web.Services.Ajax.RisksService">
	...
	<Columns>
		...
		<tstsc:NameDescriptionFieldEx ItemStyle-Wrap="True" DataField="Name" NameMaxLength="60" CommandArgumentField="RiskId" HeaderColumnSpan="-1" />

<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ProgramRelativeSize.ascx.cs"
    Inherits="Inflectra.SpiraTest.Web.UserControls.WebParts.PortfolioHome.ProgramRelativeSize" %>
...
<script type="text/javascript">
    ...
    $('#help-RelativeSize').popover({
        content: resx.InAppHelp_Chart_ProgramRelativeSize,
        placement: "left",
        trigger: "hover focus",

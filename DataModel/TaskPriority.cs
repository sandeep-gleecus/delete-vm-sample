...
namespace Inflectra.SpiraTest.DataModel
{
    ...
    public partial class TaskPriority: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        public int TaskPriorityId
        {
            ...
            set
            {
                if (_taskPriorityId != value)
                {
                    ...
                    {
                        throw new InvalidOperationException("The property 'TaskPriorityId' is part of the object's key and cannot be changed. Changes to key properties can only be made when the object is not being tracked or is in the Added state.");
                    }
        ...
        private void FixupProjectTemplate(ProjectTemplate previousValue)
        {
            ...
            if (previousValue != null && previousValue.TaskPriorities.Contains(this))
            {
                previousValue.TaskPriorities.Remove(this);
            }
    
            if (ProjectTemplate != null)
            {
                if (!ProjectTemplate.TaskPriorities.Contains(this))
                {
                    ProjectTemplate.TaskPriorities.Add(this);
                }

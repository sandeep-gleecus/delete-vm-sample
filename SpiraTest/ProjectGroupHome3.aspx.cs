...
namespace Inflectra.SpiraTest.Web
{
	...
	public partial class ProjectGroupHome3 : PageLayout
	{
		private const string CLASS_NAME = "Inflectra.SpiraTest.Web.ProjectGroupHome3::";
		...
		protected void Page_Load(object sender, EventArgs e)
		{
            ...
            if (ProjectGroupId.HasValue)
            {
                ...
                if (!IsPostBack)
                {
                    ...
                    if (preferredHome != "Dev")
                    {
                        SaveUserSetting(GlobalFunctions.USER_SETTINGS_PROJECT_GROUP_HOME_GENERAL, GlobalFunctions.PROJECT_SETTINGS_KEY_HOME_PAGE, "Dev");
                    }
                }
            }
            else

/***************************************************************
**	Insert script for table TST_TASK_PRIORITY
***************************************************************/
SET IDENTITY_INSERT TST_TASK_PRIORITY ON; 

INSERT INTO TST_TASK_PRIORITY
(
TASK_PRIORITY_ID, PROJECT_TEMPLATE_ID, NAME, IS_ACTIVE, COLOR, SCORE
)
VALUES
(
...
SET IDENTITY_INSERT TST_TASK_PRIORITY OFF; 

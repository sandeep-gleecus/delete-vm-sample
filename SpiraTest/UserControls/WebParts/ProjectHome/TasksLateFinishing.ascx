<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="TasksLateFinishing.ascx.cs" Inherits="Inflectra.SpiraTest.Web.UserControls.WebParts.ProjectHome.TasksLateFinishing" %>
<%@ Import namespace="Inflectra.SpiraTest.Web" %>
<%@ Import namespace="Inflectra.SpiraTest.DataModel" %>
<%@ Import Namespace="Microsoft.Security.Application" %>
<tstsc:GridViewEx id="grdLateFinishingTasks" Runat="server" EnableViewState="false" SkinID="WidgetGrid" WebServiceClass="Inflectra.SpiraTest.Web.Services.Ajax.TasksService">
	<Columns>
		...
		<tstsc:TemplateFieldEx ItemStyle-Wrap="True" HeaderStyle-CssClass="priority3" ItemStyle-CssClass="priority3">
			<HeaderTemplate>
				<asp:Localize ID="Localize2" runat="server" Text="<%$Resources:Fields,Owner %>" />
			</HeaderTemplate>
			<ItemTemplate>
		...
		<tstsc:TemplateFieldEx ItemStyle-Wrap="False">
			<HeaderTemplate>
				<asp:Localize ID="Localize2" runat="server" Text="<%$Resources:Fields,Progress %>" />
			</HeaderTemplate>
			<ItemTemplate>
		...
		<tstsc:TemplateFieldEx ItemStyle-Wrap="False" HeaderStyle-Wrap="False" HeaderStyle-CssClass="priority2" ItemStyle-CssClass="priority2">
			<HeaderTemplate>
				<asp:Localize ID="Localize2" runat="server" Text="<%$Resources:Fields,EndDate %>"/>
			</HeaderTemplate>
			<ItemTemplate>

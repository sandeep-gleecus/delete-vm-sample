...
namespace Inflectra.SpiraTest.DataModel
{
    ...
    public partial class TestCaseParameterHierarchyAlreadySet: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        private void FixupProject(Project previousValue)
        {
            ...
            if (previousValue != null && previousValue.TestCaseParameterAlreadySetHierarchies.Contains(this))
            {
                previousValue.TestCaseParameterAlreadySetHierarchies.Remove(this);
            }
    
            if (Project != null)
            {
                if (!Project.TestCaseParameterAlreadySetHierarchies.Contains(this))
                {
                    Project.TestCaseParameterAlreadySetHierarchies.Add(this);
                }

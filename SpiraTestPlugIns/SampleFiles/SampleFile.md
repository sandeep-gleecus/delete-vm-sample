...
## Git workflow
- Quick fixes should be done on main - eg typos
- New pages or larger changes should be done in a branch off main (eg. reporting-pages)
...
- **Edit and commit your documentation changes**: files can be edited and committed straight on Github, and created, deleted, or edited from the desktop. Work in the relevant branch (main to make the changes live) and commit code as normal using Git. 
- **Deploy to to GitHub Pages**: from the local machine when on the main branch, run `mkdocs gh-deploy` and that's it! Your changes should be live after the command finishes!

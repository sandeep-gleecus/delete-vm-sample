...
namespace Inflectra.SpiraTest.DataModel
{
    ...
    public partial class TestCaseFolder: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        public Nullable<int> ParentTestCaseFolderId
        {
            ...
            set
            {
                if (_parentTestCaseFolderId != value)
                {
                    ...
                    if (!IsDeserializing)
                    {
                        if (Parent != null && Parent.TestCaseFolderId != value)
                        {
                            Parent = null;
                        }
                    }
        ...
        [DataMember]
        public TrackableCollection<TestCaseFolder> Children
        {
            get
            {
                if (_children == null)
                {
                    _children = new TrackableCollection<TestCaseFolder>();
        ...
        private TrackableCollection<TestCaseFolder> _children;
    
        [DataMember]
        public TestCaseFolder Parent
        {
            get { return _parent; }
            set
            {
        ...
        private TestCaseFolder _parent;
    
        [DataMember]
        public TrackableCollection<ReleaseTestCaseFolder> Releases
        {
            get
            {
                if (_releases == null)
                {
                    _releases = new TrackableCollection<ReleaseTestCaseFolder>();
            ...
            set
            {
                if (!ReferenceEquals(_releases, value))
                {
                    ...
                    if (_releases != null)
                    {
                        ...
                        foreach (ReleaseTestCaseFolder item in _releases)
                        {
        ...
        private TrackableCollection<ReleaseTestCaseFolder> _releases;
        ...
        private void FixupProject(Project previousValue)
        {
            ...
            if (Project != null)
            {
                if (!Project.TestCaseFolders.Contains(this))
                {
                    Project.TestCaseFolders.Add(this);
                }
        ...
        private void FixupParent(TestCaseFolder previousValue, bool skipKeys = false)
        {
            if (IsDeserializing)
            {
                return;
            ...
            if (Parent != null)
            {
                ...
                ParentTestCaseFolderId = Parent.TestCaseFolderId;
            }
            else if (!skipKeys)
            {

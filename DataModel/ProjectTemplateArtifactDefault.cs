...
namespace Inflectra.SpiraTest.DataModel
{
    ...
    public partial class ProjectTemplateArtifactDefault: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        private void FixupArtifactType(ArtifactType previousValue)
        {
            ...
            if (previousValue != null && previousValue.ProjectTemplateDefaults.Contains(this))
            {
                previousValue.ProjectTemplateDefaults.Remove(this);
            }
    
            if (ArtifactType != null)
            {
                if (!ArtifactType.ProjectTemplateDefaults.Contains(this))
                {
                    ArtifactType.ProjectTemplateDefaults.Add(this);
                }
        ...
        private void FixupProjectTemplate(ProjectTemplate previousValue)
        {
            ...
            if (previousValue != null && previousValue.ArtifactDefaults.Contains(this))
            {
                previousValue.ArtifactDefaults.Remove(this);
            }
    
            if (ProjectTemplate != null)
            {
                if (!ProjectTemplate.ArtifactDefaults.Contains(this))
                {
                    ProjectTemplate.ArtifactDefaults.Add(this);
                }

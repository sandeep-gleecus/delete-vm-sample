...
namespace Inflectra.SpiraTest.DataModel
{
    ...
    [KnownType(typeof(ProjectTemplateSetting))]
    public partial class ProjectTemplateSettingValue: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        #region Primitive Properties
    
        [DataMember]
        public int ProjectTemplateSettingId
        {
            get { return _projectTemplateSettingId; }
            set
            {
                if (_projectTemplateSettingId != value)
                {
                    if (ChangeTracker.ChangeTrackingEnabled && ChangeTracker.State != ObjectState.Added)
                    {
                        throw new InvalidOperationException("The property 'ProjectTemplateSettingId' is part of the object's key and cannot be changed. Changes to key properties can only be made when the object is not being tracked or is in the Added state.");
                    }
                    if (!IsDeserializing)
                    {
                        if (Setting != null && Setting.ProjectTemplateSettingId != value)
                        {
                            Setting = null;
                        }
                    }
                    _projectTemplateSettingId = value;
                    OnPropertyChanged("ProjectTemplateSettingId");
                }
            }
        }
        private int _projectTemplateSettingId;
            ...
            set
            {
                if (!ReferenceEquals(_projectTemplate, value))
                {
                    if (ChangeTracker.ChangeTrackingEnabled && ChangeTracker.State != ObjectState.Added && value != null)
                    {
                        ...
                        if (ProjectTemplateId != value.ProjectTemplateId)
                        {
        ...
        [DataMember]
        public ProjectTemplateSetting Setting
        {
            get { return _setting; }
            set
            {
                if (!ReferenceEquals(_setting, value))
                {
                    if (ChangeTracker.ChangeTrackingEnabled && ChangeTracker.State != ObjectState.Added && value != null)
                    {
                        // This the dependent end of an identifying relationship, so the principal end cannot be changed if it is already set,
                        // otherwise it can only be set to an entity with a primary key that is the same value as the dependent's foreign key.
                        if (ProjectTemplateSettingId != value.ProjectTemplateSettingId)
                        {
                            throw new InvalidOperationException("The principal end of an identifying relationship can only be changed when the dependent end is in the Added state.");
                        }
                    }
        ...
        private ProjectTemplateSetting _setting;
        ...
        private void FixupProjectTemplate(ProjectTemplate previousValue)
        {
            ...
            if (previousValue != null && previousValue.Settings.Contains(this))
            {
            ...
            {
                if (!ProjectTemplate.Settings.Contains(this))
                {
                    ProjectTemplate.Settings.Add(this);
                }
        ...
        private void FixupSetting(ProjectTemplateSetting previousValue)
        {
            if (IsDeserializing)
            {
                return;
            ...
            if (Setting != null)
            {
                ...
                ProjectTemplateSettingId = Setting.ProjectTemplateSettingId;
            }
            if (ChangeTracker.ChangeTrackingEnabled)
            {

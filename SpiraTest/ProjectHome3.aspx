...
<%@ Page language="c#" Codebehind="ProjectHome3.aspx.cs" AutoEventWireup="True" Inherits="Inflectra.SpiraTest.Web.ProjectHome3" MasterPageFile="~/MasterPages/ProjectDashboard.Master" %>
...
<asp:Content ContentPlaceHolderID="cplMainContent" runat="server" ID="Content2">
    <tstsc:UpdatePanelEx ID="ajaxWebParts" runat="server">
        <ContentTemplate>
            <tstsc:WebPartManagerEx ID="prtManager" runat="server" DashboardName="ProjectHome3" OnInit="prtManager_Init"  OnAuthorizeWebPart="prtManager_AuthorizeWebPart">
                <StaticConnections>
                </StaticConnections>
            ...
            <div class="pt4 px3 flex flex-wrap justify-between">
                <div class="pr3">
			        <h2>
                        ...
                        <asp:Label CssClass="o-50 fw-b" id="lblProjectId" Runat="server"/>
                    </h2>

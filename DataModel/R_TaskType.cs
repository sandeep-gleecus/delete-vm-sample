...
namespace Inflectra.SpiraTest.DataModel
{
    ...
    public partial class R_TaskType: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        [DataMember]
        public int TASK_WORKFLOW_ID
        {
            get { return _tASK_WORKFLOW_ID; }
            set
            {
                if (_tASK_WORKFLOW_ID != value)
                {
                    if (ChangeTracker.ChangeTrackingEnabled && ChangeTracker.State != ObjectState.Added)
                    {
                        throw new InvalidOperationException("The property 'TASK_WORKFLOW_ID' is part of the object's key and cannot be changed. Changes to key properties can only be made when the object is not being tracked or is in the Added state.");
                    }
                    _tASK_WORKFLOW_ID = value;
                    OnPropertyChanged("TASK_WORKFLOW_ID");
                }
            }
        }
        private int _tASK_WORKFLOW_ID;
        ...
        public bool IS_PULL_REQUEST
        {
            ...
            set
            {
                if (_iS_PULL_REQUEST != value)
                {
                    if (ChangeTracker.ChangeTrackingEnabled && ChangeTracker.State != ObjectState.Added)
                    {
                        throw new InvalidOperationException("The property 'IS_PULL_REQUEST' is part of the object's key and cannot be changed. Changes to key properties can only be made when the object is not being tracked or is in the Added state.");
                    }
                    _iS_PULL_REQUEST = value;
                    OnPropertyChanged("IS_PULL_REQUEST");
                }
            }
        }
        private bool _iS_PULL_REQUEST;

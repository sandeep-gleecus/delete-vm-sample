...
namespace Inflectra.SpiraTest.DataModel
{
    ...
    public partial class ProjectAttachmentFolderHierarchy: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        private void FixupProject(Project previousValue)
        {
            ...
            if (previousValue != null && previousValue.AttachmentFoldersHierarchy.Contains(this))
            {
                previousValue.AttachmentFoldersHierarchy.Remove(this);
            }
    
            if (Project != null)
            {
                if (!Project.AttachmentFoldersHierarchy.Contains(this))
                {
                    Project.AttachmentFoldersHierarchy.Add(this);
                }

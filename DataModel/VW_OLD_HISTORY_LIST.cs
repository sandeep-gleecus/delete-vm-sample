...
namespace Inflectra.SpiraTest.DataModel
{
    ...
    public partial class VW_OLD_HISTORY_LIST: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        public string FIELD_CAPTION
        {
            ...
            set
            {
                ...
                {
                    ChangeTracker.RecordOriginalValue("FIELD_CAPTION", _fIELD_CAPTION);

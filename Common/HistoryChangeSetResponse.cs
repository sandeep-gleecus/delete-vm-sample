...
{
	public partial class HistoryChangeSetResponse : IObjectWithChangeTracker, INotifyPropertyChanged
	{
		...
		public long DetailId
		{
			...
			set
			{
				if (_detailId != value)
				{
					if (ChangeTracker.ChangeTrackingEnabled && ChangeTracker.State != ObjectState.Added)
					{
						throw new InvalidOperationException("The property 'DetailId' is part of the object's key and cannot be changed. Changes to key properties can only be made when the object is not being tracked or is in the Added state.");
					}
					_detailId = value;
		...
		//{
		//	get { return DateTime.Parse(_time1); }
		//	set
		//	{
		//		if (DateTime.Parse(_time1) != value)
		//		{
		//			if (ChangeTracker.ChangeTrackingEnabled && ChangeTracker.State != ObjectState.Added)
		//			{
		//				throw new InvalidOperationException("The property 'ChangeDate' is part of the object's key and cannot be changed. Changes to key properties can only be made when the object is not being tracked or is in the Added state.");
		//			}
		//			_time1 =  value.Hour + ":" + value.Minute ;
		...
		//				throw new InvalidOperationException("The property 'ChangeDate' is part of the object's key and cannot be changed. Changes to key properties can only be made when the object is not being tracked or is in the Added state.");
		//			}
		//			_time1 = DateTime.Parse( value.Hour + ":" + value.Minute);
		//			OnPropertyChanged("Time1");
		//		}
		//	}
		//}
		...
		{
			get { return _nameOfSigner; }
			set
			{
				if (_nameOfSigner != value)
				{
					//ChangeTracker.RecordOriginalValue("Meaning", _meaning);
					_nameOfSigner = value;
					OnPropertyChanged("NameOfSigner");
				}
			}
		}
		private string _nameOfSigner;

...
namespace Inflectra.SpiraTest.DataModel
{
    ...
    public partial class R_DocumentType: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        [DataMember]
        public int DOCUMENT_WORKFLOW_ID
        {
            get { return _dOCUMENT_WORKFLOW_ID; }
            set
            {
                if (_dOCUMENT_WORKFLOW_ID != value)
                {
                    if (ChangeTracker.ChangeTrackingEnabled && ChangeTracker.State != ObjectState.Added)
                    {
                        throw new InvalidOperationException("The property 'DOCUMENT_WORKFLOW_ID' is part of the object's key and cannot be changed. Changes to key properties can only be made when the object is not being tracked or is in the Added state.");
                    }
                    _dOCUMENT_WORKFLOW_ID = value;
                    OnPropertyChanged("DOCUMENT_WORKFLOW_ID");
                }
            }
        }
        private int _dOCUMENT_WORKFLOW_ID;

...
(function ()
{
	...
	callIf = Sys._callIf;
        ...
        if (document.documentElement.getBoundingClientRect)
        {
            ...
            offsetX = Math.round(clientRect.left) + (documentElement.scrollLeft || ((ownerDoc.body && ownerDoc.body.scrollLeft) ? ownerDoc.body.scrollLeft : 0)),
            offsetY = Math.round(clientRect.top) + (documentElement.scrollTop || ((ownerDoc.body && ownerDoc.body.scrollTop) ? ownerDoc.body.scrollTop : 0));
                ...
                //Inflectra - added parseInt to get round fraction issue when zoom != 100%
                return new Sys.UI.Point(parseInt(offsetX), parseInt(offsetY));
            }
        }
        ...
        { name: "element", domElement: true }
            ...
            if (e) throw e;
            if (element.control && element.tagName.toLowerCase() != 'label') throw Error.invalidOperation(Sys.Res.controlAlreadyDefined + ': ' + element.id);

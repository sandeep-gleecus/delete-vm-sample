...
namespace Inflectra.SpiraTest.DataModel
{
    ...
    public partial class R_IncidentSeverity: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        public int SEVERITY_ID
        {
            ...
            set
            {
                if (_sEVERITY_ID != value)
                {
                    ...
                    {
                        throw new InvalidOperationException("The property 'SEVERITY_ID' is part of the object's key and cannot be changed. Changes to key properties can only be made when the object is not being tracked or is in the Added state.");
                    }
                    _sEVERITY_ID = value;

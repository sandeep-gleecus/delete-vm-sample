...
using Inflectra.SpiraTest.ApiTestSuite.SpiraImportExport40;
...
{
	/// <summary>
	/// This fixture tests that the v4.0 import/export web service interface works correctly
	/// </summary>
	[
	TestFixture,
	...
	public class V4_0_ApiTest
	{
		protected static SpiraImportExport40.ImportExportClient spiraImportExport;
        protected static SpiraDataSync40.DataSyncClient spiraDataSync;
		...
		public void Init()
		{
			...
			spiraImportExport = new SpiraImportExport40.ImportExportClient();
			spiraImportExport.Endpoint.Address = new EndpointAddress(Properties.Settings.Default.WebServiceUrl + "v4_0/ImportExport.svc");
            spiraDataSync = new SpiraDataSync40.DataSyncClient();
            spiraDataSync.Endpoint.Address = new EndpointAddress(Properties.Settings.Default.WebServiceUrl + "v4_0/DataSync.svc");
            ...
            BasicHttpBinding httpBinding2 = (BasicHttpBinding)spiraDataSync.Endpoint.Binding;
            httpBinding2.AllowCookies = true;
            httpBinding2.Security.Mode = BasicHttpSecurityMode.None;
        ...
        public void CleanUp()
        {
            ...
            //Delete the template (no v4.0 api call available for this)
		...
		public void _02_RetrieveProjectList()
		{
            ...
            success = spiraImportExport.Connection_Authenticate("administrator", "Welcome123$");
            Assert.IsTrue(success);
...
//			Assert.IsTrue(success, "Authorization 1 Failed");
		...
		public void _04_ImportUsers()
		{
			...
			remoteUser.LdapDn = "";
			remoteUser = spiraImportExport.User_Create(remoteUser, "aant123456789", "What is 2+3?", "5", InternalRoutines.PROJECT_ROLE_MANAGER);
			...
			remoteUser = spiraImportExport.User_Create(remoteUser, null, null, null, InternalRoutines.PROJECT_ROLE_TESTER);
            ...
            remoteUser.Active = true;
            remoteUser.LdapDn = "";
            remoteUser = spiraImportExport.User_Create(remoteUser, "aant123456789", "What is 1+1?", "2", InternalRoutines.PROJECT_ROLE_MANAGER);
		...
		public void _05_ImportCustomProperties()
		{
            ...
            spiraImportExport.CustomProperty_AddDefinition(remoteCustomProperty, null);
            ...
            remoteCustomProperties = spiraImportExport.CustomProperty_RetrieveForArtifactType((int)DataModel.Artifact.ArtifactTypeEnum.Requirement, false);
			...
			//Verify the additions
            remoteCustomProperties = spiraImportExport.CustomProperty_RetrieveForArtifactType((int)DataModel.Artifact.ArtifactTypeEnum.Incident, false);
			Assert.AreEqual(2, remoteCustomProperties.Length);
            Assert.AreEqual("Custom_01", remoteCustomProperties.FirstOrDefault(c => c.Name == "Source").CustomPropertyFieldName);
            Assert.AreEqual("Custom_02", remoteCustomProperties.FirstOrDefault(c => c.Name == "Req Type").CustomPropertyFieldName);
            Assert.AreEqual(1, remoteCustomProperties.FirstOrDefault(c => c.Name == "Source").CustomPropertyTypeId);
            ...
            remoteCustomProperties = spiraImportExport.CustomProperty_RetrieveForArtifactType((int)DataModel.Artifact.ArtifactTypeEnum.Task, false);
            ...
            {
                spiraImportExport.CustomProperty_DeleteDefinition(remoteCustomProperty2.CustomPropertyId.Value);
            }
            ...
            spiraImportExport.CustomProperty_AddDefinition(remoteCustomProperty, customListId2);
            remoteCustomProperty = new RemoteCustomProperty();
            remoteCustomProperty.CustomPropertyTypeId = (int)DataModel.CustomProperty.CustomPropertyTypeEnum.List;
            ...
            remoteCustomProperties = spiraImportExport.CustomProperty_RetrieveForArtifactType((int)DataModel.Artifact.ArtifactTypeEnum.TestSet, false);
            Assert.AreEqual(1, remoteCustomProperties.Length);
            remoteCustomProperties = spiraImportExport.CustomProperty_RetrieveForArtifactType((int)DataModel.Artifact.ArtifactTypeEnum.TestRun, false);
            Assert.AreEqual(1, remoteCustomProperties.Length);
		...
		public void _07_ImportRequirements()
		{
            ...
            spiraImportExport.Requirement_Indent(requirementId3);
            remoteRequirement = spiraImportExport.Requirement_RetrieveById(requirementId3);
            Assert.AreEqual("AAAAAAAAA", remoteRequirement.IndentLevel);
            remoteRequirement = spiraImportExport.Requirement_RetrieveById(requirementId2);
            Assert.AreEqual(true, remoteRequirement.Summary);

            //Now put it back
            spiraImportExport.Requirement_Outdent(requirementId3);
            remoteRequirement = spiraImportExport.Requirement_RetrieveById(requirementId3);
            Assert.AreEqual("AAAAAB", remoteRequirement.IndentLevel);
            remoteRequirement = spiraImportExport.Requirement_RetrieveById(requirementId2);
		...
		public void _08_ImportTestCases()
		{
            ...
            RemoteTestCaseParameter[] remoteTestCaseParameters = spiraImportExport.TestCase_RetrieveParameters(testCaseId2);
            ...
            RemoteTestCaseFolder[] remoteTestCaseFolders = spiraImportExport.TestCase_RetrieveFolderHierarchy();
		...
		public void _09_ImportTestSteps()
		{
            ...
            RemoteTestStepParameter[] remoteTestStepParameters = spiraImportExport.TestCase_RetrieveStepParameters(testCaseId1, testStepId6);
		...
		public void _11_ImportTestSets()
		{
			...
			RemoteTestSetTestCaseMapping[] remoteTestSetTestCaseMappings = spiraImportExport.TestSet_AddTestMapping(remoteTestSetTestCaseMapping, null, null);
            ...
            remoteTestSetTestCaseMappings = spiraImportExport.TestSet_AddTestMapping(remoteTestSetTestCaseMapping, null, null);
            Assert.AreEqual(1, remoteTestSetTestCaseMappings.Length);
            Assert.AreEqual(testSetId1, remoteTestSetTestCaseMappings[0].TestSetId);
		...
		public void _12_ImportTestRun()
		{
            ...
            remoteManualTestRuns = spiraImportExport.TestRun_Save(remoteManualTestRuns, DateTime.UtcNow);
			...
			remoteManualTestRuns = spiraImportExport.TestRun_Save(remoteManualTestRuns, DateTime.UtcNow.AddMinutes(1));
			testRunId1 = remoteManualTestRuns[0].TestRunId.Value;
			testRunId2 = remoteManualTestRuns[1].TestRunId.Value;
			testRunStepId1 = remoteManualTestRuns[0].TestRunSteps[0].TestRunStepId.Value;
			testRunStepId2 = remoteManualTestRuns[0].TestRunSteps[1].TestRunStepId.Value;
			...
			testRunId5 = spiraImportExport.TestRun_RecordAutomated2("aant", "aant123456789", projectId1, userId2, testCaseId1, iterationId2, null, null, null, DateTime.UtcNow, DateTime.UtcNow.AddSeconds(20), (int)TestCase.ExecutionStatusEnum.Failed, "TestSuite", "02_Test_Method", 5, "Expected 1, Found 0", "Error Stack Trace........", 1);
            ...
            remoteAutomatedTestRun.TestRunSteps[0].ActualResult = "Object Not Available on Screen";
            ...
            remoteAutomatedTestRun.TestRunSteps[1].ActualResult = "the scowrers";
            ...
            testRunId6 = spiraImportExport.TestRun_RecordAutomated1(remoteAutomatedTestRun).TestRunId.Value;

            //Verify the data
            //Test Run
            remoteAutomatedTestRun = spiraImportExport.TestRun_RetrieveAutomatedById(testRunId6);
            ...
            Assert.AreEqual("Object Not Available on Screen", remoteAutomatedTestRun.TestRunSteps[0].ActualResult);
            ...
            Assert.AreEqual("the scowrers", remoteAutomatedTestRun.TestRunSteps[1].ActualResult);
		...
		public void _13_ImportIncidents()
		{
            ...
            RemoteIncidentType defaultRemoteIncidentType = spiraImportExport.Incident_RetrieveDefaultType();
            Assert.AreEqual("Incident", defaultRemoteIncidentType.Name);
            Assert.AreEqual(true, defaultRemoteIncidentType.Active);
            RemoteIncidentStatus defaultRemoteIncidentStatus = spiraImportExport.Incident_RetrieveDefaultStatus();
            ...
            remoteComments = spiraImportExport.Incident_RetrieveComments(incidentId1);
            ...
            remoteComments = spiraImportExport.Incident_RetrieveComments(incidentId2);
            Assert.AreEqual(0, remoteComments.Length);
            ...
            remoteComments = spiraImportExport.Incident_RetrieveComments(incidentId3);
		...
		public void _16_RetrieveIncidents()
		{
			...
			RemoteIncident[] remoteIncidents = spiraImportExport.Incident_RetrieveNew(DateTime.Parse("1/1/2000"), 1, 100);
			...
			Assert.AreEqual("Adam Ant", remoteIncident.OpenerName, "OpenerName");
			Assert.IsNull(remoteIncident.OwnerName, "OwnerName");
			RemoteComment[] remoteComments = spiraImportExport.Incident_RetrieveComments(incidentId1);
            Assert.AreEqual(0, remoteComments.Length);
		...
		public void _17_RetrieveTasks()
		{
			...
			RemoteTask[] remoteTasks = spiraImportExport.Task_RetrieveNew(DateTime.Parse("1/1/2000"),1, 100);
		...
		public void _19_RetrieveTestCases()
		{
			...
			//Verify the data returned, including the pseudo indent-levels
		...
		public void _25_Concurrency_Handling()
		{
            ...
            spiraImportExport.Incident_Delete(incidentId);
		...
		public void _28_RetrieveDeleteAttachments()
		{
			...
			Assert.AreEqual(2, remoteDocuments.Length);
			remoteDocument = remoteDocuments[0];
            Assert.AreEqual(testCaseId1, remoteDocument.ArtifactId);
            Assert.AreEqual((int)DataModel.Artifact.ArtifactTypeEnum.TestCase, remoteDocument.ArtifactTypeId);
		...
		public void _32_DataMappingChanges()
		{
			...
			int userId = spiraImportExport.User_Create(remoteUser, "test123", "What is 3+4?", "7", 1).UserId.Value;
		...
		public void _35_DeleteItems()
		{
            ...
            spiraImportExport.User_Delete(remoteUser.UserId.Value);
            Assert.IsFalse(spiraImportExport.User_RetrieveById(remoteUser.UserId.Value).Active);

            //Now actually delete and verify
            new UserManager().DeleteUser(remoteUser.UserId.Value, true);
            Assert.IsNull(spiraImportExport.User_RetrieveById(remoteUser.UserId.Value));
        ...
        [Test, SpiraTestCase(1283)]
        public void _39_DataSyncApi()
        {
            //First authenticate the DataSync API
            bool success = spiraDataSync.Connection_Authenticate2("administrator", "Welcome123$", "UnitTest");
            Assert.IsTrue(success);

            //Get the list of data-sync systems configured
            SpiraDataSync40.RemoteDataSyncSystem[] dataSyncSystems = spiraDataSync.DataSyncSystem_Retrieve();
            ...
            success = spiraImportExport.Connection_Authenticate2("administrator", "Welcome123$", "UnitTest");
            Assert.IsTrue(success);
            success = spiraImportExport.Connection_ConnectToProject(1);
            Assert.IsTrue(success);
            ...
            //Incident Severity
            RemoteDataMapping[] fieldMappings = spiraImportExport.DataMapping_RetrieveFieldValueMappings(dataSyncSystem1, 1);
            //Incident Priority
            fieldMappings = spiraImportExport.DataMapping_RetrieveFieldValueMappings(dataSyncSystem1, 2);
            //Incident Status
            fieldMappings = spiraImportExport.DataMapping_RetrieveFieldValueMappings(dataSyncSystem1, 3);
            //Incident Type
            fieldMappings = spiraImportExport.DataMapping_RetrieveFieldValueMappings(dataSyncSystem1, 4);
            //Requirement Importance
            fieldMappings = spiraImportExport.DataMapping_RetrieveFieldValueMappings(dataSyncSystem1, 18);
            //Requirement Status
            fieldMappings = spiraImportExport.DataMapping_RetrieveFieldValueMappings(dataSyncSystem1, 16);
            //Requirement Type
            fieldMappings = spiraImportExport.DataMapping_RetrieveFieldValueMappings(dataSyncSystem1, 140);
            //Component
            fieldMappings = spiraImportExport.DataMapping_RetrieveFieldValueMappings(dataSyncSystem1, 141);
            //Task Priority
            fieldMappings = spiraImportExport.DataMapping_RetrieveFieldValueMappings(dataSyncSystem1, 59);
            //Task Status
            fieldMappings = spiraImportExport.DataMapping_RetrieveFieldValueMappings(dataSyncSystem1, 57);
            //Task Type
            fieldMappings = spiraImportExport.DataMapping_RetrieveFieldValueMappings(dataSyncSystem1, 145);

            //Verify that we can retrieve custom property mapping
            RemoteDataMapping customPropertyMapping = spiraImportExport.DataMapping_RetrieveCustomPropertyMapping(dataSyncSystem1, 1, 1);

            //Verify that we can retrieve custom property mapping
            RemoteDataMapping[] customPropertyValueMappings = spiraImportExport.DataMapping_RetrieveCustomPropertyValueMappings(dataSyncSystem1, 1, 1);
        }
        ...
        [Test]
        [SpiraTestCase(1858)]
        public void _40_CheckCompatibilityWithOldStaticIDs()
        {

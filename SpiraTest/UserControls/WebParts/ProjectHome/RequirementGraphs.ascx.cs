...
{
    /// <summary>
    /// Displays the requirement graphs web part
    /// </summary>
    public partial class RequirementGraphs : WebPartBase, IWebPartReloadable
    {
        private const string CLASS_NAME = "Inflectra.SpiraTest.Web.UserControls.WebParts.ProjectHome.RequirementGraphs::";
        ...
        public void LoadAndBindData()
        {
            ...
            List<Graph> graphs = graphManager.RetrieveByType(Graph.GraphTypeEnum.SnapshotGraphs, DataModel.Artifact.ArtifactTypeEnum.Requirement);

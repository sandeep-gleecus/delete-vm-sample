...
namespace Inflectra.SpiraTest.Web.Services.v5_0
{
	...
	/// <remarks>This API is available for all installations v5.0 or greater. There are older APIs available
	...
	{
		private const string CLASS_NAME = "Inflectra.SpiraTest.Web.Services.v5_0.SoapService::";
		...
		public RemoteDataSyncSystem DataSyncSystem_RetrieveById(int dataSyncSystemId)
		{
		...
		public void DataSyncSystem_Update(RemoteDataSyncSystem remoteDataSyncSystem)
		{
		...
		public List<RemoteComponent> Component_Retrieve(bool activeOnly, bool includeDeleted)
		{
		...
		public RemoteComponent Component_RetrieveById(int componentId)
		{
		...
		public RemoteComponent Component_Create(RemoteComponent remoteComponent)
		{
		...
		public void Component_Update(RemoteComponent remoteComponent)
		{
		...
		public RemoteProject Project_Create(RemoteProject remoteProject, Nullable<int> existingProjectId)
		{
			...
			else
			{
				int projectId = projectManager.Insert(
				   ...
				   false,
				   1.0M,
				   ProjectManager.DEFAULT_POINT_EFFORT,
				   null,
				   true,
				   true,
				   true,
		...
		public void Project_AddUserMembership(RemoteProjectUser remoteProjectUser)
		{
		...
		public void Project_UpdateUserMembership(RemoteProjectUser remoteProjectUser)
		{
		...
		/// </example>
		public RemoteCustomProperty CustomProperty_AddDefinition(RemoteCustomProperty remoteCustomProperty, int? customListId)
		{
		...
		/// </example>
		public void CustomProperty_UpdateDefinition(RemoteCustomProperty remoteCustomProperty)
		{
			const string METHOD_NAME = "CustomProperty_UpdateDefinition";
		...
		/// </example>
		public List<RemoteDocument> Document_Retrieve(List<RemoteFilter> remoteFilters, RemoteSort remoteSort, int startingRow, int numberRows)
		{
		...
		public RemoteDocumentFolder Document_AddFolder(RemoteDocumentFolder remoteDocumentFolder)
		{
			...
			//Make sure we have permissions to create document folders
		...
		public void Document_UpdateFolder(RemoteDocumentFolder remoteDocumentFolder)
		{
			...
			//Make sure we have permissions to update document folders
		...
		public void Document_AddToArtifactId(int artifactTypeId, int artifactId, int attachmentId)
		{
			...
			if (this.ProjectRolePermissions == null || (userId != 1
				&& this.ProjectRolePermissions.FindByProjectRoleIdArtifactTypeIdPermissionId(this.ProjectRoleId, artifactTypeId, (int)Project.PermissionEnum.Modify) == null
				&& this.ProjectRolePermissions.FindByProjectRoleIdArtifactTypeIdPermissionId(this.ProjectRoleId, artifactTypeId, (int)Project.PermissionEnum.Create) == null))
			{
				//Throw back an exception
				Logger.LogExitingEvent(METHOD_NAME);
		...
		public RemoteDocument Document_AddFile(RemoteDocument remoteDocument, byte[] binaryData)
		{
			...
			try
			{
				...
				remoteDocument.AttachmentId = attachmentManager.Insert(
				   remoteDocument.ProjectId.Value,
				...
				Dictionary<string, string> validationMessages = UpdateFunctions.UpdateCustomPropertyData(ref artifactCustomProperty, remoteDocument, remoteDocument.ProjectId.Value, DataModel.Artifact.ArtifactTypeEnum.Document, remoteDocument.AttachmentId.Value, projectTemplateId);
		...
		public RemoteUser User_Create(RemoteUser remoteUser, string password, string passwordQuestion, string passwordAnswer, int? projectRoleId)
		{
			...
			if (!IsAuthorized && projectRoleId.HasValue)
			{
				//Throw back an exception
				Logger.LogExitingEvent(CLASS_NAME + METHOD_NAME);
				Logger.Flush();
			...
			try
			{
				...
				if (membershipUser != null)
				{
					...
					if (projectRoleId.HasValue)
					{
						...
						try
						{
							projectManager.InsertUserMembership(existingUserId, projectId, projectRoleId.Value);
						}
				...
				if (projectRoleId.HasValue)
				{
					try
					{
						projectManager.InsertUserMembership(userId, projectId, projectRoleId.Value);
					}
					catch (ProjectDuplicateMembershipRecordException)
					{
						//Ignore this error
		...
		public void User_Update(RemoteUser remoteUser)
		{
			...
			if (!IsSystemAdmin && remoteUser.UserId.Value != authenticatedUserId)
			{
				//Throw back an exception
				Logger.LogExitingEvent(CLASS_NAME + METHOD_NAME);
				Logger.Flush();
		...
		/// </summary>
		public List<RemoteUser> User_Retrieve()
		{
		...
		/// <returns>The user object</returns>
		public RemoteUser User_RetrieveByUserName(string userName, bool includeInactive)
		{
		...
		/// <returns>List of incidents</returns>
		public List<RemoteIncident> Incident_RetrieveNew(DateTime creationDate, int startRow, int numberOfRows)
		{
		...
		public List<RemoteComment> Incident_RetrieveComments(int incidentId)
		{
		...
		public List<RemoteComment> Incident_AddComments(List<RemoteComment> remoteComments)
		{
		...
		public RemoteIncidentStatus Incident_RetrieveDefaultStatus()
		{
		...
		public RemoteIncidentType Incident_RetrieveDefaultType()
		{
		...
		public List<RemoteWorkflowTransition> Incident_RetrieveWorkflowTransitions(int currentTypeId, int currentStatusId, bool isDetector, bool isOwner)
		{
		...
		public List<RemoteWorkflowField> Incident_RetrieveWorkflowFields(int currentTypeId, int currentStatusId)
		{
		...
		public List<RemoteWorkflowCustomProperty> Incident_RetrieveWorkflowCustomProperties(int currentTypeId, int currentStatusId)
		{
		...
		public List<RemoteReleaseStatus> Release_RetrieveStatuses()
		{
		...
		public List<RemoteReleaseType> Release_RetrieveTypes()
		{
		...
		public List<RemoteWorkflowField> Release_RetrieveWorkflowFields(int currentTypeId, int currentStatusId)
		{
		...
		/// <returns>The list of workflow transitions</returns>
		public List<RemoteWorkflowTransition> Release_RetrieveWorkflowTransitions(int currentTypeId, int currentStatusId, bool isCreator, bool isOwner)
		{
		...
		public List<RemoteWorkflowCustomProperty> Release_RetrieveWorkflowCustomProperties(int currentTypeId, int currentStatusId)
		{
		...
		public List<RemoteRequirementStatus> Requirement_RetrieveStatuses()
		{
		...
		public List<RemoteRequirementType> Requirement_RetrieveTypes()
		{
		...
		public List<RemoteWorkflowField> Requirement_RetrieveWorkflowFields(int currentTypeId, int currentStatusId)
		{
		...
		/// <returns>The list of workflow transitions</returns>
		public List<RemoteWorkflowTransition> Requirement_RetrieveWorkflowTransitions(int currentTypeId, int currentStatusId, bool isCreator, bool isOwner)
		{
		...
		public List<RemoteWorkflowCustomProperty> Requirement_RetrieveWorkflowCustomProperties(int currentTypeId, int currentStatusId)
		{
		...
		public List<RemoteRequirementStep> Requirement_RetrieveSteps(int requirementId)
		{
		...
		public RemoteRequirementStep Requirement_RetrieveStepById(int requirementStepId)
		{
		...
		public RemoteRequirementStep Requirement_AddStep(RemoteRequirementStep remoteRequirementStep, int? existingRequirementStepId, int? creatorId)
		{
		...
		public void Requirement_UpdateStep(RemoteRequirementStep remoteRequirementStep)
		{
		...
		public void Requirement_MoveStep(int requirementId, int sourceRequirementStepId, int? destinationRequirementStepId)
		{
		...
		public void Requirement_AddTestStepCoverage(RemoteRequirementTestStepMapping remoteReqTestStepMapping)
		{
			...
			if (this.ProjectRolePermissions == null || this.ProjectRolePermissions.FindByProjectRoleIdArtifactTypeIdPermissionId(this.ProjectRoleId, (int)DataModel.Artifact.ArtifactTypeEnum.TestStep, (int)Project.PermissionEnum.Modify) == null)
			{
				//Throw back an exception
				Logger.LogExitingEvent(CLASS_NAME + METHOD_NAME);
				Logger.Flush();
		...
		public List<RemoteRequirementTestStepMapping> Requirement_RetrieveTestStepCoverage(int requirementId)
		{
		...
		public void Requirement_RemoveTestStepCoverage(RemoteRequirementTestStepMapping remoteReqTestStepMapping)
		{
			const string METHOD_NAME = "Requirement_AddTestStepCoverage";
		...
		/// </summary>
		/// <param name="testStepId"></param>
		/// <returns></returns>
		public List<RemoteRequirementTestStepMapping> TestStep_RetrieveRequirementCoverage(int testStepId)
		{
		...
		/// <returns>The number of items.</returns>
		public long TestCase_Count(List<RemoteFilter> remoteFilters, int? releaseId)
		{
		...
		public long TestCase_CountForFolder(int? testCaseFolderId, List<RemoteFilter> remoteFilters, int? releaseId)
		{
		...
		public RemoteTestCaseFolder TestCase_CreateFolder(RemoteTestCaseFolder remoteTestCaseFolder)
		{
		...
		public RemoteTestCase TestCase_Create(RemoteTestCase remoteTestCase)
		{
		...
		public List<RemoteTestCase> TestCase_Retrieve(List<RemoteFilter> remoteFilters, RemoteSort remoteSort, int startingRow, int numberOfRows, int? releaseId)
		{
		...
		public List<RemoteTestCaseFolder> TestCase_RetrieveFolders()
		{
		...
		public List<RemoteTestCaseFolder> TestCase_RetrieveFoldersByParent(int? parentTestCaseFolderId, int? releaseId)
		{
		...
		/// <returns>List of testCases</returns>
		public List<RemoteTestCase> TestCase_RetrieveByFolder(int? testCaseFolderId, List<RemoteFilter> remoteFilters, RemoteSort remoteSort, int startingRow, int numberOfRows, int? releaseId)
		{
		...
		public RemoteTestCaseFolder TestCase_RetrieveFolderById(int testCaseFolderId)
		{
		...
		public List<RemoteTestCaseParameter> TestCase_RetrieveParameters(int testCaseId)
		{
		...
		/// <returns>List of parameters</returns>
		public List<RemoteTestStepParameter> TestCase_RetrieveStepParameters(int testCaseId, int testStepId)
		{
		...
		public void TestCase_UpdateFolder(RemoteTestCaseFolder remoteTestCaseFolder)
		{
		...
		public List<RemoteTestStep> TestCase_RetrieveSteps(int testCaseId)
		{
		...
		public RemoteTestStep TestCase_RetrieveStepById(int testStepId)
		{
		...
		public void TestCase_UpdateStep(RemoteTestStep remoteTestStep)
		{
		...
		public List<RemoteTestCaseStatus> TestCase_RetrieveStatuses()
		{
		...
		public List<RemoteTestCaseType> TestCase_RetrieveTypes()
		{
		...
		public List<RemoteWorkflowField> TestCase_RetrieveWorkflowFields(int currentTypeId, int currentStatusId)
		{
		...
		/// <returns>The list of workflow transitions</returns>
		public List<RemoteWorkflowTransition> TestCase_RetrieveWorkflowTransitions(int currentTypeId, int currentStatusId, bool isCreator, bool isOwner)
		{
		...
		public List<RemoteWorkflowCustomProperty> TestCase_RetrieveWorkflowCustomProperties(int currentTypeId, int currentStatusId)
		{
		...
		public void TestRun_Delete(int testRunId)
		{
			...
			if (this.ProjectRolePermissions == null || this.ProjectRolePermissions.FindByProjectRoleIdArtifactTypeIdPermissionId(this.ProjectRoleId, (int)DataModel.Artifact.ArtifactTypeEnum.TestRun, (int)Project.PermissionEnum.Delete) == null)
			{
				//Throw back an exception
				Logger.LogExitingEvent(CLASS_NAME + METHOD_NAME);
				Logger.Flush();
		...
		public List<RemoteTestRun> TestRun_RetrieveByTestCaseId(int testCaseId, List<RemoteFilter> remoteFilters, RemoteSort remoteSort, int startingRow, int numberOfRows)
		{
			...
			return this.TestRun_Retrieve(remoteFilters, remoteSort, startingRow, numberOfRows);
		}
		...
		public List<RemoteTestSetParameter> TestSet_RetrieveParameters(int testSetId)
		{
		...
		/// <param name="testSetId">The id of the test set</param>
		/// <returns>The list of parameter values</returns>
		public List<RemoteTestSetTestCaseParameter> TestSet_RetrieveTestCaseParameters(int testSetId, int testSetTestCaseId)
		{
			const string METHOD_NAME = "TestSet_RetrieveTestCaseParameters";
		...
		public RemoteTestSetFolder TestSet_CreateFolder(RemoteTestSetFolder remoteTestSetFolder)
		{
		...
		/// <returns>The populated test set object - including the primary key</returns>
		public RemoteTestSet TestSet_Create(RemoteTestSet remoteTestSet)
		{
		...
		/// <returns>Test Case Folder object</returns>
		public RemoteTestSetFolder TestSet_RetrieveFolderById(int testSetFolderId)
		{
		...
		public List<RemoteTestSetFolder> TestSet_RetrieveFolders()
		{
		...
		/// <param name="releaseId">The id of the current release, or null = all releases</param>
		/// <returns>The list of folders</returns>
		public List<RemoteTestSetFolder> TestSet_RetrieveFoldersByParent(int? parentTestSetFolderId, int? releaseId)
		{
		...
		public void TestSet_UpdateFolder(RemoteTestSetFolder remoteTestSetFolder)
		{
		...
		/// <param name="releaseId">The id of the release, null = All Releases</param>
		/// <returns>The number of items.</returns>
		public long TestSet_Count(List<RemoteFilter> remoteFilters, int? releaseId)
		{
		...
		public long TestSet_CountForFolder(int? testSetFolderId, List<RemoteFilter> remoteFilters, int? releaseId)
		{
		...
		public List<RemoteTestSet> TestSet_Retrieve(List<RemoteFilter> remoteFilters, RemoteSort remoteSort, int startingRow, int numberOfRows, int? releaseId)
		{
		...
		/// <returns>List of testSets</returns>
		public List<RemoteTestSet> TestSet_RetrieveByFolder(int? testSetFolderId, List<RemoteFilter> remoteFilters, RemoteSort remoteSort, int startingRow, int numberOfRows, int? releaseId)
		{
		...
		/// </returns>
		public List<RemoteTestSetTestCaseMapping> TestSet_AddTestMapping(RemoteTestSetTestCaseMapping remoteTestSetTestCaseMapping, Nullable<int> existingTestSetTestCaseId, List<RemoteTestSetTestCaseParameter> parameters)
		{
		...
		public RemoteTestConfigurationSet TestConfiguration_RetrieveForTestSet(int testSetId)
		{
		...
		public RemoteTestConfigurationSet TestConfiguration_RetrieveSetById(int testConfigurationSetId)
		{
			const string METHOD_NAME = "TestConfiguration_RetrieveSetById";
		...
		public List<RemoteTestConfigurationSet> TestConfiguration_RetrieveSets()
		{
			const string METHOD_NAME = "TestConfiguration_RetrieveSetById";
		...
		public List<RemoteTask> Task_RetrieveNew(DateTime creationDate, int startRow, int numberOfRows)
		{
		...
		public List<RemoteTaskStatus> Task_RetrieveStatuses()
		{
		...
		public List<RemoteTaskType> Task_RetrieveTypes()
		{
		...
		public List<RemoteWorkflowField> Task_RetrieveWorkflowFields(int currentTypeId, int currentStatusId)
		{
		...
		/// <returns>The list of workflow transitions</returns>
		public List<RemoteWorkflowTransition> Task_RetrieveWorkflowTransitions(int currentTypeId, int currentStatusId, bool isCreator, bool isOwner)
		{
		...
		public List<RemoteWorkflowCustomProperty> Task_RetrieveWorkflowCustomProperties(int currentTypeId, int currentStatusId)
		{
		...
		public RemoteTaskFolder Task_CreateFolder(RemoteTaskFolder remoteTaskFolder)
		{
		...
		public List<RemoteTaskFolder> Task_RetrieveFolders()
		{
		...
		/// <returns>Test Case Folder object</returns>
		public RemoteTaskFolder Task_RetrieveFolderById(int taskFolderId)
		{
		...
		/// <returns>The list of folders</returns>
		public List<RemoteTaskFolder> Task_RetrieveFoldersByParent(int? parentTaskFolderId)
		{
		...
		public void Task_UpdateFolder(RemoteTaskFolder remoteTaskFolder)
		{
		...
		public List<RemoteProjectArtifact> DataMapping_SearchArtifactMappings(int dataSyncSystemId, int artifactTypeId, string externalKey)
		{
		...
		/// </example>
		public List<RemoteCustomProperty> CustomProperty_RetrieveForArtifactType(int artifactTypeId, bool includeDeleted)
		{
		...
		#endregion AutomationHost methods
		...
		#endregion AutomationEngine functions
		...
		public List<RemoteSourceCodeBranch> SourceCode_RetrieveBranches()
		{
		...
		/// <returns>The list of folders</returns>
		public List<RemoteSourceCodeFolder> SourceCode_RetrieveFoldersByParent(string branchId, string parentFolderId)
		{
		...
		public List<RemoteSourceCodeFile> SourceCode_RetrieveFilesByFolder(string branchId, string folderId)
		{
		...
		/// <returns>The list of files</returns>
		public List<RemoteSourceCodeFile> SourceCode_RetrieveFilesByRevision(string branchId, string revisionId)
		{
		...
		public RemoteSourceCodeFile SourceCode_RetrieveFileById(string branchId, string fileId)
		{
		...
		public List<RemoteSourceCodeFile> SourceCode_RetrieveFilesForArtifact(string branchId, int artifactTypeId, int artifactId)
		{
		...
		public List<RemoteSourceCodeRevision> SourceCode_RetrieveRevisions(string branchId, int startRow, int numberRows, RemoteSort remoteSort, List<RemoteFilter> remoteFilters)
		{
		...
		/// <param name="fileId">The id of the file</param>
		/// <returns>The list of revisions</returns>
		public List<RemoteSourceCodeRevision> SourceCode_RetrieveRevisionsForFile(string branchId, string fileId)
		{
		...
		public RemoteSourceCodeRevision SourceCode_RetrieveRevisionById(string branchId, string revisionId)
		{
		...
		public List<RemoteSourceCodeRevision> SourceCode_RetrieveRevisionsForArtifact(string branchId, int artifactTypeId, int artifactId)
		{
		...
		public List<RemoteLinkedArtifact> SourceCode_RetrieveArtifactsForRevision(string branchId, string revisionId)
		{
		...
		public long Message_PostNew(int recipientUserId, string messageText)
		{
		...
		public List<RemoteHistoryChange> History_RetrieveForArtifact(int artifactTypeId, int artifactId, int startingRow, int numberOfRows, RemoteSort remoteSort, List<RemoteFilter> remoteFilters)
		{
		...
		/// <remarks>Includes the field-level details of each change</remarks>
		public RemoteHistoryChangeSet History_RetrieveById(int historyChangeSetId)
		{
			...
			try
			{
				...
				if (historyChangeSet != null)
				{
					...
					//Make sure we have permissions to view the artifact type in this project
					if (this.ProjectRolePermissions == null || this.ProjectRolePermissions.FindByProjectRoleIdArtifactTypeIdPermissionId(this.ProjectRoleId, historyChangeSet.ArtifactTypeId, (int)Project.PermissionEnum.View) == null)
					{
						//Throw back an exception
						Logger.LogExitingEvent(CLASS_NAME + METHOD_NAME);
						Logger.Flush();
		...
		public List<RemoteArtifactSubscription> Subscription_RetrieveForArtifact(int artifactTypeId, int artifactId)
		{
			const string METHOD_NAME = "Subscription_RetrieveForUser";

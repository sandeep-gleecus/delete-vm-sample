...
{
    /// <summary>
    /// Represents a decimal-range that is used in filters, etc.
    /// </summary>
    [Serializable]
    public class DecimalRange
    {
        ...
        /// <summary>
        /// Returns the string representation of a decimal-range
        /// </summary>
        ...
        public static bool TryParse(string s, out DecimalRange result)
        {

    ...
    public partial class Session: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        public System.DateTime Expires
        {
            ...
            set
            {
                if (_expires != value)
                {
                    ChangeTracker.RecordOriginalValue("Expires", _expires);
                    _expires = value;
        ...
        [DataMember]
        public string StaticObjects
        {
            get { return _staticObjects; }
            set
            {
                if (_staticObjects != value)
                {
                    ChangeTracker.RecordOriginalValue("StaticObjects", _staticObjects);
                    _staticObjects = value;
                    OnPropertyChanged("StaticObjects");
                }
            }
        }
        private string _staticObjects;
        ...
        public string Items
        {
            ...
            set
            {
                if (_items != value)
                {
                    ChangeTracker.RecordOriginalValue("Items", _items);
                    _items = value;

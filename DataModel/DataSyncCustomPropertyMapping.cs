...
namespace Inflectra.SpiraTest.DataModel
{
    ...
    public partial class DataSyncCustomPropertyMapping: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        private void FixupCustomProperty(CustomProperty previousValue)
        {
            ...
            {
                if (!CustomProperty.DataSyncMappings.Contains(this))
                {
                    CustomProperty.DataSyncMappings.Add(this);
                }
        ...
        private void FixupProject(DataSyncProject previousValue)
        {
            ...
            if (previousValue != null && previousValue.CustomPropertyMappings.Contains(this))
            {
                previousValue.CustomPropertyMappings.Remove(this);
            }
    
            if (Project != null)
            {
                if (!Project.CustomPropertyMappings.Contains(this))
                {
                    Project.CustomPropertyMappings.Add(this);
                }

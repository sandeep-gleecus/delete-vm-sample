...
namespace Inflectra.SpiraTest.DataModel
{
    ...
    public partial class ReleaseWorkflow: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        [DataMember]
        public TrackableCollection<ReleaseWorkflowCustomProperty> CustomProperties
        {
            get
            {
                if (_customProperties == null)
                {
                    _customProperties = new TrackableCollection<ReleaseWorkflowCustomProperty>();
            ...
            set
            {
                if (!ReferenceEquals(_customProperties, value))
                {
                    ...
                    if (_customProperties != null)
                    {
                        ...
                        foreach (ReleaseWorkflowCustomProperty item in _customProperties)
                        {
        ...
        private TrackableCollection<ReleaseWorkflowCustomProperty> _customProperties;
    
        [DataMember]
        public TrackableCollection<ReleaseWorkflowField> Fields
        {
            get
            {
                if (_fields == null)
                {
                    _fields = new TrackableCollection<ReleaseWorkflowField>();
            ...
            set
            {
                if (!ReferenceEquals(_fields, value))
                {
                    ...
                    if (_fields != null)
                    {
                        ...
                        // This is the principal end in an association that performs cascade deletes.
                        // Remove the cascade delete event handler for any entities in the current collection.
                        foreach (ReleaseWorkflowField item in _fields)
                        {
                            ChangeTracker.ObjectStateChanging -= item.HandleCascadeDelete;
                        }
                    }
        ...
        private TrackableCollection<ReleaseWorkflowField> _fields;
    
        [DataMember]
        public TrackableCollection<ReleaseWorkflowTransition> Transitions
        {
            get
            {
                if (_transitions == null)
                {
                    _transitions = new TrackableCollection<ReleaseWorkflowTransition>();
        ...
        private TrackableCollection<ReleaseWorkflowTransition> _transitions;
        ...
        [DataMember]
        public TrackableCollection<ReleaseTypeWorkflow> ReleaseTypes
        {
            get
            {
                if (_releaseTypes == null)
                {
                    _releaseTypes = new TrackableCollection<ReleaseTypeWorkflow>();
                    _releaseTypes.CollectionChanged += FixupReleaseTypes;
                }
                return _releaseTypes;
            }
            set
            {
                if (!ReferenceEquals(_releaseTypes, value))
                {
                    if (ChangeTracker.ChangeTrackingEnabled)
                    {
                        throw new InvalidOperationException("Cannot set the FixupChangeTrackingCollection when ChangeTracking is enabled");
                    ...
                    if (_releaseTypes != null)
                    {
                        ...
                        // This is the principal end in an association that performs cascade deletes.
                        // Remove the cascade delete event handler for any entities in the current collection.
                        foreach (ReleaseTypeWorkflow item in _releaseTypes)
                        {
                            ChangeTracker.ObjectStateChanging -= item.HandleCascadeDelete;
                        }
                    }
                    ...
                    OnNavigationPropertyChanged("ReleaseTypes");
                }
            }
        }
        private TrackableCollection<ReleaseTypeWorkflow> _releaseTypes;
        ...
        private void FixupProjectTemplate(ProjectTemplate previousValue)
        {
            ...
            if (previousValue != null && previousValue.ReleaseWorkflows.Contains(this))
            {
                previousValue.ReleaseWorkflows.Remove(this);
            }
    
            if (ProjectTemplate != null)
            {
                if (!ProjectTemplate.ReleaseWorkflows.Contains(this))
                {
                    ProjectTemplate.ReleaseWorkflows.Add(this);
                }
        ...
        private void FixupReleaseTypes(object sender, NotifyCollectionChangedEventArgs e)
        {
            if (IsDeserializing)
            {
                return;
            ...
            if (e.NewItems != null)
            {
                foreach (ReleaseTypeWorkflow item in e.NewItems)
                {
                    ...
                    if (ChangeTracker.ChangeTrackingEnabled)
                    {
                        ...
                        ChangeTracker.RecordAdditionToCollectionProperties("ReleaseTypes", item);
                    }
                    // This is the principal end in an association that performs cascade deletes.
                    // Update the event listener to refer to the new dependent.
                    ChangeTracker.ObjectStateChanging += item.HandleCascadeDelete;
            ...
            if (e.OldItems != null)
            {
                foreach (ReleaseTypeWorkflow item in e.OldItems)
                {
                    ...
                    if (ChangeTracker.ChangeTrackingEnabled)
                    {
                        ChangeTracker.RecordRemovalFromCollectionProperties("ReleaseTypes", item);
                        // Delete the dependent end of this identifying association. If the current state is Added,
                        // allow the relationship to be changed without causing the dependent to be deleted.
                        if (item.ChangeTracker.State != ObjectState.Added)
                        {

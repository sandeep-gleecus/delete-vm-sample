...
namespace Inflectra.SpiraTest.DataModel
{
    ...
    public partial class R_ProjectGroup: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        [DataMember]
        public Nullable<int> PORTFOLIO_ID
        {
            ...
            set
            {
                ...
                {
                    ChangeTracker.RecordOriginalValue("PORTFOLIO_ID", _pORTFOLIO_ID);
                    _pORTFOLIO_ID = value;
                    OnPropertyChanged("PORTFOLIO_ID");
                }
            }
        }
        private Nullable<int> _pORTFOLIO_ID;

...
{
    /// <summary>
    /// RESTful service interface for SpiraTeam v5.0+. Alternative to the ImportExport.svc SOAP API
    /// </summary>
    /// <remarks>
    ...
    /// </remarks>
    [
    ServiceContract(Namespace = "http://www.inflectra.com/SpiraTest/Services/v5.0/", SessionMode = SessionMode.NotAllowed)
    ]
    public interface IRestService
    {
        ...
        List<RemoteWorkflowField> Incident_RetrieveWorkflowFields(string project_id, string incident_type_id, string incident_status_id);
        ...
        List<RemoteWorkflowCustomProperty> Incident_RetrieveWorkflowCustomProperties(string project_id, string incident_type_id, string incident_status_id);
        ...
        OperationContract,
        WebGet(UriTemplate = "projects/{project_id}/releases/statuses")
        ]
        List<RemoteReleaseStatus> Release_RetrieveStatuses(string project_id);

        [
        RestResource("Release Type", "This resource lets you retrieve the list of release types in the system"),
        OperationContract,
        WebGet(UriTemplate = "projects/{project_id}/releases/types")
        ]
        List<RemoteReleaseType> Release_RetrieveTypes(string project_id);
        ...
        RestResource("Release Type"),
        OperationContract,
        WebGet(UriTemplate = "projects/{project_id}/releases/types/{release_type_id}/workflow/fields?status_id={release_status_id}")
        ]
        List<RemoteWorkflowField> Release_RetrieveWorkflowFields(string project_id, string release_type_id, string release_status_id);

        [
        RestResource("Release Type"),
        OperationContract,
        WebGet(UriTemplate = "projects/{project_id}/releases/types/{release_type_id}/workflow/custom-properties?status_id={release_status_id}")
        ]
        List<RemoteWorkflowCustomProperty> Release_RetrieveWorkflowCustomProperties(string project_id, string release_type_id, string release_status_id);
        ...
        RestResource("Requirement"),
        OperationContract,
        WebInvoke(Method = "POST", UriTemplate = "projects/{project_id}/requirements/{requirement_id}/move")
        ]
        void Requirement_MoveToEnd(string project_id, string requirement_id);
        ...
        [
        RestResource("Requirement Status", "This resource lets you retrieve the list of requirement statuses in the system"),
        OperationContract,
        WebGet(UriTemplate = "projects/{project_id}/requirements/statuses")
        ]
        List<RemoteRequirementStatus> Requirement_RetrieveStatuses(string project_id);

        [
        RestResource("Requirement Type", "This resource lets you retrieve the list of requirement types in the system"),
        OperationContract,
        WebGet(UriTemplate = "projects/{project_id}/requirements/types")
        ]
        List<RemoteRequirementType> Requirement_RetrieveTypes(string project_id);
        ...
        RestResource("Requirement Type"),
        OperationContract,
        WebGet(UriTemplate = "projects/{project_id}/requirements/types/{requirement_type_id}/workflow/fields?status_id={requirement_status_id}")
        ]
        List<RemoteWorkflowField> Requirement_RetrieveWorkflowFields(string project_id, string requirement_type_id, string requirement_status_id);

        [
        RestResource("Requirement Type"),
        OperationContract,
        WebGet(UriTemplate = "projects/{project_id}/requirements/types/{requirement_type_id}/workflow/custom-properties?status_id={requirement_status_id}")
        ]
        List<RemoteWorkflowCustomProperty> Requirement_RetrieveWorkflowCustomProperties(string project_id, string requirement_type_id, string requirement_status_id);
        ...
        OperationContract,
        WebGet(UriTemplate = "projects/{project_id}/test-cases/statuses")
        ]
        List<RemoteTestCaseStatus> TestCase_RetrieveStatuses(string project_id);

        [
        RestResource("Test Case Type", "This resource lets you retrieve the list of Test Case types in the system"),
        OperationContract,
        WebGet(UriTemplate = "projects/{project_id}/test-cases/types")
        ]
        List<RemoteTestCaseType> TestCase_RetrieveTypes(string project_id);
        ...
        RestResource("Test Case Type"),
        OperationContract,
        WebGet(UriTemplate = "projects/{project_id}/test-cases/types/{test_case_type_id}/workflow/fields?status_id={test_case_status_id}")
        ]
        List<RemoteWorkflowField> TestCase_RetrieveWorkflowFields(string project_id, string test_case_type_id, string test_case_status_id);

        [
        RestResource("Test Case Type"),
        OperationContract,
        WebGet(UriTemplate = "projects/{project_id}/test-cases/types/{test_case_type_id}/workflow/custom-properties?status_id={test_case_status_id}")
        ]
        List<RemoteWorkflowCustomProperty> TestCase_RetrieveWorkflowCustomProperties(string project_id, string test_case_type_id, string test_case_status_id);
        ...
        OperationContract,
        WebGet(UriTemplate = "projects/{project_id}/tasks/statuses")
        ]
        List<RemoteTaskStatus> Task_RetrieveStatuses(string project_id);

        [
        RestResource("Task Type", "This resource lets you retrieve the list of Task types in the system"),
        OperationContract,
        WebGet(UriTemplate = "projects/{project_id}/tasks/types")
        ]
        List<RemoteTaskType> Task_RetrieveTypes(string project_id);
        ...
        RestResource("Task Type"),
        OperationContract,
        WebGet(UriTemplate = "projects/{project_id}/tasks/types/{task_type_id}/workflow/fields?status_id={task_status_id}")
        ]
        List<RemoteWorkflowField> Task_RetrieveWorkflowFields(string project_id, string task_type_id, string task_status_id);

        [
        RestResource("Task Type"),
        OperationContract,
        WebGet(UriTemplate = "projects/{project_id}/tasks/types/{task_type_id}/workflow/custom-properties?status_id={task_status_id}")
        ]
        List<RemoteWorkflowCustomProperty> Task_RetrieveWorkflowCustomProperties(string project_id, string task_type_id, string task_status_id);

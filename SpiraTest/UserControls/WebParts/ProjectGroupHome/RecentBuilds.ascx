<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="RecentBuilds.ascx.cs" Inherits="Inflectra.SpiraTest.Web.UserControls.WebParts.ProjectGroupHome.RecentBuilds" %>
...
<script type="text/javascript">
    ...
    function load_recentBuilds() {
        ...
        var projectGroupId = SpiraContext.ProjectGroupId;
        var rowsToDisplay = <%=RowsToDisplay.ToString()%>;
        Inflectra.SpiraTest.Web.Services.Ajax.ProgramService.Program_RetrieveBuilds(projectGroupId, rowsToDisplay, function (data)
        {
            //Success

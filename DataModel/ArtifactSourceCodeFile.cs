...
namespace Inflectra.SpiraTest.DataModel
{
    ...
    public partial class ArtifactSourceCodeFile: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        #region Primitive Properties
    
        [DataMember]
        public int ArtifactSourceCodeFileId
        {
            get { return _artifactSourceCodeFileId; }
            set
            {
                if (_artifactSourceCodeFileId != value)
                {
                    if (ChangeTracker.ChangeTrackingEnabled && ChangeTracker.State != ObjectState.Added)
                    {
                        throw new InvalidOperationException("The property 'ArtifactSourceCodeFileId' is part of the object's key and cannot be changed. Changes to key properties can only be made when the object is not being tracked or is in the Added state.");
                    }
                    _artifactSourceCodeFileId = value;
                    OnPropertyChanged("ArtifactSourceCodeFileId");
                }
            }
        }
        private int _artifactSourceCodeFileId;
        ...
        public string FileKey
        {
            ...
            set
            {
                if (_fileKey != value)
                {
                    ChangeTracker.RecordOriginalValue("FileKey", _fileKey);
                    _fileKey = value;
        ...
        private void FixupArtifactType(ArtifactType previousValue)
        {
            ...
            if (previousValue != null && previousValue.SourceCodeFiles.Contains(this))
            {
                previousValue.SourceCodeFiles.Remove(this);
            }
    
            if (ArtifactType != null)
            {
                if (!ArtifactType.SourceCodeFiles.Contains(this))
                {
                    ArtifactType.SourceCodeFiles.Add(this);
                }

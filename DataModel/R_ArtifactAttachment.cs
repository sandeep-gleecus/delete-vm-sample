...
namespace Inflectra.SpiraTest.DataModel
{
    ...
    public partial class R_ArtifactAttachment: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        #region Primitive Properties
    
        [DataMember]
        public Nullable<int> ARTIFACT_LINK_ID
        {
            ...
            set
            {
                ...
                {
                    ChangeTracker.RecordOriginalValue("ARTIFACT_LINK_ID", _aRTIFACT_LINK_ID);
                    _aRTIFACT_LINK_ID = value;
                    OnPropertyChanged("ARTIFACT_LINK_ID");
                }
            }
        }
        private Nullable<int> _aRTIFACT_LINK_ID;
        ...
        public string COMMENT
        {
            ...
            set
            {
                if (_cOMMENT != value)
                {
                    if (ChangeTracker.ChangeTrackingEnabled && ChangeTracker.State != ObjectState.Added)
                    {
                        throw new InvalidOperationException("The property 'COMMENT' is part of the object's key and cannot be changed. Changes to key properties can only be made when the object is not being tracked or is in the Added state.");
                    }
                    _cOMMENT = value;
        ...
        [DataMember]
        public string ARTIFACT_STATUS_NAME
        {
            get { return _aRTIFACT_STATUS_NAME; }
            set
            {
                if (_aRTIFACT_STATUS_NAME != value)
                {
                    if (ChangeTracker.ChangeTrackingEnabled && ChangeTracker.State != ObjectState.Added)
                    {
                        throw new InvalidOperationException("The property 'ARTIFACT_STATUS_NAME' is part of the object's key and cannot be changed. Changes to key properties can only be made when the object is not being tracked or is in the Added state.");
                    }
                    _aRTIFACT_STATUS_NAME = value;
                    OnPropertyChanged("ARTIFACT_STATUS_NAME");
                }
            }
        }
        private string _aRTIFACT_STATUS_NAME;

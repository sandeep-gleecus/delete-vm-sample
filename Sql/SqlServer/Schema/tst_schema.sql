USE [ValidationMasterAudit];
GO

/* ---------------------------------------------------------------------- */
/* Add table "TST_ADMIN_SECTION_AUDIT"                                */
/* ---------------------------------------------------------------------- */
IF OBJECT_ID('TST_ADMIN_SECTION_AUDIT', 'U') IS NULL
BEGIN
CREATE TABLE [dbo].[TST_ADMIN_SECTION_AUDIT](
	[ADMIN_SECTION_ID] [int] IDENTITY(1,1) NOT NULL,
...
/* ---------------------------------------------------------------------- */
/* Add table "TST_ADMIN_HISTORY_CHANGESET_AUDIT"                                */
/* ---------------------------------------------------------------------- */
IF OBJECT_ID('TST_ADMIN_HISTORY_CHANGESET_AUDIT', 'U') IS NULL
BEGIN
CREATE TABLE [dbo].[TST_ADMIN_HISTORY_CHANGESET_AUDIT](
	[CHANGESET_ID] [bigint] IDENTITY(1,1) NOT NULL,
	[ADMIN_USER_ID] [int] NULL,
	[CHANGE_DATE] [datetime] NOT NULL,
	[ADMIN_SECTION_ID] [int] NOT NULL,
	[HISTORY_CHANGESET_TYPE_ID] [int] NULL,
	[ACTION_DESCRIPTION] [nvarchar](max) NULL,
	[ARTIFACT_ID] [int] NULL,
	[ARTIFACT_GUID_ID] [uniqueidentifier] NULL,
PRIMARY KEY CLUSTERED 
(
	[CHANGESET_ID] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY]
...
/* ---------------------------------------------------------------------- */
/* Add table "TST_ADMIN_HISTORY_DETAILS_AUDIT"                                */
/* ---------------------------------------------------------------------- */
IF OBJECT_ID('TST_ADMIN_HISTORY_DETAILS_AUDIT', 'U') IS NULL
BEGIN
CREATE TABLE [dbo].[TST_ADMIN_HISTORY_DETAILS_AUDIT](
	[ADMIN_HISTORY_DETAIL_ID] [bigint] IDENTITY(1,1) NOT NULL,
	[ADMIN_PROPERTY_NAME] [nvarchar](max) NULL,
	[OLD_VALUE] [nvarchar](max) NULL,
	[NEW_VALUE] [nvarchar](max) NULL,
	[OLD_VALUE_INT] [int] NULL,
	[NEW_VALUE_INT] [int] NULL,
	[OLD_VALUE_DATE] [datetime] NULL,
	[NEW_VALUE_DATE] [datetime] NULL,
	[ADMIN_USER_ID] [int] NULL,
	[ADMIN_ARTIFACT_FIELD_ID] [int] NULL,
	[ADMIN_CUSTOM_PROPERTY_ID] [int] NULL,
	[ADMIN_CHANGESET_ID] [bigint] NOT NULL,
	[ADMIN_ARTIFACT_FIELD_NAME] [nvarchar](50) NULL,
	[ADMIN_ARTIFACT_FIELD_CAPTION] [nvarchar](50) NULL,
PRIMARY KEY CLUSTERED 
(
	[ADMIN_HISTORY_DETAIL_ID] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY]
) ON [PRIMARY] TEXTIMAGE_ON [PRIMARY]
END
GO
...
/* ---------------------------------------------------------------------- */
IF OBJECT_ID('TST_HISTORY_CHANGESET', 'U') IS NULL
BEGIN
CREATE TABLE [dbo].[TST_HISTORY_CHANGESET](
	[CHANGESET_ID] [bigint] IDENTITY(1,1) NOT NULL,
	...
	[PROJECT_ID] [int] NULL,
	[REVERT_ID] [bigint] NULL,
	[ARTIFACT_DESC] [nvarchar](255) NULL,
	[SIGNATURE_HASH] [nvarchar](255) NULL,
	[MEANING] [nvarchar](max) NULL,
 CONSTRAINT [PK_TST_HISTORY_CHANGESET] PRIMARY KEY CLUSTERED 
(
	[CHANGESET_ID] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY]
) ON [PRIMARY] TEXTIMAGE_ON [PRIMARY]
...
/* ---------------------------------------------------------------------- */
IF OBJECT_ID('TST_HISTORY_DETAIL', 'U') IS NULL
BEGIN
CREATE TABLE [dbo].[TST_HISTORY_DETAIL](
 ...
 CONSTRAINT [XPKTST_ARTIFACT_HISTORY] PRIMARY KEY CLUSTERED 
(
	[ARTIFACT_HISTORY_ID] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY]
) ON [PRIMARY] TEXTIMAGE_ON [PRIMARY]
END
GO
...
/* ---------------------------------------------------------------------- */
/* Add table "TST_USER_ACTIVITY_LOG_AUDIT"                                */
/* ---------------------------------------------------------------------- */
IF OBJECT_ID('TST_USER_ACTIVITY_LOG_AUDIT', 'U') IS NULL
BEGIN
CREATE TABLE [dbo].[TST_USER_ACTIVITY_LOG_AUDIT](
	[USER_ACTIVITY_LOG_ID] [bigint] IDENTITY(1,1) NOT NULL,
	[USER_ID] [int] NOT NULL,
...
/* ---------------------------------------------------------------------- */
/* Add table "TST_USER_HISTORY_CHANGESET_AUDIT"                                */
/* ---------------------------------------------------------------------- */
IF OBJECT_ID('TST_USER_HISTORY_CHANGESET_AUDIT', 'U') IS NULL
BEGIN
CREATE TABLE [dbo].[TST_USER_HISTORY_CHANGESET_AUDIT](
	[CHANGESET_ID] [bigint] IDENTITY(1,1) NOT NULL,
	[USER_ID] [int] NOT NULL,
	...
	[OLD_VALUE] [nvarchar](max) NULL,
	[NEW_VALUE] [nvarchar](max) NULL,
	[HISTORY_CHANGESET_TYPE_ID] [int] NOT NULL,
	[ADMIN_SECTION_ID] [int] NOT NULL,
PRIMARY KEY CLUSTERED 
(
	[CHANGESET_ID] ASC
...
IF NOT EXISTS (
    ...
    WHERE t.name = 'TST_ADMIN_HISTORY_CHANGESET_AUDIT'
      AND c.name = 'ARTIFACT_ID'
      AND dc.definition = '((0))'
)
BEGIN
ALTER TABLE [dbo].[TST_ADMIN_HISTORY_CHANGESET_AUDIT] ADD  DEFAULT ((0)) FOR [ARTIFACT_ID]
END
GO
...
IF NOT EXISTS (
    ...
    WHERE name = 'ADMIN_SECTION_ID'
)
BEGIN
ALTER TABLE [dbo].[TST_ADMIN_HISTORY_CHANGESET_AUDIT]  WITH CHECK ADD FOREIGN KEY([ADMIN_SECTION_ID])
REFERENCES [dbo].[TST_ADMIN_SECTION_AUDIT] ([ADMIN_SECTION_ID])
END
GO
...
IF NOT EXISTS (
    SELECT 1 
    FROM sys.foreign_keys 
    WHERE name = 'ADMIN_CHANGESET_ID'
)
BEGIN
ALTER TABLE [dbo].[TST_ADMIN_HISTORY_DETAILS_AUDIT]  WITH CHECK ADD FOREIGN KEY([ADMIN_CHANGESET_ID])
REFERENCES [dbo].[TST_ADMIN_HISTORY_CHANGESET_AUDIT] ([CHANGESET_ID])
END
GO
...
BEGIN
ALTER TABLE [dbo].[TST_USER_HISTORY_CHANGESET_AUDIT]  WITH CHECK ADD FOREIGN KEY([ADMIN_SECTION_ID])
REFERENCES [dbo].[TST_ADMIN_SECTION_AUDIT] ([ADMIN_SECTION_ID])
END
GO

SET IDENTITY_INSERT [dbo].[TST_ADMIN_SECTION_AUDIT] ON;

-- Insert rows if they do not already exist
IF NOT EXISTS (SELECT 1 FROM [dbo].[TST_ADMIN_SECTION_AUDIT] WHERE [ADMIN_SECTION_ID] = 1)
BEGIN
    INSERT [dbo].[TST_ADMIN_SECTION_AUDIT] ([ADMIN_SECTION_ID], [NAME], [DESCRIPTION], [PARENT_ID], [IS_ACTIVE]) 
    VALUES (1, N'Workspaces', N'Workspaces', NULL, 1);
END

IF NOT EXISTS (SELECT 1 FROM [dbo].[TST_ADMIN_SECTION_AUDIT] WHERE [ADMIN_SECTION_ID] = 2)
BEGIN
    INSERT [dbo].[TST_ADMIN_SECTION_AUDIT] ([ADMIN_SECTION_ID], [NAME], [DESCRIPTION], [PARENT_ID], [IS_ACTIVE]) 
    VALUES (2, N'View / Edit Projects', N'View / Edit Projects', 1, 1);
END

IF NOT EXISTS (SELECT 1 FROM [dbo].[TST_ADMIN_SECTION_AUDIT] WHERE [ADMIN_SECTION_ID] = 3)
BEGIN
    INSERT [dbo].[TST_ADMIN_SECTION_AUDIT] ([ADMIN_SECTION_ID], [NAME], [DESCRIPTION], [PARENT_ID], [IS_ACTIVE]) 
    VALUES (3, N'View / Edit Programs', N'View / Edit Programs', 1, 1);
END

IF NOT EXISTS (SELECT 1 FROM [dbo].[TST_ADMIN_SECTION_AUDIT] WHERE [ADMIN_SECTION_ID] = 4)
BEGIN
    INSERT [dbo].[TST_ADMIN_SECTION_AUDIT] ([ADMIN_SECTION_ID], [NAME], [DESCRIPTION], [PARENT_ID], [IS_ACTIVE]) 
    VALUES (4, N'View / Edit Portfolios', N'View / Edit Portfolios', 1, 1);
END

IF NOT EXISTS (SELECT 1 FROM [dbo].[TST_ADMIN_SECTION_AUDIT] WHERE [ADMIN_SECTION_ID] = 5)
BEGIN
    INSERT [dbo].[TST_ADMIN_SECTION_AUDIT] ([ADMIN_SECTION_ID], [NAME], [DESCRIPTION], [PARENT_ID], [IS_ACTIVE]) 
    VALUES (5, N'View / Edit Templates', N'View / Edit Templates', 1, 1);
END

IF NOT EXISTS (SELECT 1 FROM [dbo].[TST_ADMIN_SECTION_AUDIT] WHERE [ADMIN_SECTION_ID] = 6)
BEGIN
    INSERT [dbo].[TST_ADMIN_SECTION_AUDIT] ([ADMIN_SECTION_ID], [NAME], [DESCRIPTION], [PARENT_ID], [IS_ACTIVE]) 
    VALUES (6, N'Users', N'Users', NULL, 1);
END

IF NOT EXISTS (SELECT 1 FROM [dbo].[TST_ADMIN_SECTION_AUDIT] WHERE [ADMIN_SECTION_ID] = 7)
BEGIN
    INSERT [dbo].[TST_ADMIN_SECTION_AUDIT] ([ADMIN_SECTION_ID], [NAME], [DESCRIPTION], [PARENT_ID], [IS_ACTIVE]) 
    VALUES (7, N'View / Edit Users', N'View / Edit Users', 6, 1);
END

IF NOT EXISTS (SELECT 1 FROM [dbo].[TST_ADMIN_SECTION_AUDIT] WHERE [ADMIN_SECTION_ID] = 8)
BEGIN
    INSERT [dbo].[TST_ADMIN_SECTION_AUDIT] ([ADMIN_SECTION_ID], [NAME], [DESCRIPTION], [PARENT_ID], [IS_ACTIVE]) 
    VALUES (8, N'View / Edit Project Roles', N'View / Edit Project Roles', 6, 1);
END

IF NOT EXISTS (SELECT 1 FROM [dbo].[TST_ADMIN_SECTION_AUDIT] WHERE [ADMIN_SECTION_ID] = 9)
BEGIN
    INSERT [dbo].[TST_ADMIN_SECTION_AUDIT] ([ADMIN_SECTION_ID], [NAME], [DESCRIPTION], [PARENT_ID], [IS_ACTIVE]) 
    VALUES (9, N'Active Sessions', N'Active Sessions', 6, 1);
END

IF NOT EXISTS (SELECT 1 FROM [dbo].[TST_ADMIN_SECTION_AUDIT] WHERE [ADMIN_SECTION_ID] = 10)
BEGIN
    INSERT [dbo].[TST_ADMIN_SECTION_AUDIT] ([ADMIN_SECTION_ID], [NAME], [DESCRIPTION], [PARENT_ID], [IS_ACTIVE]) 
    VALUES (10, N'Pending Requests', N'Pending Requests', 6, 1);
END

IF NOT EXISTS (SELECT 1 FROM [dbo].[TST_ADMIN_SECTION_AUDIT] WHERE [ADMIN_SECTION_ID] = 11)
BEGIN
    INSERT [dbo].[TST_ADMIN_SECTION_AUDIT] ([ADMIN_SECTION_ID], [NAME], [DESCRIPTION], [PARENT_ID], [IS_ACTIVE]) 
    VALUES (11, N'LDAP Configuration', N'LDAP Configuration', 6, 1);
END

IF NOT EXISTS (SELECT 1 FROM [dbo].[TST_ADMIN_SECTION_AUDIT] WHERE [ADMIN_SECTION_ID] = 12)
BEGIN
    INSERT [dbo].[TST_ADMIN_SECTION_AUDIT] ([ADMIN_SECTION_ID], [NAME], [DESCRIPTION], [PARENT_ID], [IS_ACTIVE]) 
    VALUES (12, N'Manage Login Providers', N'Manage Login Providers', 6, 1);
END

IF NOT EXISTS (SELECT 1 FROM [dbo].[TST_ADMIN_SECTION_AUDIT] WHERE [ADMIN_SECTION_ID] = 14)
BEGIN
    INSERT [dbo].[TST_ADMIN_SECTION_AUDIT] ([ADMIN_SECTION_ID], [NAME], [DESCRIPTION], [PARENT_ID], [IS_ACTIVE]) 
    VALUES (14, N'System', N'System', NULL, 1);
END

IF NOT EXISTS (SELECT 1 FROM [dbo].[TST_ADMIN_SECTION_AUDIT] WHERE [ADMIN_SECTION_ID] = 15)
BEGIN
    INSERT [dbo].[TST_ADMIN_SECTION_AUDIT] ([ADMIN_SECTION_ID], [NAME], [DESCRIPTION], [PARENT_ID], [IS_ACTIVE]) 
    VALUES (15, N'General Settings', N'General Settings', 14, 1);
END

IF NOT EXISTS (SELECT 1 FROM [dbo].[TST_ADMIN_SECTION_AUDIT] WHERE [ADMIN_SECTION_ID] = 16)
BEGIN
    INSERT [dbo].[TST_ADMIN_SECTION_AUDIT] ([ADMIN_SECTION_ID], [NAME], [DESCRIPTION], [PARENT_ID], [IS_ACTIVE]) 
    VALUES (16, N'Event Log', N'Event Log', 14, 1);
END

IF NOT EXISTS (SELECT 1 FROM [dbo].[TST_ADMIN_SECTION_AUDIT] WHERE [ADMIN_SECTION_ID] = 18)
BEGIN
    INSERT [dbo].[TST_ADMIN_SECTION_AUDIT] ([ADMIN_SECTION_ID], [NAME], [DESCRIPTION], [PARENT_ID], [IS_ACTIVE]) 
    VALUES (18, N'Security Settings', N'Security Settings', 14, 1);
END

IF NOT EXISTS (SELECT 1 FROM [dbo].[TST_ADMIN_SECTION_AUDIT] WHERE [ADMIN_SECTION_ID] = 19)
BEGIN
    INSERT [dbo].[TST_ADMIN_SECTION_AUDIT] ([ADMIN_SECTION_ID], [NAME], [DESCRIPTION], [PARENT_ID], [IS_ACTIVE]) 
    VALUES (19, N'Email Configuration', N'Email Configuration', 14, 1);
END

IF NOT EXISTS (SELECT 1 FROM [dbo].[TST_ADMIN_SECTION_AUDIT] WHERE [ADMIN_SECTION_ID] = 20)
BEGIN
    INSERT [dbo].[TST_ADMIN_SECTION_AUDIT] ([ADMIN_SECTION_ID], [NAME], [DESCRIPTION], [PARENT_ID], [IS_ACTIVE]) 
    VALUES (20, N'File Type Icons', N'File Type Icons', 14, 1);
END

IF NOT EXISTS (SELECT 1 FROM [dbo].[TST_ADMIN_SECTION_AUDIT] WHERE [ADMIN_SECTION_ID] = 21)
BEGIN
    INSERT [dbo].[TST_ADMIN_SECTION_AUDIT] ([ADMIN_SECTION_ID], [NAME], [DESCRIPTION], [PARENT_ID], [IS_ACTIVE]) 
    VALUES (21, N'License Details', N'License Details', 14, 1);
END

IF NOT EXISTS (SELECT 1 FROM [dbo].[TST_ADMIN_SECTION_AUDIT] WHERE [ADMIN_SECTION_ID] = 22)
BEGIN
    INSERT [dbo].[TST_ADMIN_SECTION_AUDIT] ([ADMIN_SECTION_ID], [NAME], [DESCRIPTION], [PARENT_ID], [IS_ACTIVE]) 
    VALUES (22, N'System Information', N'System Information', 14, 1);
END

IF NOT EXISTS (SELECT 1 FROM [dbo].[TST_ADMIN_SECTION_AUDIT] WHERE [ADMIN_SECTION_ID] = 23)
BEGIN
    INSERT [dbo].[TST_ADMIN_SECTION_AUDIT] ([ADMIN_SECTION_ID], [NAME], [DESCRIPTION], [PARENT_ID], [IS_ACTIVE]) 
    VALUES (23, N'Integration', N'Integration', NULL, 1);
END

IF NOT EXISTS (SELECT 1 FROM [dbo].[TST_ADMIN_SECTION_AUDIT] WHERE [ADMIN_SECTION_ID] = 24)
BEGIN
    INSERT [dbo].[TST_ADMIN_SECTION_AUDIT] ([ADMIN_SECTION_ID], [NAME], [DESCRIPTION], [PARENT_ID], [IS_ACTIVE]) 
    VALUES (24, N'Source Code', N'Source Code', 23, 1);
END

IF NOT EXISTS (SELECT 1 FROM [dbo].[TST_ADMIN_SECTION_AUDIT] WHERE [ADMIN_SECTION_ID] = 25)
BEGIN
    INSERT [dbo].[TST_ADMIN_SECTION_AUDIT] ([ADMIN_SECTION_ID], [NAME], [DESCRIPTION], [PARENT_ID], [IS_ACTIVE]) 
    VALUES (25, N'Data Synchronization', N'Data Synchronization', 23, 1);
END

IF NOT EXISTS (SELECT 1 FROM [dbo].[TST_ADMIN_SECTION_AUDIT] WHERE [ADMIN_SECTION_ID] = 26)
BEGIN
    INSERT [dbo].[TST_ADMIN_SECTION_AUDIT] ([ADMIN_SECTION_ID], [NAME], [DESCRIPTION], [PARENT_ID], [IS_ACTIVE]) 
    VALUES (26, N'Test Automation', N'Test Automation', 23, 1);
END

IF NOT EXISTS (SELECT 1 FROM [dbo].[TST_ADMIN_SECTION_AUDIT] WHERE [ADMIN_SECTION_ID] = 27)
BEGIN
    INSERT [dbo].[TST_ADMIN_SECTION_AUDIT] ([ADMIN_SECTION_ID], [NAME], [DESCRIPTION], [PARENT_ID], [IS_ACTIVE]) 
    VALUES (27, N'Web Services', N'Web Services', 23, 1);
END

IF NOT EXISTS (SELECT 1 FROM [dbo].[TST_ADMIN_SECTION_AUDIT] WHERE [ADMIN_SECTION_ID] = 28)
BEGIN
    INSERT [dbo].[TST_ADMIN_SECTION_AUDIT] ([ADMIN_SECTION_ID], [NAME], [DESCRIPTION], [PARENT_ID], [IS_ACTIVE]) 
    VALUES (28, N'Reporting', N'Reporting', NULL, 1);
END

IF NOT EXISTS (SELECT 1 FROM [dbo].[TST_ADMIN_SECTION_AUDIT] WHERE [ADMIN_SECTION_ID] = 29)
BEGIN
    INSERT [dbo].[TST_ADMIN_SECTION_AUDIT] ([ADMIN_SECTION_ID], [NAME], [DESCRIPTION], [PARENT_ID], [IS_ACTIVE]) 
    VALUES (29, N'Edit Reports', N'Edit Reports', 28, 1);
END

IF NOT EXISTS (SELECT 1 FROM [dbo].[TST_ADMIN_SECTION_AUDIT] WHERE [ADMIN_SECTION_ID] = 30)
BEGIN
    INSERT [dbo].[TST_ADMIN_SECTION_AUDIT] ([ADMIN_SECTION_ID], [NAME], [DESCRIPTION], [PARENT_ID], [IS_ACTIVE]) 
    VALUES (30, N'Edit Graphs', N'Edit Graphs', 28, 1);
END

IF NOT EXISTS (SELECT 1 FROM [dbo].[TST_ADMIN_SECTION_AUDIT] WHERE [ADMIN_SECTION_ID] = 31)
BEGIN
    INSERT [dbo].[TST_ADMIN_SECTION_AUDIT] ([ADMIN_SECTION_ID], [NAME], [DESCRIPTION], [PARENT_ID], [IS_ACTIVE]) 
    VALUES (31, N'Audit Trail', N'Audit Trail', NULL, 1);
END

IF NOT EXISTS (SELECT 1 FROM [dbo].[TST_ADMIN_SECTION_AUDIT] WHERE [ADMIN_SECTION_ID] = 32)
BEGIN
    INSERT [dbo].[TST_ADMIN_SECTION_AUDIT] ([ADMIN_SECTION_ID], [NAME], [DESCRIPTION], [PARENT_ID], [IS_ACTIVE]) 
    VALUES (32, N'AuditTrail', N'AuditTrail', 31, 1);
END

IF NOT EXISTS (SELECT 1 FROM [dbo].[TST_ADMIN_SECTION_AUDIT] WHERE [ADMIN_SECTION_ID] = 33)
BEGIN
    INSERT [dbo].[TST_ADMIN_SECTION_AUDIT] ([ADMIN_SECTION_ID], [NAME], [DESCRIPTION], [PARENT_ID], [IS_ACTIVE]) 
    VALUES (33, N'AuditTrail Settings', N'AuditTrail Settings', 31, 0);
END

SET IDENTITY_INSERT [dbo].[TST_ADMIN_SECTION_AUDIT] OFF;
GO
...
/* ---------------------------------------------------------------------- */
/* Add table "TST_REPORT_DOWNLOADABLE"                                */
/* ---------------------------------------------------------------------- */

GO

CREATE TABLE [dbo].[TST_REPORT_DOWNLOADABLE](
	[DOWNLOADABLE_REPORT_ID] [bigint] IDENTITY(1,1) NOT NULL,
	[REPORT_NUMBER] [nvarchar](max) NOT NULL,
	[REPORT_NAME] [nvarchar](max) NOT NULL,
	[REPORT_CATEGORYID] [int] NOT NULL,
	[APPROVED] [bit] NOT NULL,
	[REPORT_OWNERID] [int] NOT NULL,
...
/* ---------------------------------------------------------------------- */
/* Add table "TST_ADMIN_SECTION"                                 */
/* ---------------------------------------------------------------------- */

GO

CREATE TABLE [dbo].[TST_ADMIN_SECTION](
	[ADMIN_SECTION_ID] [int] IDENTITY(1,1) NOT NULL,
	[NAME] [varchar](50) NULL,
	[DESCRIPTION] [nvarchar](max) NULL,
	[PARENT_ID] [int] NULL,
...
/* ---------------------------------------------------------------------- */
/* Add table "TST_ADMIN_HISTORY_CHANGESET"                                 */
/* ---------------------------------------------------------------------- */

GO

CREATE TABLE [dbo].[TST_ADMIN_HISTORY_CHANGESET](
	[CHANGESET_ID] [bigint] IDENTITY(1,1) NOT NULL,
...
ALTER TABLE [dbo].[TST_ADMIN_HISTORY_CHANGESET]  WITH CHECK ADD  CONSTRAINT [FK_TST_ADMIN_HISTORY_CHANGESET_TST_USER] FOREIGN KEY([ADMIN_USER_ID])
REFERENCES [dbo].[TST_USER] ([USER_ID])
GO

ALTER TABLE [dbo].[TST_ADMIN_HISTORY_CHANGESET] CHECK CONSTRAINT [FK_TST_ADMIN_HISTORY_CHANGESET_TST_USER]
GO

ALTER TABLE [dbo].[TST_ADMIN_HISTORY_CHANGESET]  WITH CHECK ADD  CONSTRAINT [FK_TST_ADMIN_HISTORY_CHANGESET_TST_ADMIN_SECTION] FOREIGN KEY([ADMIN_SECTION_ID])
REFERENCES [dbo].[TST_ADMIN_SECTION] ([ADMIN_SECTION_ID])
GO

ALTER TABLE [dbo].[TST_ADMIN_HISTORY_CHANGESET] CHECK CONSTRAINT [FK_TST_ADMIN_HISTORY_CHANGESET_TST_ADMIN_SECTION]
GO

ALTER TABLE [dbo].[TST_ADMIN_HISTORY_CHANGESET]  WITH CHECK ADD  CONSTRAINT [FK_TST_ADMIN_HISTORY_CHANGESET_TST_HISTORY_CHANGESET_TYPE] FOREIGN KEY([HISTORY_CHANGESET_TYPE_ID])
REFERENCES [dbo].[TST_HISTORY_CHANGESET_TYPE] ([CHANGETYPE_ID])
GO

ALTER TABLE [dbo].[TST_ADMIN_HISTORY_CHANGESET] CHECK CONSTRAINT [FK_TST_ADMIN_HISTORY_CHANGESET_TST_HISTORY_CHANGESET_TYPE]
GO

/* ---------------------------------------------------------------------- */
/* Add table "TST_ADMIN_HISTORY_DETAILS"                        */
/* ---------------------------------------------------------------------- */

GO
CREATE TABLE [dbo].[TST_ADMIN_HISTORY_DETAILS](
	[ADMIN_HISTORY_DETAIL_ID] [bigint] IDENTITY(1,1) NOT NULL,
	[ADMIN_PROPERTY_NAME] [nvarchar](max) NULL,
	[OLD_VALUE] [nvarchar](max) NULL,
	[NEW_VALUE] [nvarchar](max) NULL,
...
ALTER TABLE [dbo].[TST_ADMIN_HISTORY_DETAILS]  WITH CHECK ADD  CONSTRAINT [FK_TST_ADMIN_HISTORY_DETAILS_TST_USER] FOREIGN KEY([ADMIN_USER_ID])
REFERENCES [dbo].[TST_USER] ([USER_ID])
GO

ALTER TABLE [dbo].[TST_ADMIN_HISTORY_DETAILS] CHECK CONSTRAINT [FK_TST_ADMIN_HISTORY_DETAILS_TST_USER]
GO

ALTER TABLE [TST_ADMIN_HISTORY_DETAILS] ADD CONSTRAINT [FK_TST_ADMIN_HISTORY_CHANGESET_TST_ADMIN_HISTORY_DETAILS] 
    FOREIGN KEY ([ADMIN_CHANGESET_ID]) REFERENCES [TST_ADMIN_HISTORY_CHANGESET] ([CHANGESET_ID]) ON DELETE CASCADE
GO

/* ---------------------------------------------------------------------- */
/* Add table "TST_USER_ACTIVITY_LOG"                        */
/* ---------------------------------------------------------------------- */

GO
CREATE TABLE [dbo].[TST_USER_ACTIVITY_LOG](
	[USER_ACTIVITY_LOG_ID] [bigint] IDENTITY(1,1) NOT NULL,
	[USER_ID] [int] NOT NULL,
	[LOGIN_DATE] [datetime] NULL,
	[LOGOUT_DATE] [datetime] NULL,
...
ALTER TABLE [dbo].[TST_USER_ACTIVITY_LOG]  WITH CHECK ADD  CONSTRAINT [FK_TST_USER_ACTIVITY_LOG_TST_USER] FOREIGN KEY([USER_ID])
REFERENCES [dbo].[TST_USER] ([USER_ID])
GO

ALTER TABLE [dbo].[TST_USER_ACTIVITY_LOG] CHECK CONSTRAINT [FK_TST_USER_ACTIVITY_LOG_TST_USER]
GO

/* ---------------------------------------------------------------------- */
/* Add table "TST_USER_HISTORY_CHANGESET"                        */
/* ---------------------------------------------------------------------- */

GO
CREATE TABLE [dbo].[TST_USER_HISTORY_CHANGESET](
	[CHANGESET_ID] [bigint] IDENTITY(1,1) NOT NULL,
	[USER_ID] [int] NOT NULL,
	[UPDATED_BY_USERID] [int] NOT NULL,
	[CHANGE_DATE] [datetime] NOT NULL,
...
ALTER TABLE [dbo].[TST_USER_HISTORY_CHANGESET]  WITH CHECK ADD  CONSTRAINT [FK_TST_USER_HISTORY_CHANGESET_TST_USER] FOREIGN KEY([USER_ID])
REFERENCES [dbo].[TST_USER] ([USER_ID])
GO

ALTER TABLE [dbo].[TST_USER_HISTORY_CHANGESET] CHECK CONSTRAINT [FK_TST_USER_HISTORY_CHANGESET_TST_USER]
GO

ALTER TABLE [dbo].[TST_USER_HISTORY_CHANGESET]  WITH CHECK ADD  CONSTRAINT [FK_TST_USER_HISTORY_CHANGESET1_TST_USER] FOREIGN KEY([UPDATED_BY_USERID])
REFERENCES [dbo].[TST_USER] ([USER_ID])
GO

ALTER TABLE [dbo].[TST_USER_HISTORY_CHANGESET] CHECK CONSTRAINT [FK_TST_USER_HISTORY_CHANGESET1_TST_USER]
GO

ALTER TABLE [dbo].[TST_USER_HISTORY_CHANGESET] ADD  CONSTRAINT [DF_TST_USER_HISTORY_CHANGESET_CHANGE_DATE]  DEFAULT (getdate()) FOR [CHANGE_DATE]
GO

ALTER TABLE [dbo].[TST_USER_HISTORY_CHANGESET]  WITH CHECK ADD  CONSTRAINT [FK_TST_USER_HISTORY_CHANGESET_TST_HISTORY_CHANGESET_TYPE] FOREIGN KEY([HISTORY_CHANGESET_TYPE_ID])
REFERENCES [dbo].[TST_HISTORY_CHANGESET_TYPE] ([CHANGETYPE_ID])
GO

ALTER TABLE [dbo].[TST_USER_HISTORY_CHANGESET] CHECK CONSTRAINT [FK_TST_USER_HISTORY_CHANGESET_TST_HISTORY_CHANGESET_TYPE]
GO
...
CREATE INDEX [IDX_TST_TEMPLATE_DATASOURCE] ON [TST_TEMPLATE_DATASOURCE] ([TemplateId])
GO
...
CREATE INDEX [IDX_TST_TEMPLATE_OUTTYPE] ON [TST_TEMPLATE_OUTTYPE] ([TemplateId])
GO
...
CREATE INDEX [IDX_TST_TEMPLATE_PARAMETER] ON [TST_TEMPLATE_PARAMETER] ([TemplateId])
GO
...
CREATE TABLE [dbo].[TST_SCHEDULES](
	...
	[OUTPUTFILENAME] NVARCHAR(MAX) NULL,
	[USERFOLDER] NVARCHAR(MAX) NULL,
...
/* ---------------------------------------------------------------------- */
/* Add table "TST_REQUIREMENT_APPROVAL_USERS"                               */
/* ---------------------------------------------------------------------- */

GO

CREATE TABLE [dbo].[TST_REQUIREMENT_APPROVAL_USERS](
	[REQUIREMENT_APPROVAL_USER_ID] INTEGER IDENTITY(1,1) NOT NULL,
	[PROJECT_ID] INTEGER NOT NULL,
	[USER_ID] INTEGER NOT NULL,
	[WORKFLOW_TRANSITION_ID] INTEGER NOT NULL,
	[IS_ACTIVE] BIT NOT NULL,
	[UPDATE_DATE] [datetime] NOT NULL,
	[ORDER_ID] [smallint] NULL,
 CONSTRAINT [PK_TST_REQUIREMENT_APPROVAL_USERS] PRIMARY KEY CLUSTERED 
(
	[REQUIREMENT_APPROVAL_USER_ID] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON, OPTIMIZE_FOR_SEQUENTIAL_KEY = OFF) ON [PRIMARY]
) ON [PRIMARY]
GO

ALTER TABLE [dbo].[TST_REQUIREMENT_APPROVAL_USERS]  WITH CHECK ADD  CONSTRAINT [FK_TST_REQUIREMENT_APPROVAL_USERS_TST_USER] FOREIGN KEY([USER_ID])
REFERENCES [dbo].[TST_USER] ([USER_ID])
GO

ALTER TABLE [dbo].[TST_REQUIREMENT_APPROVAL_USERS] CHECK CONSTRAINT [FK_TST_REQUIREMENT_APPROVAL_USERS_TST_USER]
GO

/* ---------------------------------------------------------------------- */
/* Add table "TST_REQUIREMENT_APPROVAL_WORKFLOW"                            */
/* ---------------------------------------------------------------------- */

GO

CREATE TABLE [dbo].[TST_REQUIREMENT_APPROVAL_WORKFLOW](
	[REQUIREMENT_APPROVAL_WORKFLOW_ID] INTEGER IDENTITY(1,1) NOT NULL,
	[REQUIREMENT_ID] INTEGER NOT NULL,
	[IS_ACTIVE] BIT NOT NULL,
	[UPDATE_DATE] [datetime] NOT NULL,
 CONSTRAINT [PK_TST_REQUIREMENT_APPROVAL_WORKFLOW] PRIMARY KEY CLUSTERED 
(
	[REQUIREMENT_APPROVAL_WORKFLOW_ID] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON, OPTIMIZE_FOR_SEQUENTIAL_KEY = OFF) ON [PRIMARY]
) ON [PRIMARY]
GO
...
/* ---------------------------------------------------------------------- */
/* Add table "TST_ARTIFACT_SIGNATURE"                                    */
/* ---------------------------------------------------------------------- */

CREATE TABLE [dbo].[TST_ARTIFACT_SIGNATURE](
	[TST_ARTIFACT_SIGNATURE_ID] INTEGER IDENTITY(1,1) NOT NULL,
	...
	[MEANING] NVARCHAR(512) NULL,
	[UPDATE_DATE] [datetime] NOT NULL,
	[APPROVAL_WORKFLOW_ID] INTEGER NULL,
 CONSTRAINT [PK_TST_ARTIFACT_SIGNATURE] PRIMARY KEY CLUSTERED 
(
	[TST_ARTIFACT_SIGNATURE_ID] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON, OPTIMIZE_FOR_SEQUENTIAL_KEY = OFF) ON [PRIMARY]
) ON [PRIMARY]
GO

ALTER TABLE [dbo].[TST_ARTIFACT_SIGNATURE]  WITH CHECK ADD  CONSTRAINT [FK_TST_ARTIFACT_SIGNATURE_TST_ARTIFACT_TYPE] FOREIGN KEY([ARTIFACT_TYPE_ID])
REFERENCES [dbo].[TST_ARTIFACT_TYPE] ([ARTIFACT_TYPE_ID])
GO

ALTER TABLE [dbo].[TST_ARTIFACT_SIGNATURE] CHECK CONSTRAINT [FK_TST_ARTIFACT_SIGNATURE_TST_ARTIFACT_TYPE]
GO

ALTER TABLE [dbo].[TST_ARTIFACT_SIGNATURE]  WITH CHECK ADD  CONSTRAINT [FK_TST_ARTIFACT_SIGNATURE_TST_USER] FOREIGN KEY([USER_ID])
REFERENCES [dbo].[TST_USER] ([USER_ID])
GO

ALTER TABLE [dbo].[TST_ARTIFACT_SIGNATURE] CHECK CONSTRAINT [FK_TST_ARTIFACT_SIGNATURE_TST_USER]
GO

/* ---------------------------------------------------------------------- */
/* Add table "TST_REQUIREMENT_SIGNATURE"                                    */
/* ---------------------------------------------------------------------- */

GO

CREATE TABLE [dbo].[TST_REQUIREMENT_SIGNATURE](
	[TST_REQUIREMENT_SIGNATURE_ID] INTEGER IDENTITY(1,1) NOT NULL,
	[REQUIREMENT_ID] INTEGER NOT NULL,
	[USER_ID] INTEGER NOT NULL,
	[STATUS_ID] INTEGER NOT NULL,
	[REQUESTED_DATE] [datetime] NULL,
	[MEANING] NVARCHAR(512) NULL,
	[UPDATE_DATE] [datetime] NOT NULL,
	[REQUIREMENT_APPROVAL_WORKFLOW_ID] INTEGER NOT NULL,
	[PROJECT_ID] INTEGER NULL,
 CONSTRAINT [PK_TST_REQUIREMENT_SIGNATURE] PRIMARY KEY CLUSTERED 
(
	[TST_REQUIREMENT_SIGNATURE_ID] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON, OPTIMIZE_FOR_SEQUENTIAL_KEY = OFF) ON [PRIMARY]
) ON [PRIMARY]
GO

ALTER TABLE [dbo].[TST_REQUIREMENT_SIGNATURE]  WITH CHECK ADD  CONSTRAINT [FK_TST_REQUIREMENT_SIGNATURE_TST_REQUIREMENT] FOREIGN KEY([REQUIREMENT_ID])
REFERENCES [dbo].[TST_REQUIREMENT] ([REQUIREMENT_ID])
GO

ALTER TABLE [dbo].[TST_REQUIREMENT_SIGNATURE] CHECK CONSTRAINT [FK_TST_REQUIREMENT_SIGNATURE_TST_REQUIREMENT]
GO

ALTER TABLE [dbo].[TST_REQUIREMENT_SIGNATURE]  WITH CHECK ADD  CONSTRAINT [FK_TST_REQUIREMENT_SIGNATURE_TST_REQUIREMENT_APPROVAL_WORKFLOW] FOREIGN KEY([REQUIREMENT_APPROVAL_WORKFLOW_ID])
REFERENCES [dbo].[TST_REQUIREMENT_APPROVAL_WORKFLOW] ([REQUIREMENT_APPROVAL_WORKFLOW_ID])
GO

ALTER TABLE [dbo].[TST_REQUIREMENT_SIGNATURE]  WITH CHECK ADD  CONSTRAINT [FK_TST_REQUIREMENT_SIGNATURE_TST_USER] FOREIGN KEY([USER_ID])
REFERENCES [dbo].[TST_USER] ([USER_ID])
GO

ALTER TABLE [dbo].[TST_REQUIREMENT_SIGNATURE] CHECK CONSTRAINT [FK_TST_REQUIREMENT_SIGNATURE_TST_USER]
GO

ALTER TABLE [TST_REQUIREMENT_SIGNATURE] ADD CONSTRAINT [FK_TST_PROJECT_TST_REQUIREMENT_SIGNATURE] 
...
ALTER TABLE [dbo].[TST_REPORT_DOWNLOADABLE]  WITH CHECK ADD FOREIGN KEY([CREATED_BY])
REFERENCES [dbo].[TST_USER] ([USER_ID])
GO

ALTER TABLE [dbo].[TST_REPORT_DOWNLOADABLE]  WITH CHECK ADD FOREIGN KEY([REPORT_OWNERID])
REFERENCES [dbo].[TST_USER] ([USER_ID])
GO

ALTER TABLE [dbo].[TST_REPORT_DOWNLOADABLE]  WITH CHECK ADD FOREIGN KEY([REPORT_CATEGORYID])
REFERENCES [dbo].[TST_REPORT_CATEGORY] ([REPORT_CATEGORY_ID])
GO
...
ALTER TABLE TST_ATTACHMENT ADD IS_DELETED  BIT CONSTRAINT [DEF_TST_ATTACHMENT_IS_DELETED] DEFAULT 0 NOT NULL
GO

ALTER TABLE TST_TEST_CONFIGURATION ADD IS_DELETED  BIT CONSTRAINT [DEF_TST_TEST_CONFIGURATION_IS_DELETED] DEFAULT 0 NOT NULL
GO

ALTER TABLE TST_TEST_RUN ADD IS_DELETED  BIT CONSTRAINT [DEF_TST_TEST_RUN_IS_DELETED] DEFAULT 0 NOT NULL
GO
ALTER TABLE TST_REQUIREMENT ADD APPROVED_STATUS NVARCHAR(max)
GO
IF EXISTS (
    SELECT 1 
    FROM sys.foreign_keys 
    WHERE name = 'FK_TST_HISTORY_CHANGESET_TST_PROJECT_BASELINE'
)
BEGIN
    ALTER TABLE TST_PROJECT_BASELINE
    DROP CONSTRAINT FK_TST_HISTORY_CHANGESET_TST_PROJECT_BASELINE;
END
GO
GO

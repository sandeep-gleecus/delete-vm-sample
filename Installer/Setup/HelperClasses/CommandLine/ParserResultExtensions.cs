...
{
	/// <summary>Provides convenience extension methods for <see cref="CommandLine.ParserResult{T}"/>.</summary>
	public static partial class ParserResultExtensions
	{
		#region WithParsed()
		/// <summary>Executes <paramref name="action"/> if <see cref="CommandLine.ParserResult{T}"/> containsparsed values.</summary>
		...
		/// <summary>Executes <paramref name="action"/> if parsed values are of <typeparamref name="T"/>.</summary>
		/// <typeparam name="T">Type of the target instance built with parsed value.</typeparam>
		...
		#endregion WithParsed()

		#region WithNotParsed()
		/// <summary>

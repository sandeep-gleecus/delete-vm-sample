...
namespace Inflectra.SpiraTest.DataModel
{
    ...
    public partial class UserRecentProject: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        private void FixupProject(Project previousValue)
        {
            ...
            if (previousValue != null && previousValue.RecentProjects.Contains(this))
            {
                previousValue.RecentProjects.Remove(this);
            }
    
            if (Project != null)
            {
                if (!Project.RecentProjects.Contains(this))
                {
                    Project.RecentProjects.Add(this);
                }
        ...
        private void FixupUser(User previousValue)
        {
            ...
            if (User != null)
            {
                if (!User.RecentProjects.Contains(this))
                {
                    User.RecentProjects.Add(this);
                }

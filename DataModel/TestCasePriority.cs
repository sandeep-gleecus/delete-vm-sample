...
namespace Inflectra.SpiraTest.DataModel
{
    ...
    public partial class TestCasePriority: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        public int TestCasePriorityId
        {
            ...
            set
            {
                if (_testCasePriorityId != value)
                {
                    ...
                    {
                        throw new InvalidOperationException("The property 'TestCasePriorityId' is part of the object's key and cannot be changed. Changes to key properties can only be made when the object is not being tracked or is in the Added state.");
                    }
        ...
        private int _testCasePriorityId;
        ...
        private void FixupProjectTemplate(ProjectTemplate previousValue)
        {
            ...
            if (previousValue != null && previousValue.TestCasePriorities.Contains(this))
            {
                previousValue.TestCasePriorities.Remove(this);
            }
    
            if (ProjectTemplate != null)
            {
                if (!ProjectTemplate.TestCasePriorities.Contains(this))
                {
                    ProjectTemplate.TestCasePriorities.Add(this);
                }

...
namespace Inflectra.SpiraTest.DataModel
{
    ...
    public partial class UserArtifactField: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        private void FixupProject(Project previousValue)
        {
            ...
            if (Project != null)
            {
                if (!Project.UserFields.Contains(this))
                {
                    Project.UserFields.Add(this);
                }
        ...
        private void FixupUser(User previousValue)
        {
            ...
            if (previousValue != null && previousValue.ArtifactFields.Contains(this))
            {
                previousValue.ArtifactFields.Remove(this);
            }
    
            if (User != null)
            {
                if (!User.ArtifactFields.Contains(this))
                {
                    User.ArtifactFields.Add(this);
                }
        ...
        private void FixupArtifactField(ArtifactField previousValue)
        {
            ...
            {
                if (!ArtifactField.UserFields.Contains(this))
                {
                    ArtifactField.UserFields.Add(this);
                }

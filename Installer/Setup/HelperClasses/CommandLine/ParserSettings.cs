...
{
	/// <summary>Provides settings for <see cref="CommandLine.Parser"/>. Once consumed cannot be reused.</summary>
	public class ParserSettings : IDisposable
	{
		...
		/// <summary>Initializes a new instance of the <see cref="ParserSettings"/> class.</summary>
		...
		/// <summary>Finalizes an instance of the <see cref="CommandLine.ParserSettings"/> class.</summary>
		~ParserSettings()
		{
			Dispose(false);
		}

...
namespace Inflectra.SpiraTest.DataModel
{
    ...
    public partial class R_ArtifactType: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        public string PREFIX
        {
            ...
            set
            {
                if (_pREFIX != value)
                {
                    if (ChangeTracker.ChangeTrackingEnabled && ChangeTracker.State != ObjectState.Added)
                    {
                        throw new InvalidOperationException("The property 'PREFIX' is part of the object's key and cannot be changed. Changes to key properties can only be made when the object is not being tracked or is in the Added state.");
                    }
                    _pREFIX = value;

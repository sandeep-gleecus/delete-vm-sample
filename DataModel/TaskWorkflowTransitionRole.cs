...
namespace Inflectra.SpiraTest.DataModel
{
    ...
    public partial class TaskWorkflowTransitionRole: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        [DataMember]
        public TaskWorkflowTransition Transition
        {
        ...
        private TaskWorkflowTransition _transition;
        ...
        private void FixupRole(ProjectRole previousValue)
        {
            ...
            if (previousValue != null && previousValue.TaskWorkflowTransitionRoles.Contains(this))
            {
                previousValue.TaskWorkflowTransitionRoles.Remove(this);
            }
    
            if (Role != null)
            {
                if (!Role.TaskWorkflowTransitionRoles.Contains(this))
                {
                    Role.TaskWorkflowTransitionRoles.Add(this);
                }
        ...
        private void FixupTransition(TaskWorkflowTransition previousValue)
        {
            if (IsDeserializing)
            {
                return;
        ...
        private void FixupType(WorkflowTransitionRoleType previousValue)
        {
            ...
            if (Type != null)
            {
                if (!Type.TaskWorkflowTransitionRoles.Contains(this))
                {
                    Type.TaskWorkflowTransitionRoles.Add(this);
                }

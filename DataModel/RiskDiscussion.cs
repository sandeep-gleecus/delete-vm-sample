...
namespace Inflectra.SpiraTest.DataModel
{
    ...
    public partial class RiskDiscussion: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        private void FixupRisk(Risk previousValue)
        {
            ...
            if (Risk != null)
            {
                if (!Risk.Discussions.Contains(this))
                {
                    Risk.Discussions.Add(this);
                }
    
                ArtifactId = Risk.RiskId;
            }
        ...
        private void FixupCreator(User previousValue)
        {
            ...
            if (previousValue != null && previousValue.RiskDiscussions.Contains(this))
            {
                previousValue.RiskDiscussions.Remove(this);
            }
    
            if (Creator != null)
            {
                if (!Creator.RiskDiscussions.Contains(this))
                {
                    Creator.RiskDiscussions.Add(this);
                }

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RestService.aspx.cs" Inherits="Inflectra.SpiraTest.Web.Services.v6_0.RestService1" EnableTheming="false" Theme="" %>
...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body class="pa0 ma0">
        <form id="frmMain" runat="server">
            <p class="pa4 mt0 mb6 bg-tiber fs-h3 ff-josefin white"><asp:Literal runat="server" ID="ltrProductName2"/>: REST Web Service (v6.0)</p>
            <div class="vw-50-xl vw-66-lg vw-75-md vw-75_sm vw-90-xs vw-90-xxs mx-auto">
                <div>
                    ...
                    <p>For instance, if you access the application in the browser from <strong>https://companyname.spiraservice.net</strong>, then that will be the base of the URL used for accessing the API.
                        And if you are on version 6, the API URL would be: <strong>https://companyname.spiraservice.net</strong>/services/v6_0/RestService.svc
                    </p>
                    ...
                    <p><strong>Note: </strong> when sending data to Spira using XML, make sure all tags are sent in alphabetical order</p>

                    <p><strong>Note: </strong> when making call to Spira it is safest to always include both "Content-Type" and "accept" headers</p>
                    ...
                    <ul class="ma0 ml3 pl5">
                        ...
                        <li class="mb2">Risk = 14</li>
                        <li class="mb2">RiskMitigation = 15</li>
                    </ul>
                </div>
                ...
                <div class="mt6">
                    ...
                    <p>
                        This table provides a list of all the resources exposed by this REST web service.<br />
                        More detail about each resource is explored after this table:
                        <tstsc:HyperLinkEx 

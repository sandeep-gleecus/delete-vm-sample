<%@ Page 
    ...
    CodeBehind="ProjectGroupHome.aspx.cs" 
    Inherits="Inflectra.SpiraTest.Web.ProjectGroupHome" 
    Title="Untitled Page" 
    %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cplMainContent" runat="server">
    <tstsc:UpdatePanelEx ID="ajaxWebParts" runat="server">
        <ContentTemplate>
            <tstsc:WebPartManagerEx ID="prtManager" runat="server" DashboardName="ProjectGroupHome" OnInit="prtManager_Init"  OnAuthorizeWebPart="prtManager_AuthorizeWebPart">
                <StaticConnections>
                </StaticConnections>
            </tstsc:WebPartManagerEx>
            <div class="py4 pt2-xs px3 df justify-between">
			    <h2  class="pr3">
            ...
            <tstsc:MessageBox id="lblMessage" Runat="server" SkinID="MessageBox" />
             ...
             <div class ="flex flex-wrap">
		        <div class ="w-100 w-100-sm pl3 pr3 relative ov-hidden">

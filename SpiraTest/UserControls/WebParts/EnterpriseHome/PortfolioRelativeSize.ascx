 <%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PortfolioRelativeSize.ascx.cs"
    Inherits="Inflectra.SpiraTest.Web.UserControls.WebParts.EnterpriseHome.PortfolioRelativeSize" %>
...
<script type="text/javascript">
    ...
    $('#help-RelativeSize').popover({
        content: resx.InAppHelp_Chart_PortfolioRelativeSize,
        placement: "left",
        trigger: "hover focus",

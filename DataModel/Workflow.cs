...
namespace Inflectra.SpiraTest.DataModel
{
    ...
    public partial class Workflow: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        [DataMember]
        public TrackableCollection<WorkflowTransition> Transitions
        {
            get
            {
                if (_transitions == null)
                {
                    _transitions = new TrackableCollection<WorkflowTransition>();
        ...
        private TrackableCollection<WorkflowTransition> _transitions;
    
        [DataMember]
        public TrackableCollection<WorkflowCustomProperty> CustomProperties
        {
            get
            {
                if (_customProperties == null)
                {
                    _customProperties = new TrackableCollection<WorkflowCustomProperty>();
            ...
            set
            {
                if (!ReferenceEquals(_customProperties, value))
                {
                    ...
                    if (_customProperties != null)
                    {
                        ...
                        foreach (WorkflowCustomProperty item in _customProperties)
                        {
        ...
        private TrackableCollection<WorkflowCustomProperty> _customProperties;
    
        [DataMember]
        public TrackableCollection<WorkflowField> Fields
        {
            get
            {
                if (_fields == null)
                {
                    _fields = new TrackableCollection<WorkflowField>();
            ...
            set
            {
                if (!ReferenceEquals(_fields, value))
                {
                    ...
                    if (_fields != null)
                    {
                        ...
                        // This is the principal end in an association that performs cascade deletes.
                        // Remove the cascade delete event handler for any entities in the current collection.
                        foreach (WorkflowField item in _fields)
                        {
                            ChangeTracker.ObjectStateChanging -= item.HandleCascadeDelete;
                        }
                    }
        ...
        private TrackableCollection<WorkflowField> _fields;
        ...
        private void FixupProjectTemplate(ProjectTemplate previousValue)
        {
            ...
            if (previousValue != null && previousValue.IncidentWorkflows.Contains(this))
            {
                previousValue.IncidentWorkflows.Remove(this);
            }
    
            if (ProjectTemplate != null)
            {
                if (!ProjectTemplate.IncidentWorkflows.Contains(this))
                {
                    ProjectTemplate.IncidentWorkflows.Add(this);
                }

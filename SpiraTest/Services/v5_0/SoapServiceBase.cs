...
{
	/// <summary>
	/// This is the base class for all v5.0 SOAP WCF services
	/// </summary>
	/// <remarks>
	/// We use ASP.NET compatibility mode because the services are hosted in IIS and we need access to the session object
	/// </remarks>
	[
	ServiceBehavior(InstanceContextMode = InstanceContextMode.PerCall, Namespace = "http://www.inflectra.com/SpiraTest/Services/v5.0/"),
	AspNetCompatibilityRequirements(RequirementsMode = AspNetCompatibilityRequirementsMode.Required),
	]
	public class SoapServiceBase
	{
		private const string CLASS_NAME = "Inflectra.SpiraTest.Web.Services.v5_0.ServiceBase::";
		...
		{
			const string METHOD_NAME = "Connection_Authenticate3";
			...
			bool validUser = provider.ValidateUserByRssToken(userName.ToLower(System.Globalization.CultureInfo.InvariantCulture), apiKey);

...
namespace Inflectra.SpiraTest.DataModel
{
    ...
    public partial class TaskFolderHierarchy: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        private void FixupProject(Project previousValue)
        {
            ...
            if (previousValue != null && previousValue.TaskFoldersHierarchy.Contains(this))
            {
                previousValue.TaskFoldersHierarchy.Remove(this);
            }
    
            if (Project != null)
            {
                if (!Project.TaskFoldersHierarchy.Contains(this))
                {
                    Project.TaskFoldersHierarchy.Add(this);
                }

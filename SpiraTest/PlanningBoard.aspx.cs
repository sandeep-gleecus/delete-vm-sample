...
namespace Inflectra.SpiraTest.Web
{
    ...
    /// </summary>
    [HeaderSettings(GlobalNavigation.NavigationHighlightedLink.PlanningBoard, "SiteMap_PlanningBoard", "Planning-Board")]
    public partial class PlanningBoard : PageLayout
    {
		...
		protected void Page_Load(object sender, EventArgs e)
        {
            ...
            //Specify the context for the ajax form controls
			//Requirements
			...
			//Incidents
			this.incident_ajxFormManager.ProjectId = this.ProjectId;
			Dictionary<string, string> incident_formManagerHandlers = new Dictionary<string, string>();
			incident_formManagerHandlers.Add("dataSaved", "incident_ajxFormManager_dataSaved");
			incident_formManagerHandlers.Add("loaded", "incident_ajxFormManager_loaded");
			this.incident_ajxFormManager.SetClientEventHandlers(incident_formManagerHandlers);
			...
			if (!IsPostBack)
            {
				...
				this.incident_txtDescription.Screenshot_ProjectId = ProjectId;

				//Populate the standard fields of the incident creation dialog
				this.incident_ddlDetectedRelease.BaseUrl = UrlRewriterModule.RetrieveRewriterURL(UrlRoots.NavigationLinkEnum.Releases, ProjectId, -2);
				this.incident_ddlResolvedRelease.BaseUrl = UrlRewriterModule.RetrieveRewriterURL(UrlRoots.NavigationLinkEnum.Releases, ProjectId, -2);
				this.incident_ddlVerifiedRelease.BaseUrl = UrlRewriterModule.RetrieveRewriterURL(UrlRoots.NavigationLinkEnum.Releases, ProjectId, -2);
				...
				this.incident_ddlComponents.DataSource = components;
				this.incident_ddlPriority.DataSource = priorities;
				this.incident_ddlSeverity.DataSource = severities;
				this.incident_ddlOpener.DataSource = allUsers;
				this.incident_ddlOwner.DataSource = activeUsers;
				...
				this.incident_ddlDetectedRelease.DataSource = releases2;
				this.incident_ddlResolvedRelease.DataSource = releases2;
				this.incident_ddlVerifiedRelease.DataSource = releases2;
				this.incident_ddlType.DataSource = incidentTypes;
				...
				{
					this.incident_ddlDetectedRelease.ActiveItemField = "IsActive";
				}
				...
				UnityCustomPropertyInjector.CreateControls(
					...
					this.incident_customFieldsDefault,
					this.incident_ajxFormManager,
					this.incident_customFieldsUsers,
					this.incident_customFieldsDates,
					this.incident_customFieldsRichText
				);
                ...
                this.chkIncludeIncidents.Checked = includeIncidents;
                ...
                this.ajxPlanningBoard.IncludeIncidents = includeIncidents;

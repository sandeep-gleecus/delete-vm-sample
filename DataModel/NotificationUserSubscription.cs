...
namespace Inflectra.SpiraTest.DataModel
{
    ...
    public partial class NotificationUserSubscription: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        private void FixupArtifactType(ArtifactType previousValue)
        {
            ...
            if (previousValue != null && previousValue.UserSubscriptions.Contains(this))
            {
            ...
            {
                if (!ArtifactType.UserSubscriptions.Contains(this))
                {
                    ArtifactType.UserSubscriptions.Add(this);
                }
        ...
        private void FixupUser(User previousValue)
        {
            ...
            if (previousValue != null && previousValue.ArtifactSubscriptions.Contains(this))
            {
                previousValue.ArtifactSubscriptions.Remove(this);
            }
    
            if (User != null)
            {
                if (!User.ArtifactSubscriptions.Contains(this))
                {
                    User.ArtifactSubscriptions.Add(this);
                }

...
namespace Inflectra.SpiraTest.DataModel
{
    ...
    public partial class GlobalTag: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        private void FixupArtifactType(ArtifactType previousValue)
        {
            ...
            if (previousValue != null && previousValue.GlobalTags.Contains(this))
            {
                previousValue.GlobalTags.Remove(this);
            }
    
            if (ArtifactType != null)
            {
                if (!ArtifactType.GlobalTags.Contains(this))
                {
                    ArtifactType.GlobalTags.Add(this);
                }

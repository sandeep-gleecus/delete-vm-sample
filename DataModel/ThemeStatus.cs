...
namespace Inflectra.SpiraTest.DataModel
{
    ...
    public partial class ThemeStatus: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        public int ThemeStatusId
        {
            ...
            set
            {
                if (_themeStatusId != value)
                {
                    ...
                    {
                        throw new InvalidOperationException("The property 'ThemeStatusId' is part of the object's key and cannot be changed. Changes to key properties can only be made when the object is not being tracked or is in the Added state.");
                    }

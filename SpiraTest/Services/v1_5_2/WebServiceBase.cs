...
namespace Inflectra.SpiraTest.Web.Services.v1_5_2
{
	...
	public class WebServiceBase : System.Web.Services.WebService
	{
		...
		protected const string Session_UserName = "UserName";
		...
		protected bool IsSystemAdmin
		{
			get
			{
				...
				ProfileEx profile = new ProfileEx((string)Session[Session_UserName]);
				if (profile == null)
				{
					return false;
				}
		...
		public bool Authenticate(string userName, string password)
		{
			...
			if (validUser)
			{
				...
				Global.RegisterSession(Session.SessionID, (int)membershipUser.ProviderUserKey, "v1.5.2 API");
				...
				Session[Session_UserName] = membershipUser.UserName;
				success = true;
			}

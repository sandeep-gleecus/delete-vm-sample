...
namespace Inflectra.SpiraTest.DataModel
{
    ...
    public partial class DataSyncArtifactMapping: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        private void FixupArtifactType(ArtifactType previousValue)
        {
            ...
            {
                if (!ArtifactType.DataSyncMappings.Contains(this))
                {
                    ArtifactType.DataSyncMappings.Add(this);
                }
        ...
        private void FixupProject(DataSyncProject previousValue)
        {
            ...
            if (previousValue != null && previousValue.ArtifactMappings.Contains(this))
            {
                previousValue.ArtifactMappings.Remove(this);
            }
    
            if (Project != null)
            {
                if (!Project.ArtifactMappings.Contains(this))
                {
                    Project.ArtifactMappings.Add(this);
                }

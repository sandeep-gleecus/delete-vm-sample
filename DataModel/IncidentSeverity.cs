...
namespace Inflectra.SpiraTest.DataModel
{
    ...
    public partial class IncidentSeverity: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        public int SeverityId
        {
            ...
            set
            {
                if (_severityId != value)
                {
                    ...
                    {
                        throw new InvalidOperationException("The property 'SeverityId' is part of the object's key and cannot be changed. Changes to key properties can only be made when the object is not being tracked or is in the Added state.");
                    }
                    _severityId = value;
        ...
        private void FixupProjectTemplate(ProjectTemplate previousValue)
        {
            ...
            if (previousValue != null && previousValue.IncidentSeverities.Contains(this))
            {
                previousValue.IncidentSeverities.Remove(this);
            }
    
            if (ProjectTemplate != null)
            {
                if (!ProjectTemplate.IncidentSeverities.Contains(this))
                {
                    ProjectTemplate.IncidentSeverities.Add(this);
                }
        ...
        private void FixupIncidents(object sender, NotifyCollectionChangedEventArgs e)
        {
            ...
            if (e.OldItems != null)
            {
                ...
                {
                    if (ReferenceEquals(item.Severity, this))
                    {
                        item.Severity = null;
                    }
                    if (ChangeTracker.ChangeTrackingEnabled)
